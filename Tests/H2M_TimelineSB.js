...
$.fn.H2M_Timeline = function(dictionary) 
{
    ...
    //alert ('This is the correct file');
    ...
    $.post("get_personal_doctor_timelineSB.php", {pat_id: patient, doc_id: doctor, max: max, element: "#"+element}, function(data, status)
    {
        console.log(data);
        ...
        /*
        start_date = 'Apr 21, 2012 7:20 AM';
        ...
        */
        ...
        o.html('');
        o.append('<div id="scale_timeline" style="width: 100%; height:30px; border-radius: 25px; background: #FAFAFA; border: 1px solid #CACACA; margin-top: '+((container_height/2)-15)+'px; "><div id="'+element+'"></div></div>');
        ...
        for (var i = 0; i <= years_span; i++)
        {
            ...
            if (i != years_span) o.append('  <div class="timeline_box_label" style="left:'+position_item+'px;"><div class="timeline_label rotate" style="">'+(parseInt(start_year)+i+1)+'</div></div>');
...
function H2M_timeline_display_view(item, element, user, offset, index)
{
    ...
    $(element).append('<div id="personal_doctor_timeline_item_'+index+'_'+(offset+1)+'" class="personal_doctor_timeline_item" style="position:absolute; left:'+position_item+'px; top:'+((container_height/2)-30)+'px;"><i class="icon-eye-open" style="line-height: inherit;"></i></div>');
...
function H2M_timeline_display_upload(item, element, user, offset, index, type)
{
    ...
    if(type == 'doctor') 
        $(element).append('<div id="personal_doctor_timeline_item_'+index+'_'+(offset+1)+'" class="personal_doctor_timeline_item" style="position:absolute; left:'+position_item+'px; top:'+((container_height/2)-30)+'px;"><i class="icon-upload" style="line-height: inherit;"></i></div>');
    else
        $(element).append('<div id="personal_doctor_timeline_item_'+index+'_'+(offset+1)+'" class="personal_doctor_timeline_item" style="color: #54bc00; position:absolute; left:'+position_item+'px; top:'+((container_height/2)+35)+'px;"><i class="icon-upload" style="line-height: inherit;"></i></div>');
...
function H2M_timeline_display_summary_edit(item, element, user, offset, index)
{
    ...
    $(element).append('<div id="personal_doctor_timeline_item_'+index+'_'+(offset+1)+'" class="personal_doctor_timeline_item" style="position:absolute; left:'+position_item+'px; top:'+((container_height/2)-30)+'px;"><i class="icon-pencil" style="line-height: inherit;"></i></div>');
...
function H2M_timeline_display_referrals(item, element, user, offset, index)
{
    ...
    $(element).append('<div id="personal_doctor_timeline_item_'+index+'_'+(offset+1)+'" class="personal_doctor_timeline_item" style="position:absolute; left:'+position_item+'px; top:'+((container_height/2)-30)+'px;"><i class="icon-share-alt" style="line-height: inherit;"></i></div>');
...
function H2M_timeline_display_messages(item, element, user, offset, index, type, isPatient)
{
    ...
    */
    if(type == 'doctor') 
        $(element).append('<div id="personal_doctor_timeline_item_'+index+'_'+(offset+1)+'" class="personal_doctor_timeline_item" style="position:absolute; left:'+position_item+'px; top:'+((container_height/2)-30)+'px;"><i class="icon-envelope" style="line-height: inherit;"></i></div>');
    else
        $(element).append('<div id="personal_doctor_timeline_item_'+index+'_'+(offset+1)+'" class="personal_doctor_timeline_item" style="color: #54bc00; position:absolute; left:'+position_item+'px; top:'+((container_height/2)+35)+'px;"><i class="icon-envelope" style="line-height: inherit;"></i></div>');
...
function H2M_timeline_display_consultations(item, element, user, offset, index, type)
{
    ...
    if(type == 'phone')
        ...
        $(element).append('<div id="personal_doctor_timeline_item_'+index+'_'+(offset+1)+'" class="personal_doctor_timeline_item" style="position:absolute; left:'+position_item+'px; top:'+((container_height/2)+3)+'px; color: #EE8F19;"><i class="icon-phone" style="line-height: inherit;"></i></div>');
    else
        ...
        $(element).append('<div id="personal_doctor_timeline_item_'+index+'_'+(offset+1)+'" class="personal_doctor_timeline_item" style="position:absolute; left:'+position_item+'px; top:'+((container_height/2)+3)+'px; color: #EE8F19;"><i class="icon-facetime-video" style="line-height: inherit;"></i></div>');
...
function H2M_timeline_display_probe(item, element, user, offset, index)
{
    ...
    $(current_timeline_element).append('<div id="personal_doctor_timeline_item_'+index+'_'+(offset+1)+'" class="personal_doctor_timeline_item" style="color: #54bc00; position:absolute; left:'+position_item+'px; top:'+((container_height/2)+35)+'px;"><i class="icon-check" style="line-height: inherit;"></i></div>');

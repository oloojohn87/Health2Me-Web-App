...
-->
    ...
    <div id="modalImmunizationAllergy" style="display:none; text-align:center; padding:20px;">
        ...
        <div style="border:solid 1px #cacaca; height:120px; margin-top:20px; padding:10px;">
				...
				<input id="VaccineName" type="text" style="margin-left:10px;width: 160px; float:left;font-size:14px;height:17px" lang="en" placeholder="Vaccine Code">
				...
				<div style="padding:3px;height: 30px;margin-top: 5px ">
					...
					<input id="dateEvent" type="date" style="margin-left:10px; width: 150px; float:left; font-size:14px; height:17px">
				</div>
    ...
    <div id="modalAllergy" style="display:none; text-align:center; padding:20px;">
        ...
        <div style="border:solid 1px #cacaca; height:140px; margin-top:20px; padding:10px;">
				...
				<input id="AllergyName" type="text" style="margin-left:10px;width: 150px; float:left;font-size:14px;height:17px" lang="en" placeholder="Allergy Name">
    ...
    <div id="modalHabitsInfo" style="overflow:visible;display:none;  padding:20px;">
        ...
        <a id="ButtonUpdateHabitsInfo" class="btn" style="width:65px; color:#22aeff; float:right; margin-top:10px;margin-bottom:10px"><span lang="en">Update</span></a>
...
//		alert(idrow);
				...
				case 1:switch(d)
						{
							case 0:middlecolumn=frequency;
								   break;
							case 1:middlecolumn=frequency + (language == 'th' ? ' por ' : ' for ') + dossage;
								   break;
						}
						break;
			}
	...
	function getMedicationsDeleted()
	{
		...
		while (n<numMedications){
			...
			var middlecolumn=(language == 'th' ? 'Desconocido' : 'Unknown');
			...
			switch(f)
			{
				case 0:	switch(d)
						{
							case 0:middlecolumn=(language == 'th' ? 'Desconocido' : 'Unknown');
								   break;
							case 1:middlecolumn=dossage;
								   break;
						}

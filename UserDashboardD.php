...
<div id="modal_send" title= "Send Reports Link" style="display:none; text-align:center; padding:10px;">
        ...
        <!-- add stream here -->
        <div style="width: 95%; margin: auto; height: 300px; overflow-y:hidden;text-align: center; margin-top: 30px; margin-bottom: 20px;" id="sendStreamContainer">
  ...
  var gritterOptions = {
   ...
   var tour = new Tour({
          steps: [
          {
            ...
            content: "Content of my step asl dlakj sdlakjs dlaskjd flaskjdf lskjdf laksjdf laskjdf lskdjf laskjdf lskajdf lskjdf lsakjd flskajdf ",
            placement: "bottom",  
            backdrop: "true"             
             },
          {
...
//	$('#UpdateSumm').live('click',function(){
    ...
    $("#connect_now_yes").live('click', function()
    {
        ...
        html += 'Consultation</strong></li><li style="text-align: left;">With Dr. <strong>'+ info[3] + ' ' + info[4] + '</strong></li><li style="text-align: left;">starting <strong>NOW</strong></li></ul><div style="width: 100%; height: 62px; padding-top: 8px; visibility: hidden;" id="video_telemedicine_loading_bar"><img src="images/load/8.gif" style="margin-bottom: 7px;"  alt=""><p style="color: #333; text-align: center;">Loading Consultation. Please Wait ...</p></div><span style="color: #666; font-size: 10px; line-height: 10px;">You must share all of your records with this doctor to start the consultation.<br/> Press "Next" below to agree and start the consultation, otherwise press "Cancel."</span></div>';
        $("#find_doctor_receipt").html(html);
        $("#find_doctor_confirmation").html('<p style="color: #22AEFF; margin-top: 50px;" lang="en"><strong lang="en">Thank you!</strong><br/><strong lang="en">Your consultation appointment is starting now.</strong><br/><br/><span lang="en" style="color: #555; font-size: 18px;">Call Status:  <span id="call_status_label" lang="en" style="color: #E07221;">Connecting</span></span></p>');

...
*/
    ...
    if(isset($row['current_calling_doctor']))
    {
        ...
        $doc_res = mysql_query("SELECT Name,Surname FROM doctors WHERE id=".$current_calling_doctor);
        $doc_row = mysql_fetch_assoc($doc_res);
  ...
  <body style="background: #F9F9F9;">
    ...
    <div id="setup_modal" title="SetUp" style="display:none; text-align:center; padding:20px; width: 600px; height: 310px;">
        <div id="setup_modal_container" style="width: 600px; height: 280px;">
            <h4 id="setup_title">Change Password</h4>
            <br/>
            <div style="width: 15%; height:200px; float: left;">
                ...
                <button id="setup_menu_4" style="background-color: #FBFBFB; color: #22AEFF; width: 50px; height: 50px; font-size: 24px; border: 1px solid #E6E6E6; outline: 0px; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px; float: left;">
            ...
            <div style="width: 85%; height: 200px; float: left;">
                <div id="setup_page_1">
                    <div style="width: 100%; height: 40px;">
                        <div style="float: left; margin-top: 6px; margin-bottom: -6px; color: #777; width: 200px; text-align: left;">Type current password: </div>
                    ...
                    <div id="change_password_validated_section" style="display: none;">
                        <div style="width: 100%; height: 40px;">
                            <div style="float: left; margin-top: 6px; margin-bottom: -6px; color: #777; width: 200px; text-align: left;">Type new password: </div>
                            <input id="pw2" type="password" style="float: left; height: 15px; width: 200px; padding: 7px; color: #444;" value="" />
                        </div>
                        <div style="width: 100%; height: 40px;">
                            <div style="float: left; margin-top: 6px; margin-bottom: -6px; color: #777; width: 200px; text-align: left;">Retype new password: </div>
                ...
                <div id="setup_page_3" style="display: none;">
                    ...
                    <div style="margin-top: 10px; width: 70%; margin-left: auto; margin-right: auto;">
                        ...
                        <div style="color: #969696; width: 80px; float: left; text-align: left; padding-left: 5px; border-top-left-radius: 5px; border-bottom-left-radius: 5px; border: 1px solid #CACACA; height: 23px; padding-top: 5px; border-right: 0px solid #FFF;">Exp. Date:</div>
                        ...
                        <button style="width: 100px; height: 30px; background-color: #52D859; border-radius: 0px; border: 0px solid #FFF; color: #FFF; float: left; outline: 0px; margin-left: 18px; border-radius: 5px;">Add Card</button>
                    </div>
                </div>
...
<div id="modal_send" style="display:none; text-align:center; padding:10px;">
        ...
        <form>
         Email of Doctor <input type = "text" id="EmailID" width ="80" value='' />
        </form>
...
<!-- End of code inserted from userdashboard-new-pallab.php -->
	...
	<div id="content" style="background: #F9F9F9; padding-left:0px;">
     ...
     <ul class="menu-speedbar">
		 ...
		 ?>
         <li><a href="logout.php" style="color:#d9d907;">Sign Out</a></li>
     </ul>
     </div>
     </div>
     <!--SpeedBar END-->
 		     ...
 		     <div class="row-fluid" style="display:block; height:200px;">	            
                <div style="display:block; margin:15px; padding-top:0px;">
                            ...
                            <div style="vertical-align:top; float:right; display:inline-block; margin-left:20px; margin-right:30px;">
                                        ...
                                        <a id='MedHistory'  value="MedHistory" class="btn ButtonDrAct"  title="MedHistory" >  
                                        
		                     	        <img src="images/icons/medhistory_svg.png" style=" margin-top:-2px; width:50px; height:50px;">
		                     	        <div style="line-height:25px; margin-left:6px;"><span>History</span></div>
                                        
	                     	         </a>
                              
                                <a href="patientdetailMED-new.php?IdUsu=<?php echo $UserID;?>" id='Records'  value="Records" class="btn ButtonDrAct"  title="Records" > 
		                     	        <img src="images/icons/records_svg.png" style=" margin-top:-2px; width:50px; height:50px;">
		                     	        <div style="line-height:25px; margin-left:6px;"><span>Records</span></div>
	                     	         </a>
                                     <a id='Talk'  value="Talk" class="btn ButtonDrAct"  title="Talk" > 
                          	         ...
                          	         <a id='SetUp'  value="Account" class="btn ButtonDrAct" title="SetUp"> 
             ...
             <div style="float:left; height:290px; width:900px; margin: 30px auto; margin-top:-10px; margin-left:30px; margin-right:30px; padding:10px; border:1px solid #cacaca; font-size:0px; ">             
                ...
                <div class="UpperRow" style="float:left; margin-top:-40px; width:855px; border:1px solid #cacaca; padding:10px; margin:10px; border-radius: 3px;">
	             	...
	             	<div style="float:left; width:; height:24px;  border:0px solid #cacaca; ">
		             	<div id="PHSLabelOrig" style="float:left; margin-left:23px; width:360px; height:22px;  border:0px solid #cacaca; text-align:center; font-size:18px; color: #54bc00;">Personal Health Summary</div>
		             	<div id="MHRLabel" style="float:left; margin-left:20px; width:360px; height:22px;  border:0px solid #cacaca; text-align:center; font-size:18px; color: #54bc00;">Medical History Reports</div>
	             	</div>	 	
					...
					<button id="PHSLabel" class="find_doctor_button" style="float:left; display: block; background-color: rgb(82, 216, 89); width:80px; margin-top: 0px;height: 16px;font-size: 12px;line-height: 12px;">See Graph</button>
					<button id="ButtonReview" class="find_doctor_button" style="float:left; margin-left:10px; display: block; background-color: rgb(34, 174, 255); width:80px; margin-top: 0px;height: 16px;font-size: 12px;line-height: 12px;">Edit</button>
...
//		$.post("GetConnectedLight.php", {User: queMED, NReports: 3, Group: group}, function(data, status)
	...
	if (Canvas1State == 0)	{
		...
		*/
		...
		titleU =  'Latest update on '+ sourceDate.substr(0, 10);			
		...
		if (DiffDays < 14) textDate = DiffDays+' days';
		if (DiffWeeks >= 2) textDate = DiffWeeks+' weeks';
		if (DiffWeeks >= 8) textDate = DiffMonths+' months';
		if (DiffMonths >= 13) textDate = DiffYears+' years';
		...
		if (updated > 1) 
			{
				...
				iconTime = '<button id="UpdateSumm" class="find_doctor_button" style="float:right; display: block; background-color: rgb(82, 216, 89); width:80px; margin-top:-3px;">Update</button>';
			}
		else
			{
				contentTime = 'Updated';
		...
		if (DiffYears > 4) 
			{
				contentTime = 'Summary never updated'; 
				iconTime = '<i class="icon-exclamation icon-2x" style="float:left; color:rgb(216, 72, 64);"></i><button id="UpdateSumm" class="find_doctor_button" style="float:right; display: block; background-color: rgb(82, 216, 89); width:80px; margin-top:-3px;">Update</button>';
			}
		...
		if (bestVerified > -1)
		{
			...
			title =  'Verified by '+namedoctor+' on '+ VerifiedDate.substr(0, 10);
			iconVerif = '<i class="icon-check icon-2x"></i>';			
		}
		else
		{
			contentVerif = 'Not Verified'; 
			iconVerif = '<i class="icon-exclamation icon-2x" style="float:left; color:rgb(216, 72, 64);"></i><button id="VerifyDoctor" class="find_doctor_button" style="float:right; display: block; background-color: rgb(34, 174, 255); width:80px; margin-top:-3px;">Verify</button>';			
		}
		...
		contentAlt += '									<div style="float:left; width:180px; height:30px; font-size:16px; color:#22aeff; margin-left:20px; margin-top:4px;" title="'+titleU+'"> '+contentTime+'</div>	';				             	
		...
		contentAlt += '									<div style="float:left; width:180px; height:30px; font-size:16px; color:#22aeff; margin-left:20px; margin-top:4px;" title="'+title+'"> '+contentVerif+'</div>		';			             	
		...
		contentAlt += '									<div style="float:left; width:180px; height:30px; font-size:16px; color:#22aeff; margin-left:20px; margin-top:4px;" title="'+title+'"> '+complete+' events registered</div>		';			             	
...
//		rgb(74, 134, 54);
   ...
   $("#Reply").show();
    ...
    $("#BotonBusquedaPac").click(function(event) {
    	    ...
    	    var serviceURL = 'htt+ '?Usuario=' + UserInput; 

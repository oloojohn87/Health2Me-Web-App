...
<html lang="en" style="background: #F9F9F9;"><head>
  ...
  <body style="background: #F9F9F9;" onload="justtest();">
	 ...
	 <div class="content" style="">
        ...
        <?php
              ...
              $avat = 'identicon.php?size=75&hash='.$hash;
                ...
                <div style="width:940px; margin-left:30px; margin-right:0px; margin-top:30px;" >
                        <div class="grid" style="width:100%; margin: 0 auto;">
                                    <div class="grid-title">
...
$(window).load(function() {
  ...
  var gritterOptions = {
    ...
    function getPatientList() 
    {
         ...
         var UConn = $('#UConn').val();
	     var UTotal = $('#UTotal').val();
	     var TotMsg = $('#TotMsg').val();
	     var TotUpDr = $('#TotUpDr').val();
	     var TotUpUs = $('#TotUpUs').val();
         
         lastPage = Math.ceil(UConn/numDisplay);
         updatePageDisplay();

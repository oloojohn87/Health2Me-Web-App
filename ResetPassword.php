...
<!--    <script type="text/javascript" src="http://code.jquery.com/jquery-1.8.0.min.js"></script>-->
    ...
    <script>
     ...
     function getEmailID (token){
         ...
         var check=LanzaAjax(url);
         //alert('emailvalidationreturn'+check);
         if(check=='0'){$("#close_error_bar").hide();alarma('Request invalid or expired! <a href="SignIn.php#" style="color:white">click here to make a new request for password reset</a>','')}else{return check;}

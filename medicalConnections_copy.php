        ...
        <div id="header-modal" class="modal hide" style="display:none; width:800px; left:20%; margin-left: auto; margin-right: auto;" aria-hidden="true">
            <div class="modal-header" style="height:65px;">
                ...
                <div style="width:90%; margin-top:12px; float:left; line-height:12px;">
                    <div id="selpat" style="width: 100px; margin-left:5%; float: left; color: rgb(61, 147, 224);">
                        <div style="font-size: 20px; font-weight: bold; width: 100%; margin-bottom:15px;" lang="en">Step 1</div>
                        <span style="font-size: 12px; width: 100%;" lang="en">Select Member</span>
                    </div>
                    <div id="seldr" style="width:100px; margin-left:5%; float:left;">
                        <div style="font-size:20px; font-weight:bold; width:100%; margin-bottom:15px;" lang="en">Step 2</div>
                        <span style="font-size:12px; width:100%;" lang="en">Select Doctor</span>
                    </div>
                    <div id="att" style="width:100px; margin-left:5%; float:left;">
                        <div style="font-size:20px; font-weight:bold; width:100%; margin-bottom:15px;" lang="en">Step 3</div>
                        <span style="font-size:12px; width:100%;" lang="en">Attach Reports</span>
                    </div>
                    <div id="addcom" style="width:100px; margin-left:5%; float:left;">
                        <div style="font-size:20px; font-weight:bold; width:100%; margin-bottom:15px;" lang="en">Step 4</div>
                ...
                <div id="ContentScroller" style="width:100%; height:280px; overflow: hidden; ">
                        ...
                        <div id="content_selpat" style="float:left; width:400px; height:270px; ">
                            ...
                            <div class="grid" style="float:left; width:90%; height:265px; margin: 0 auto; margin-left:2%; margin-top:0px; margin-bottom:0px; overflow:auto;">
                                ...
                                <div class="search-bar">
                                    <input type="text" class="span" placeholder="Search Member" style="width:150px;" lang="en" id="SearchUserT"> 
                                    <input type="button" class="btn btn-primary" value="Filter" style="margin-left:50px;" lang="en" id="BotonBusquedaPacCOMP">
                                </div>
                        ...
                        <div id="content_seldr" style="float:left; width:400px; height:370px; ">
                            ...
                            <div class="grid" style="float:left; width:90%; height:265px; margin: 0 auto; margin-left:2%; margin-top:0px; margin-bottom:0px; overflow:scroll;">
                                ...
                                <div class="grid-title">
                                    ...
                                    <input type="text" class="span" name="" placeholder="Doctor's email" style="margin:5px; margin-left:10px; width:32%;" id="DoctorEmail" lang="en"> 
                                    <input type="button" class="btn btn-primary" value="Add" style="margin-top:7px; margin-left:7px;" id="AddNonUser" lang="en">
                                ...
                                <div class="grid-title">
                                    <div class="pull-left" lang="en"><div class="fam-user-delete" style="margin-right:10px;"lang="en"></div>Select a Doctor</div>
                                ...
                                <div class="search-bar">
                                    ...
                                    <input type="text" class="span" name="" placeholder="Search Doctor" style="width:150px;" lang="en"id="SearchDoctor"> 
                                    <input type="button" class="btn btn-primary" value="Filter" style="margin-left:50px;" lang="en"id="BotonBusquedaMedCOMP">
                    ...
                    <span style="margin-right:20px; font-size:14px; color:#22aeff; " lang="en"> Referral Type</span>:
                            ...
                            <div style="height:40px; width:500px;margin-top:10px">
                                ...
                                <input type="text" id="cellphone" placeholder="Phone Number" style="width:180px; margin-left:20px; margin-top:-5px;" />
                            </div>
            ...
            <div id="footer-modal" style="height:120px;">
                ...
                <div style="height:20px; width:90%; text-align: right; display:inline-block;">
                    ...
                    <input type="button" class="btn btn-success" value="NEXT" id="Attach" style="visibility: hidden;"lang="en">
                    ...
                    <input type="button" class="btn btn-info" value="Previous" id="PhasePrev" lang="en">
                    <input type="button" class="btn btn-success" value="NEXT" id="PhaseNext" style="width:100px;" lang="en">
                ...
                <div class="tab-pane tab-overflow-main fade in active" id="sendR">
                    ...
                    <div class="grid" style="float:left; width:95%; margin: 0 auto; margin-left:2%; margin-top:10px; margin-bottom:30px;">
                        ...
                        <div class="search-bar">
                            ...
                            <input type="button" class="btn btn-primary" lang="en" value="Filter" style="margin-left:50px;"lang="en"id="BotonBusquedaSents">
                ...
                <div class="tab-pane" id="getR">
                    ...
                    <div class="grid" style="float:left; width:95%; margin: 0 auto; margin-left:2%; margin-top:10px; margin-bottom:30px;">
                        ...
                        <div class="search-bar">
                            ...
                            <input type="button" class="btn btn-primary" lang="en" value="Filter" style="margin-left:50px;"lang="en" id="BotonBusquedaPermit">
    ...
    function DrawRadarPatients (startingPatient, endingPatient)
    {
        ...
        while (parseInt(n) <= endSequence)
        {
            ...
            wedgeP.on('touchstart click mouseover', function(evt) {
                ...
                $('#DrName').html(RealIndex + ' ' + PatientName[RealIndex]).css('color', DrColor[RealIndex]);
            ...
            if (mustDrawReferral == 1)
            {
                ...
                wedge.on('touchstart click mouseover', function(evt) {
                    ...
                    if (brokenReferral[m] == 0)
                        $('#DrName').html(ReferralNameFULL[RealM]).css('color', DrColor[RealM]); 
                    else 
                        $('#DrName').html(ReferralNameFULL[RealM]+'../.').css('color', DrColor[RealM]);
                ...
                wedge.on('click', function() {
                    ...
                    if(InOutFlag == 'out') {
                        queUrl = 'getSents.php?Doctor='+IdMed+'&DrEmail='+UserDOB+'&NReports=3&ToDoc='+DrId+'&state=2';
                        $('#TablaSents').load(queUrl);
                        $('#TablaSents').trigger('update');
                    }
                    else {
                        queUrl ='getPermits.php?Doctor='+IdMed+'&DrEmail=&NReports=3&ToDoc='+DrId;
                        $('#TablaPermit').load(queUrl);
                        $('#TablaPermit').trigger('update');  
                    }
                    
                    var txt='<b> Dr. '+DoctorsNames[DrId] + '</b>';
                    $('#radartext').html(txt).css('color',DrColor[RealM]);
                    $('#BotonBusquedaReset').show();
                    $('#BotonBusquedaReset').show();
                    $('#radartext2').html(txt).css('color', DrColor[RealM]);
...
*/    
    ...
    $("#BotonBusquedaReset2").click(function(event) {
        ...
        if($('#Group_toggle').is(":checked")) 
            group = 1;
        var queUrl ='getPermits.php?Doctor='+IdMed+'&DrEmail=&NReports=3&Username='+Username+'&group='+group;
        $('#TablaPermit').load(queUrl);
        $('#TablaPermit').trigger('update');
        $('#radartext2').html("");
    ...
    function SendWelcomeMessage(){ 
        ...
        var cadena='sendMessage.php?sender='+IdDocOrigin+'&receiver='+IdDoctor+'&patient='+IdPaciente+''+'&content='+content+'&subject='+subject+'&attachments='+reportids+'&connection_id='+RecTipo+'&type=referral';
    ...
    $(".CFILADoctor").live('click',function() {
        ...
        /*if(PhoneDoctor.length == 10)
            PhoneDoctor = '+1' + PhoneDoctor;
        else if(PhoneDoctor.length > 10)
...
*/
    ...
    /*CONTROL SEND REFERRAL BOOTSTRAP COLLAPSE 
    $('.collapse').on('show.bs.collapse', function() {
        $('#send_referral_title').css({'background':'#3b9ee1', 'opacity': 0.65});
        $('#caret_down').removeClass('fa-caret-down');
        $('#caret_down').addClass('fa-caret-up');
    });
    $('.collapse').on('hide.bs.collapse', function() {
        $('#send_referral_title').css({'background-image':'linear-gradient(to bottom, #5ab1f4, #3b9ee1)', 'opacity': 1});
        $('#caret_down').removeClass('fa-caret-up');
        $('#caret_down').addClass('fa-caret-down');
    });

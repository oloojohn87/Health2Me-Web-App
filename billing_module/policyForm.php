    ...
    <div id="container_box">
        <form id="PolicyForm" method="post" action="billing_save.php">
            <section class="half_line">
                ...
                <div class="line">
                    <label for="PID">Policy ID: </label><input class="codeslot ajax_search" type="text" id="PID" name="PID" value="" />             
            ...
            <section class="half_line">
                <div class="line">
                    <span id="PNTitle">&emsp;&emsp;&emsp;Insurance Card Front</span><span id="PNTitle">&emsp;&emsp;&emsp;&emsp;Insurance Card Back</span>
                </div>
                <div class="line">
            ...
            <div class="line">
                <span id="PNTitle">Policy Holder</span>
            </div>

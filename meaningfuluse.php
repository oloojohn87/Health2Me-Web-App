     ...
     <div class="content" >
	  ...
	  <!--- VENTANA MODAL NUMERO 2  ---> 
        ...
        <div class="grid" class="grid span4" style="width:1000px; margin: 0 auto; margin-top:30px; height:2000px; padding-top:30px; padding-left:20px;">
	        	 <span class="label label-info" style="left:0px; margin-left:10px; margin-top:40px; font-size:30px;">Meaningful Use Console&copy</span>
        ...
        <div class="grid" style="width:97%;">
          <div class="grid-title">
            <div class="pull-left"><span style="color:#3D93E0; font-size:18px;">Form #1.- Demographics</span></div>
          ...
          <div class="grid-content">
           	...
           	<span style="color:#3D93E0; font-size:16px; font-weight:bold;">Basic Demography :</span> 
           	<div class="clear"></div>
           	<span style="color:#3D93E0; font-size:16px;">Date of Birth :</span> 8-Aug-1966
          	</br>
          	<span style="color:#3D93E0; font-size:16px;">Gender :</span> Male
          	
          	<hr>
          	
           	<span style="color:#3D93E0; font-size:16px; font-weight:bold;">Biometrics :</span> 
         	<table width="100%" style="background-color:white;">
	          	<tr>
		          	<td><span style="color:#3D93E0; font-size:16px;">Weight :</span> 130 pounds</td>
		          	<td><span style="color:#3D93E0; font-size:16px;">Stature :</span> 5 feet 75</td>
		        </tr>
		        <tr>
			        <td><span style="color:#3D93E0; font-size:16px;">Edad :</span> 8-Aug-1966</td>
			        <td><span style="color:#3D93E0; font-size:16px;">Edad :</span> 8-Aug-1966</td>
			    </tr>
			</table>
			...
			<div class="clear"></div>
          	<span style="color:#3D93E0; font-size:16px; font-weight:bold;">Alergies :</span> 
            <div class="clear"></div>
            <span style="color:#3D93E0; font-size:16px;">Grass :</span> Strongly positive
            <div class="clear"></div>
          	<span style="color:#3D93E0; font-size:16px;">Pollen :</span> Negative
            <div class="clear"></div>
          	<span style="color:#3D93E0; font-size:16px;">Grass :</span> Negative
            <div class="clear"></div>
          	<span style="color:#3D93E0; font-size:16px;">Animal dander :</span> Positive
            <div class="clear"></div>
          	<span style="color:#3D93E0; font-size:16px;">Mold :</span> Negative
...
?>
          <div class="note" id="<?php echo $row['IdPin']; ?>" style="-webkit-box-shadow: 3px 3px 14px rgba(25, 25, 25, 0.5); -moz-box-shadow:3px 3px 14px rgba(25, 25, 25, 0.5); box-shadow:3px 3px 14px rgba(25, 25, 25, 0.5);">
            ...
            <div class="note-title" style="height:15px; margin-top:0px; margin-bottom:0px; font-size:12px;"  id="<?php if (!$row['EvRuPunt']){$indi = 999; $salida=$EventoALFA; }else{$indi = $row['EvRuPunt']; $salida=$Clase[$indi]; }; echo $salida;?>"><?php echo $salida;?></div>

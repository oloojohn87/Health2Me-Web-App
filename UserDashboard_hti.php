	...
	<!--Header Start-->
        ...
        <input type="hidden" id="CURRENTCALLINGDOCTORNAME" Value="<?php echo $current_calling_doctor_name; ?>" />
		   ...
		   <div class="btn-group pull-right" >
			...
			<li>
			 <?php if ($privilege==1)
					echo '<a href="UserDashboard_hti.php">';
				   else if($privilege==2)
...
<!-- End of code inserted from userdashboard-new-pallab.php -->
   	 ...
   	 <button id="message_modal" data-target="#header-message" data-toggle="modal" class="btn btn-warning" style="display: none;" lang="en">Modal with Header</button> 
         ...
         <div class="formRow" style=" margin-top:-10px; margin-bottom:10px;">
             <span id="ToDoctor" style="color:#2c93dd; font-weight:bold;"><span lang="en">TO</span> <?php echo 'Dr. '.$NameDoctor.' '.$SurnameDoctor; ?></span><input type="hidden" id="IdDoctor" value='<?php echo $IdDoctor; ?>'/>
         </div>
                ...
                <div style="display:block; margin:15px; padding-top:0px;">
                            ...
                            <div style="vertical-align:top; float:right; display:inline-block; margin-left:20px; margin-right:30px;">
                                        ...
                                        <a id='MedHistory'  value="MedHistory" class="btn ButtonDrAct"  title="MedHistory" >  
		                     	        ...
		                     	        <div style="line-height:25px; margin-left:6px;"><span lang="en">History</span></div>
                                ...
                                <a href="patientdetailMED-new.php?IdUsu=<?php echo $UserID;?>" id='Records'  value="Records" class="btn ButtonDrAct"  title="Records" > 
		                     	        ...
		                     	        <div style="line-height:25px; margin-left:6px;"><span lang="en">Records</span></div>
	                     	         </a>
...
//		rgb(74, 134, 54);
   ...
   $("#Reply").show();
    ...
    $("#BotonBusquedaPac").click(function(event) {
    	    ...
    	    var serviceURL = p' + '?Usuario=' + UserInput; 

...
<html lang="en"><head>
  ...
  <body onload="$('#BotonBusquedaPac').trigger('click');" style="background: #F9F9F9;">
	...
	<div id="content" style="background: #F9F9F9; padding-left:0px;">
     ...
     <!--CONTENT MAIN START-->
     <div class="content" style="height:3500px; background-color:orange;">
  	...
  	$("#BotonAnadirPaciente").live('click',function() {
	    ...
	    // var Year =  UserDOB.substr(queImg.length-3,3);;
		 ...
		 var OrderOB =  UserDOB.substr(9,1);
 		 ...
 		 var encontF = UserInput.lastIndexOf('.');domain.
 		 ...
 		 if (mensaje=='' && mensaje2=='')
 		 {
	 		...
	 		if (r==true)
	 			{	 	    
		 			...
		 			var RecTipo = LanzaAjax (queUrl);domain.
 	  ...
 	  function LoadPinData (selector,quethis){
	    ...
	    else
	    {
	    	...
	    	{
		    	var contenTHURL ='<?php echo $domain;?>/PackagesTH/'+queImg;  // PONER /PinImageSetTH/ en lugar de /PinImageSet/ PARA CARGAR THUMBNAILS EN LUGAR DE IMAGENES COMPLETAS

...
//CONSTRUCTOR FUNCTION INITIALIZES ON OBJECT CREATION////////////////////////////////////////////////////////////////////////
	function __construct(){
		...
		if(!isset($_SESSION['MEDID']) && !empty($_SESSION['MEDID']))
			{
			echo "<META http-equiv='refresh' content='0;URL=".$this->hardcode."index.html'>";
			}
	...
	//These allow for correct encoding of doctor name....
        ...
        $this->doctor_pdmst_priv = $row['grant_access'];
	...
	public function exit_onfail($exitType){
	echo "<!DOCTYPE html>

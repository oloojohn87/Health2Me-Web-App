				...
				//E-PRESCRIBE FOR HTI & H2M
			     ...
			     if(($MedID > 0)&&($privilege != 3))
                 {
                    ...
                    //if ($privilege != 3) { 
                        ...
                        echo '<a id="Drop_Button" class="btn ButtonDrAct" href="dropzone_short.php?IdUsu='.$IdUsu.'" style="margin-top: -10px; margin-left: 15px; width: '.$width.'; height: '.$height.'"lang="en">';
                        ...
                        echo '    <div style="line-height:25px; width: '.$label_width.'; height: 25px; font-size: '.$label_font_size.'; margin-left: '.$label_margin_left.';"><span lang="en">Drop Files</span></div>';
                        echo '</a>';
             ...
             <?php 
                ...
                if($medid != $userid) 
                    { 
                        ...
                        $superbill .= 'px; background-color:'.$TipoColorGroup[9].'"><a href="#ALL" lang="en" data-toggle="tab" style="height:40px; color:'.$TipoColorGroup[9].'"><i class="'.$TipoIconGroup[9].' icon-large" style="color:RGB(111,111,111); font-size: 1.0em; width:100%;"></i><div style="width:80%" ></div>Superbill</a></li>';
                        echo $superbill;
                    } 
                ?>

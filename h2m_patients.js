...
var timeoutTime = 18000000;
    ...
    function searchMember() {
        ...
        var queUrl ='getFullUsersMEDNEW.php?Usuario='+UserInput+'&IdMed='+queMED+'&Group='+onlyGroup+'&OFFSET='+OFFSET;
 	...
 	//var LIMIT=10;
 	var OFFSET=0;
 	var standardsize=520;		//This depends on the size of the window
    ...
    var origScrollTop = $(window).scrollTop()+standardsize;

 	/*$(window).scroll(function() {
 		console.log('scroll position');
	 	console.log($(window).scrollTop());

	 	if(($(window).scrollTop() - origScrollTop) >windowSize){

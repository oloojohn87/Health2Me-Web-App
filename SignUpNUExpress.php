            ...
            <div>
                <form method="post" id="FormSU" action="AddNonUser.php" class="form-login"> 
                    ...
                    <div class="inputs">
                        ...
                        <input type="text" name="fakeinputforpreventingautofill" style="display:none;" />
                        ...
                        <input type="password" name="fakeinputforpreventingautofill" style="display:none;" />
...
<!--    <script type="text/javascript" src="http://code.jquery.com/jquery-1.8.0.min.js"></script>-->
    ...
    <script>
        ...
        $('#BotonEnviaF').bind("click", function(){
	        ...
	        //valdato = $('#ValorGlobal').val(); if (valdato!=0) {todos=1;}
	     ...
	     if (tipo>10){
		     switch (tipo){
				 case 11: if (dato.length<8)   // 11: COMPRUEBA QUE LA LONGITUD SEA AL MENOS DE 8 CARACTERES
				 		  {
				 		  mensaje = 'Password value must be at least 8 characters long';
			     		  alarma (mensaje,selector);
			     		  quevalor = '';
			     		  pasa = 0;
			     		  $('#ValorGlobal').val('-1');
				 ...
				 case 12: if (dato.length<2)   // 12: COMPRUEBA QUE LA LONGITUD SEA AL MENOS DE 2 CARACTERES
				 		  {
				 		  mensaje = 'Surname value must be at least 2 characters long';
			     		  alarma (mensaje,selector);
			     		  quevalor = '';
			     		  pasa = 0;
			     		  $('#ValorGlobal').val('-1');
				 ...
				 case 13: if (dato.length<6)   // 13: COMPRUEBA QUE LA LONGITUD SEA AL MENOS DE 6 CARACTERES
				 		  {
				 		  mensaje = 'Value must be at least 6 characters long';
			     		  alarma (mensaje,selector);
			     		  quevalor = '';
			     		  pasa = 0;
			     		  $('#ValorGlobal').val('-1');
			     		  ...
			     		  break;
                 case 14: if (dato.length<2)   // 14: COMPRUEBA QUE LA LONGITUD SEA AL MENOS DE 2 CARACTERES
				 		  {
				 		  mensaje = 'Name value must be at least 2 characters long';
			     		  alarma (mensaje,selector);
			     		  quevalor = '';
			     		  pasa = 0;
			     		  $('#ValorGlobal').val('-1');
	 ...
	 function alarma(mensaje,selector)
	 {
         if (mensaje=='') { var tama = '0px'; $(selector).css ('background-color','white'); }else { var tama = '40px'; $(selector).css ('background-color','#FFF8DC'); }
             ...
             $('.MsgAlarma2').animate({
                 ...
                 $(this).html('<p style="text-align:center; color:white; margin:10px; top:10px; position:relative;">'+mensaje+'</p>');
             });

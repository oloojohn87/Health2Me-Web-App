...
$("#personal_doctor_share_button").on('click', function()
{
    ...
    else
    {
        ...
        $.post("../../../ajax/set_personal_doctor.php", {user_id: $("#USERID").val(), accept: 1}, function(data, status)
        {
            get_personal_doctor();
        });
...
$("body").on('click', ".personal_doctor_message_reply_button", function()
{
    ...
    $.post("../../../ajax/reply_to_personal_doctor.php", {user: $("#USERID").val(), message: $(this).parent().children('.personal_doctor_message_reply_text').eq(0).val(), id: $(this).data("id")}, function(data, status)
    {
...
$("#personal_doctor_set_button").on('click',function()
{
    ...
    $.post("../../../ajax/share_with_doctor.php", {add: 1, doctor: emailId, patient: user, idpins: idpins}, function(data, status)
    {
...
function get_personal_doctor_messages()
{
    ...
    $.post("../../../ajax/get_personal_doctors_messages.php", {doctor: my_personal_doctor, patient: $("#USERID").val(), search: $("#personal_doctor_message_search_bar").val()}, function(data, status)
    {
    ...
    $.post("../../../ajax/get_my_personal_doctors.php", {id: $("#USERID").val()}, function(data, status)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                html += '<img class="doctor_pic" src="../../../ajax/identicon.php?size=25&hash='+doc['image']+'" />';
            }

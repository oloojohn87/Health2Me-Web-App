...
function addAdditionalLicenses(){
	...
	$.post('../../../ajax/addAdditionalLicense.php', {med_id:med_id, state:state, type:'add'})
		.done(function(data){
...
function removeAdditionalLicenses(){
	var state = $('#state2').val();
	$.post('../../../ajax/addAdditionalLicense.php', {med_id:med_id, state:state, type:'remove'})
		.done(function(data){
		displayAdditionalLicenses();
		});
}
...
function displayAdditionalLicenses(){
	$.post('../../../ajax/addAdditionalLicense.php', {med_id:med_id, type:'display'})
		.done(function(data){
...
displayAdditionalLicenses();
	...
	function fileSelected() {
      ...
      function uploadFile2() {
        ...
        xhr.open("POST", "../../../ajax/uploadifyDoctor.php?pulldoc="+med_id, true);
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    $(document).ready(function() { 
        ...
        $.ajax({
            url: '../../../ajax/notification_docSetting.php',
		...
		//SHOW GROUP TABLE
		var grptble = LanzaAjax('../../../ajax/getGroupDetails.php?docid='+med_id+'');
        ...
        {
            alert(message);
            window.location = "../../../ajax/medicalConfiguration.php";
        }
        $("#change_password_validate_button").live('click', function()
        {
            console.log('doc_id: '+$("#MEDID").val()+', pw: '+$("#pw1").val());
            $.post("../../../ajax/validate_password.php", {doc_id: $("#MEDID").val(), pw: $("#pw1").val()}, function(data, status)
            {
                console.log(data);
        ...
        {
            $.post("../../../ajax/reset_doctor_availability.php", {ID: $("#USERDID").val()}, function(data, status)
            {   
                if(data == '1')
                {
        ...
        $("#change_password_finish_button").live('click', function()
        {
            if($("#pw2").val() == $("#pw3").val())
            {
                ...
                $.post("../../../ajax/update_doctor.php", {new_pw: $("#pw2").val(), doc_id: $("#MEDID").val()}, function(data, status)
                {
                    $("#pw2").val("");
                    $("#pw3").val("");
        ...
        function get_seals(state, country) {
            var sealUrl = '../../../ajax/get_my_seal.php?state='+state+'&country='+country;
            var sealOutput = '';
            $.ajax({
                url: sealUrl,
                dataType: 'html',
        ...
        function stripeResponseHandler(status, response) {
            ...
            else 
            {
                ...
                $.post("../../../ajax/change_credit_card.php", {type: '1', action: '1', id: $("#USERDID").val(), token: response.id, full_name: $("#bank_account_name").val()}, function(data, status)
                {
                    console.log(data);
		...
		if($("#USERDID").val() != ''){
        $.post("../../../ajax/get_doctor_credit_cards.php", {id: $("#USERDID").val()}, function(data, status)
        {
            /*var info = JSON.parse(data);
            if(info.hasOwnProperty('cards') && info['cards'].length > 0)
            {
        ...
        $.get("../../../ajax/get_certifications.php", function(data, status)
        {
            certifications = JSON.parse(data);
            keys = Object.keys(certifications);
            
            $.post("../../../ajax/get_certifications.php", {id: $("#MEDID").val()}, function(data, status)
            {
                var info = JSON.parse(data);
        ...
        $("#set_rate").live('click',function() 
        {
            ...
            if(isNumber)
            {
                $.post("../../../ajax/UpdateMEDUser.php", {telemed: true, hr_rate: $("#rate").val(), EnviaUserid: $("#USERDID").val()}, function(data, status){console.log(data);});
            }
            else
            {
        ...
        $('input#start_telemed').on('switchChange.bootstrapSwitch', function(e, s) {
            ...
            if($("#telemed_on").val() == "0")
            {
                $.post("../../../ajax/getTelemedAvailability.php", {get_telemed_info: 1, med_id: $("#MEDID").val()}, function(data, status)
                {
                    ...
                    //{
                        $("#telemed_on").val("1");
                        $.post("../../../ajax/getTelemedAvailability.php", {med_id: $("#MEDID").val(), set_on: 1}, function(data, status){});
                        /*$("#start_telemed").css("background-color", "#74F677");
                        $("#start_telemed").css("border-color", "#74F677");
            ...
            {
                $("#telemed_on").val("0");
                $.post("../../../ajax/getTelemedAvailability.php", {med_id: $("#MEDID").val(), set_on: 0}, function(data, status){});
                /*$("#start_telemed").css("background-color", "#F66765");
                $("#start_telemed").css("border-color", "#F66765");
        ...
        function load_appointments()
        {
            ...
            $.get("../../../ajax/get_appointments.php?doc_id="+$("#MEDID").val(), function(data, status)
            {
                console.log(data);
        ...
        function refresh_appointments()
        {
            ...
            $(".app_clear").on('click', function()
            {
                ...
                $.post("../../../ajax/update_appointment.php", {id: info[2], specific_time: 'n'}, function(data, status){console.log(data);});
            });
            ...
            $(".app_save").on('click', function()
            {
                ...
                $.post("../../../ajax/update_appointment.php", {id: info[2], specific_time: $(this).prev().val()}, function(data, status)
                {
                    button.html('Save');
                });
            });
            $("button[id^='app_del_']").on('click', function()
            {
                ...
                {
                    var info = $(this).attr("id").split("_");
                    $.get("../../../ajax/delete_appointment.php?id="+info[2], function(d, status)
                    {
		...
		get_user_event_config('../../../ajax/getusereventconfig.php');
		...
		get_user_notify_time('../../../ajax/getusernotifytime.php');
    ...
    $('#notif_update').click(function() {
        ...
        var cadena = '../../../ajax/notification_docSetting.php?idDoc='+med_id+'&notifIDs='+notifArrayString+'&group='+$("#groupN").val();
        LanzaAjax(cadena);
	...
	function saveEMRConfig()
	{
		...
		var url='../../../ajax/save_emr_config.php?ph='+personal_checked+'&fh='+family_checked+'&pastdx='+pastdx_checked+'&medications='+medications_checked+'&immunizations='+immunizations_checked+'&allergies='+allergies_checked+'&address='+address_checked+'&address2='+address2_checked+'&city='+city_checked+'&state='+state_checked+'&country='+country_checked+'&notes='+notes_checked+'&fractures='+fractures_checked+'&surgeries='+surgeries_checked+'&otherknown='+otherknown_checked+'&obstetric='+obstetric_checked+'&othermed='+othermed_checked+'&father='+father_checked+'&mother='+mother_checked+'&siblings='+siblings_checked+'&phone='+phone_checked+'&insurance='+insurance_checked;
		//alert(url);
	...
	{	
		var serviceURL = '../../../ajax/clear_scheduler_data.php';
		...
		for(var j=0;j<predefined_events;j++)
		{
			...
			if(deleted_elements.indexOf(j)==-1)
			{
				...
				var url = '../../../ajax/create_type_config_entry.php?title='+title+'&hours='+hours+'&minutes='+minutes+' &colour='+colour;
				//alert(url);
				var RecTipo = LanzaAjax(url);
				//alert(RecTipo);
			}
		...
		var url = '../../../ajax/save_notify_time.php?id='+ $('#notify_id').val() +'&minutes='+ $('#appoint_notify').val();
		//alert(url);
		RecTipo = LanzaAjax(url);
		
		
		
		var timezone_url = '../../../ajax/save_user_timezone.php?userid='+med_id+'&timez=' + $('#Timezone').val();
		//alert(timezone_url);
	...
	$(".CFILADoctorEdit").live('click',function() {
		...
		GetGroupData('../../../ajax/getGroupData.php?groupid='+groupid);
			
		var grpdoctble = LanzaAjax('../../../ajax/getGroupDocs.php?docid='+med_id+'&groupid='+groupid);
    ...
    // this represents the checkbox that was checked
		...
		var getchkval=checkowner();
			...
			if (getchkval>0){
				//alert (" Admin rights");
				if($(this).is(':checked'))  {
					var cadena='../../../ajax/addDoctorAsAdmin.php?groupid='+groupid+'&id='+parentid;
					var RecTipo=LanzaAjax(cadena);
					
				}else{
					var cadena='../../../ajax/RemoveDocAsAdmin.php?groupid='+groupid+'&id='+parentid;
					var RecTipo=LanzaAjax(cadena);			   
				}
    ...
    // this represents the checkbox that was checked
		...
		var getchkval=checkowner();
			...
			if (getchkval>0){
				//alert (" Admin rights");
				if($(this).is(':checked'))  {
					var cadena='../../../ajax/addDoctorAsRole.php?groupid='+groupid+'&id='+parentid+'&role=1';
					var RecTipo=LanzaAjax(cadena);
					
				}else{
					var cadena='../../../ajax/addDoctorAsRole.php?groupid='+groupid+'&id='+parentid+'&role=2';
					var RecTipo=LanzaAjax(cadena);			   
				}
	   ...
	   var parentid=$(this).parents("tr.CFILAGroupDoc").attr("id");
		...
		var getchkval=checkowner();
			...
			if (getchkval>0){
				//alert (" Admin rights");
				if($(this).is(':checked'))  {
					var cadena='../../../ajax/addDoctorAsRefIncharge.php?groupid='+groupid+'&id='+parentid;
					var RecTipo=LanzaAjax(cadena);
					
				}else{
					var cadena='../../../ajax/addDoctorAsRefIncharge?groupid='+groupid+'&id='+parentid;
					var RecTipo=LanzaAjax(cadena);			   
				}
    ...
    function checkowner(){
		...
		var getownerval=LanzaAjax('../../../ajax/CheckOwner.php?docid='+med_id+'&groupid='+groupid);
	 ...
	 $("#remove_doc").live('click',function(){
	   ...
	   var checkowner=LanzaAjax('../../../ajax/CheckOwner.php?docid='+med_id+'&groupid='+groupid);
	   ...
	   if(checkowner>0){
		   ...
		   function () {
						...
						if(sThisVal==1){
						 ...
						 num=num+1;
						 var cadena='../../../ajax/removeDocFromGroup.php?id='+id+'&groupid='+groupid+'&docid='+docid;
						 LanzaAjax(cadena);
						}
    ...
    var VDocId = 0;
	var VDocName = '';
    $.get("../../../ajax/getValidDoctors.php", function(data, status)
    {
   ...
   */
		...
		if (window.File && window.FileReader && window.FileList && window.Blob) {
			...
			var reader = new FileReader();
				...
				tempImg.onload = function() {
					...
					if(whichimage==1){
						xhr.open('POST', '../../../ajax/uploadResized.php?groupid='+groupid, true);
	...
	$('#add_doctors').live('click', function(){
		...
		if(VDocId==0){
			...
			var cadena='../../../ajax/addDoctorInGroup.php?groupid='+groupid+'&docid='+VDocId;
			var RecTipo=LanzaAjax(cadena);
			if(RecTipo==0){
    ...
    $.post("../../../ajax/get_probe_protocols.php", {doctor: $("#MEDID").val()}, function(data, status)
	{
        ...
        $("button[id^='probe_question_button_']").live('click', function()
        {
            ...
            if(id != 0)
            {
                $.post("../../../ajax/get_probe_questions.php", {doc_id: $("#MEDID").val(), question_id: id}, function(data, status)
                {
                    var info = JSON.parse(data);
                    var d = info.question;
                    var u = info.units;
        ...
        $("#probe_question_edit_save").live('click', function()
        {
            ...
            $.post("../../../ajax/update_probe_question.php", {title: $("#probe_question_edit_title").val(), question_en: $("#probe_question_edit_question_en").val(), question_es: $("#probe_question_edit_question_es").val(), max: $("#probe_question_edit_max").val(), min: $("#probe_question_edit_min").val(), unit: $("#probe_question_edit_unit").val(), id: probe_question_edit_id, question: probe_question_edit_number, protocol: probe_question_edit_protocol, doctor: $("#MEDID").val(), units: JSON.stringify($("#probe_editing_range_selector").H2MRange2GetData())}, function(data, status)
            {
                console.log(data);
        ...
        {
            $.post("../../../ajax/update_probe_question.php", {id: probe_question_edit_id, question: probe_question_edit_number, protocol: probe_question_edit_protocol, doctor: $("#MEDID").val(), clear: 1}, function(data, status)
            {
                $("#probe_question_modal").dialog('close');
                if(probe_question_edit_id != 0)
                {
        ...
        $('.probes_delete_button').live('click', function()
        {
            ...
            swal({title: "Delete Probe",   
             ...
             {   
                if (isConfirm) 
                {
                    $.post("../../../ajax/delete_probe_protocol.php", {id: id}, function(data, status)
                    {
                        row.remove();
                    });
                }
        ...
        $("#probe_protocol_edit_save").live('click', function()
        {
            ...
            {
                $.post("../../../ajax/add_probe_protocol.php", {doctor: $("#MEDID").val(), name: $("#probe_protocol_edit_title").val(), description: $("#probe_protocol_edit_description").val(), probe_id: probe_protocol_edit_id, edit: true}, function(data, status)
                {
            ...
            {
                $.post("../../../ajax/add_probe_protocol.php", {doctor: $("#MEDID").val(), name: $("#probe_protocol_edit_title").val(), description: $("#probe_protocol_edit_description").val()}, function(data, status)
                {
                    var d = data.split("_");
                    var protocol = d[0];
                    var question = d[1];
	...
	$("#save_grpdate").live('click', function(){
	  ...
	  if(grpname==''||grpadd==''||grpzip==''||grpcity==''||grpstate==''||grpcountry==''){
	    ...
	    var cadena='../../../ajax/CreateGroup.php?grpname='+grpname+'&grpadd='+grpadd+'&grpzip='+grpzip+'&grpcity='+grpcity+'&grpstate='+grpstate+'&grpcountry='+grpcountry+'&docid='+med_id;
...
//		alert(grpid);
		...
		if(grpid>0){
				...
				if(defaultimage==false){
					...
					xhr.open('POST', '../../../ajax/uploadResized.php?groupid='+grpid, true);
					xhr.setRequestHeader("Content-type","application/x-www-form-urlencoded");
					var data = 'image=' + dataURL;
					xhr.send(data);
				}
    ...
    $("#paste_week").live('click', function()
    {
        ...
        {
            $.get("../../../ajax/createDoctorTimeslot.php?copy="+copyDate+"&paste="+pasteDate, function(data, status)
            {
    ...
    $("#clear_week").live('click', function()
    {
        ...
        if(answer)
        {
            $.get("../../../ajax/deleteDoctorAvailability.php?clear="+startDate.toISOString().split("T")[0], function(data, status)
            {
    ...
    $("#timezone_picker").change(function()
    {
        ...
        url= "../../../ajax/get_timezone.php?timezone="+current_timezone+"&email="+email+"&type=doctor";
        var RecTipo=LanzaAjax(url);   
    });
	...
	$("#prev").live('click',function() {
	 ...
	 function getWeeklyTimeslots(js_date)
     {
        var day = js_date.getDate();
			...
			var queUrl = '../../../ajax/getDoctorWeeklySchedule.php?week='+sqlDate;
			//console.log(queUrl);
			$.ajax(
			{
				url: queUrl,
	 ...
	 $( ".timeCellIndicatorOn" ).live("click", function(){
		...
		$.each( classList, function(index, item)
		{
			...
			if(item.indexOf('event') > -1)
			{
				...
				{
					//alert('deleting ' + id);
					var url = '../../../ajax/deleteDoctorAvailability.php?eventID='+id;
					//console.log(url);
					LanzaAjax(url);
	 ...
	 function createTimeslot(sTime,eTime,weekDay)
	 {
        ...
        if(picker_val.charAt(0) == '-')
        {
         ...
         curr_tmzn += nums[1];
		var url = '../../../ajax/createDoctorTimeslot.php?startDate='+sDate+'&startTime='+sTime+'&endTime='+eTime+'&weekday='+weekDay+'&timezone='+curr_tmzn;//current_timezone;
		console.log(url);
 ...
 function updateGroupInfo() {
	  ...
	  group_dialog.dialog("close"); if(grpname==''||grpadd==''||grpzip==''||grpcity==''||grpstate==''||grpcountry==''){
	    ...
	    var cadena='../../../ajax/SaveGroup.php?grpname='+grpname+'&grpadd='+grpadd+'&grpzip='+grpzip+'&grpcity='+grpcity+'&grpstate='+grpstate+'&grpcountry='+grpcountry+'&groupid='+groupid;
		var RecTipo=LanzaAjax(cadena);

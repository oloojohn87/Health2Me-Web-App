...
$user->pageLinks('PatientDetails.php');

//require_once("../../../ajax/displayExitClass.php");
//require('../../../ajax/push_server.php');

include_once('../patientdetailClass.php');	
$patient_details = new patientdetailClass();
    ...
    <!-- End of MOdal for PhoneNotes -->
     ...
     <ul class="menu-speedbar">
		<?php
            if($MedID > 0)
            {
                echo '<li><a href="../../maindashboard/html/MainDashboardCATA.php" lang="en">Home</a></li>';
                ...
                if ($privilege==1)
                {
                    ...
                    echo '<li><a href="../../membernetwork/html/MemberNetworkCATA.php"  lang="en">Patient Network</a></li>';
                if ($privilege==1)
                {
                
                    echo '<li><a href="../../configuration/html/ConfigurationCATA.php" lang="en">Configuration</a></li>';
                }

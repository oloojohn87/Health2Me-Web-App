...
$user = new medicalConnectionsClass();
$user->pageLinks('medicalConnections.php');
?>
...
if((count($arr_d['items'])>0)&&($arr_d['items'][0]['accessid']==1)){ 
    ...
    echo '<li><a lang="en" href="../../maindashboard/html/MainDashboardCATA.php"  lang="en">Dashboard</a></li>';
            ...
            {
                echo '<li><a href="../../medicalconnections/html/MedicalConnectionsCATA.php"  class="act_link" lang="en">Doctor Connections</a></li>';
...
<script type="text/javascript" >
    ...
    {
        $.ajax({
            url: '../../../ajax/ongoing_sessions.php?userid='+<?php echo $_SESSION['MEDID'] ?>,

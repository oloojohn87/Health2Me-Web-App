			...
			while (n <= maxReferrals)
			{
				...
				if (mustDrawReferral == 1)
				{
					...
					wedge.on('click', function() {
						...
						var IdMed = $('#MEDID').val();
						var UserDOB='';
						var queUrl ='../../../ajax/getSents.php?Doctor='+IdMed+'&DrEmail='+UserDOB+'&NReports=3&ToDoc='+DrId;
...
*/    
	...
	//click(function(event) {
		var IdMed = $('#MEDID').val();
		var url='../../../ajax/getGroupDoctors.php?Doctor='+IdMed;
    ...
    $("#BotonBusquedaPermit").click(function(event) {
        ...
        console.log('Username: ' + Username);
	     ...
	     var queUrl ='../../../ajax/getPermits.php?Doctor='+IdMed+'&DrEmail='+UserDOB+'&NReports=3&Username='+Username+'&group='+group;;
   ...
   $(".CFILASents").live('click',function() {
    ...
    function SendWelcomeMessage(){ 
             ...
             var cadena='../../../ajax/sendMessage.php?sender='+IdDocOrigin+'&receiver='+IdDoctor+'&patient='+IdPaciente+''+'&content='+content+'&subject='+subject+'&attachments='+reportids+'&connection_id='+RecTipo;
        ...
        if(destino>'' || Nondestino > '') {
           ...
           if (r==true)
            ...
            if(destino>'') {
                ...
                $.post("../../../ajax/addNotification.php", {type: "NEWREF", sender: IdDocOrigin, is_sender_doctor: true, receiver: IdDoctor, is_receiver_doctor: true, auxilary: IdPaciente}, function(data, status)
                {
                    $('#BotonBusquedaSents').trigger('click');
                    SendWelcomeMessage();
                });

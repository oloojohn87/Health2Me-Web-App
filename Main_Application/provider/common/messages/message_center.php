<div class="notifications-head">
            ...
            <div class="btn-group m_left hide-mobile">
                <a class="dropdown-toggle" data-toggle="dropdown" href="#" id="patient_messages_button">
                    ...
                    <i class="icon-user" style="-webkit-filter: hue-rotate(180deg) saturate(8.9); "></i>
                    ...
                    <div class="ichat" id="patient_messages">
                        <div class="ichat-messages">
                            ...
                            <div style="text-align: center; align: center" id="patient_messages_indicator">
                                <i class="icon-spinner icon-spin " style="margin-top: 20px; margin-bottom: 20px; margin-right: auto; margin-left: auto; color:Red;"></i>
                            </div>
                        ...
                        <a href="../../common/messages/Messages.php" class="iview" style="width: 100%" lang="en">View all</a>
            ...
            <div class="btn-group pull-left hide-mobile">
                <a class="dropdown-toggle" data-toggle="dropdown" href="#" id="doctor_messages_button">
                    ...
                    <span class="triangle-1" style="display: none;"></span>
                    <i class="icon-user-md" style="-webkit-filter: hue-rotate(140deg) saturate(8.9);" ></i>
                    <span class="caret"></span>
                </a>
                <div class="dropdown-menu" style="background-color:transparent; border:none; -webkit-box-shadow:none; box-shadow:none;">
                    ...
                    <div class="ichat" id="doctor_messages">
                        ...
                        <a href="../../common/messages/Messages.php?isDoctors=1" class="iview" style="width: 100%" lang="en">View all</a>
...
$("#doctor_mes_link_1").click(function(event)
    {
        window.open("../../common/messages/Messages.php?isDoctors=1&id=" + $("#doctor_mes_link_1").attr("name"),'_self',false);
        event.preventDefault();
    });
    $("#doctor_mes_link_2").click(function(event)
    {
        window.open("../../common/messages/Messages.php?isDoctors=1&id=" + $("#doctor_mes_link_2").attr("name"),'_self',false);
        event.preventDefault();
    });
    $("#doctor_mes_link_3").click(function(event)
    {
        window.open("../../common/messages/Messages.php?isDoctors=1&id=" + $("#doctor_mes_link_3").attr("name"),'_self',false);
        event.preventDefault();
    });
    $("#doctor_mes_link_4").click(function(event)
    {
        window.open("../../common/messages/Messages.php?isDoctors=1&id=" + $("#doctor_mes_link_4").attr("name"),'_self',false);
        event.preventDefault();
    });
    $("#doctor_mes_link_5").click(function(event)
    {
        window.open("../../common/messages/Messages.php?isDoctors=1&id=" + $("#doctor_mes_link_5").attr("name"),'_self',false);
        event.preventDefault();
    });
    $("#patient_mes_link_1").click(function(event)
    {
        window.open("../../common/messages/Messages.php?isDoctors=0&id=" + $("#patient_mes_link_1").attr("name"),'_self',false);
        event.preventDefault();
    });
    $("#patient_mes_link_2").click(function(event)
    {
        window.open("../../common/messages/Messages.php?isDoctors=0&id=" + $("#patient_mes_link_2").attr("name"),'_self',false);
        event.preventDefault();
    });
    $("#patient_mes_link_3").click(function(event)
    {
        window.open("../../common/messages/Messages.php?isDoctors=0&id=" + $("#patient_mes_link_3").attr("name"),'_self',false);
        event.preventDefault();
    });
    $("#patient_mes_link_4").click(function(event)
    {
        window.open("../../common/messages/Messages.php?isDoctors=0&id=" + $("#patient_mes_link_4").attr("name"),'_self',false);
        event.preventDefault();
    });
    $("#patient_mes_link_5").click(function(event)
    {
        window.open("../../common/messages/Messages.php?isDoctors=0&id=" + $("#patient_mes_link_5").attr("name"),'_self',false);
        event.preventDefault();
    });
function GetTimeLine(unread,scenario)
    {
        ...
        var queUrl ='../../../ajax/getInboxMessageLight.php?IdMED='+queMED+'&scenario='+scenario;
        var type = "doctor";
        if (scenario == "patient")
        {
            type = "patient";
        ...
        $.post("../../../ajax/getInboxMessageLight.php", {IdMED: queMED, scenario: scenario}, function(data, status)
        {
     ...
     function GetTimeLineBOX(unread)
    {
        $("#WaitTW").css('visibility','visible');
        var queMED = $("#MEDID").val();
        var queUrl ='../../../ajax/getInboxMessageUNREAD.php?IdMED='+queMED+'&patient=-1'+'&unread='+unread;		
                ...
                MesTimeline = MesTimeline + '<div style="float:left; width:380px; margin-left:10px; <!--border-bottom:thin dotted #cacaca;-->">'; 
                    ...
                    if (NumReports>0)
                    {
                        MesTimeline = MesTimeline + '<div style="margin:0 auto; margin-top:10px; width:95%; border:solid #cacaca; border-radius:5px; height:80px;">'; 
                            ...
                            while (rn < NumReports)
                            {
                                var cadena = '../../../ajax/DecryptFileId.php?reportid='+splitted[rn]+'&queMed='+queMED;
    ...
    $(document).on('#NewsComm','click',function(){
    ...
    $(document).on('#NewMES','click',function(){
        /*
        $("#WaitTW").css('visibility','visible');
        alert ('ok');
    ...
    $(document).on(".RightZone",'click',function() {
         ...
         var cadena='../../../ajax/setMessageStatus.php?msgid='+myClass;
         var RecTipo=LanzaAjax(cadena);
         var WLink="../../patientdetail/html/PatientDetailsCATA.php?IdUsu="+myClass2; 
         window.location.href = WLink;
    });
    
    $('.btn-group.pull-left').on("#PatientMessagesButton",'click',function(e) {
        window.open('../../common/messages/Messages.php','_self',false);
        e.preventDefault();
    });
    $('.btn-group.pull-left').on("#DoctorMessagesButton",'click',function(e) {
        window.open('../../common/messages/Messages.php?isDoctors=1','_self',false);
        e.preventDefault();
    });
</script>
     ...
     <div class="speedbar">
        <div class="speedbar-content" style="position:relative;">
            <ul class="menu-speedbar">
                <li><a href="../../maindashboard/html/MainDashboard.php">Home</a></li>
                <!--li><a href="patients.php" >Members</a></li-->
                <?php 
                    if ($privilege==1)
                    {
                        echo '<li><a href="../../medicalconnections/html/MedicalConnections.php" >Doctor Connections</a></li>';
                        echo '<li><a href="../../membernetwork/hmtl/MemberNetwork.php" >Member Network</a></li>';
                    }
                ?>
                <li><a href="../../configuration/html/Configuration.php">Configuration</a></li>

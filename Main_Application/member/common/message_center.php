            ...
            <div class="btn-group m_left hide-mobile">
                ...
                <div class="dropdown-menu" style="background-color:transparent; border:none; -webkit-box-shadow:none; box-shadow:none;">
                    ...
                    <div class="ichat" id="patient_messages">
                        ...
                        <a href="../../common/Messages.php" class="iview" style="width: 100%" lang="en">View all</a>
            ...
            <div class="btn-group pull-left hide-mobile">
                ...
                <div class="dropdown-menu" style="background-color:transparent; border:none; -webkit-box-shadow:none; box-shadow:none;">
                    ...
                    <div class="ichat" id="doctor_messages">
                        ...
                        <a href="../../common/Messages.php?isDoctors=1" class="iview" style="width: 100%" lang="en">View all</a>
...
$("#doctor_mes_link_1").click(function(event)
    {
        window.open("../../common/Messages.php?isDoctors=1&id=" + $("#doctor_mes_link_1").attr("name"),'_self',false);
        event.preventDefault();
    });
    $("#doctor_mes_link_2").click(function(event)
    {
        window.open("../../common/Messages.php?isDoctors=1&id=" + $("#doctor_mes_link_2").attr("name"),'_self',false);
        event.preventDefault();
    });
    $("#doctor_mes_link_3").click(function(event)
    {
        window.open("../../common/Messages.php?isDoctors=1&id=" + $("#doctor_mes_link_3").attr("name"),'_self',false);
        event.preventDefault();
    });
    $("#doctor_mes_link_4").click(function(event)
    {
        window.open("../../common/Messages.php?isDoctors=1&id=" + $("#doctor_mes_link_4").attr("name"),'_self',false);
        event.preventDefault();
    });
    $("#doctor_mes_link_5").click(function(event)
    {
        window.open("../../common/Messages.php?isDoctors=1&id=" + $("#doctor_mes_link_5").attr("name"),'_self',false);
        event.preventDefault();
    });
    $("#patient_mes_link_1").click(function(event)
    {
        window.open("../../common/Messages.php?isDoctors=0&id=" + $("#patient_mes_link_1").attr("name"),'_self',false);
        event.preventDefault();
    });
    $("#patient_mes_link_2").click(function(event)
    {
        window.open("../../common/Messages.php?isDoctors=0&id=" + $("#patient_mes_link_2").attr("name"),'_self',false);
        event.preventDefault();
    });
    $("#patient_mes_link_3").click(function(event)
    {
        window.open("../../common/Messages.php?isDoctors=0&id=" + $("#patient_mes_link_3").attr("name"),'_self',false);
        event.preventDefault();
    });
    $("#patient_mes_link_4").click(function(event)
    {
        window.open("../../common/Messages.php?isDoctors=0&id=" + $("#patient_mes_link_4").attr("name"),'_self',false);
        event.preventDefault();
    });
    $("#patient_mes_link_5").click(function(event)
    {
        window.open("../../common/Messages.php?isDoctors=0&id=" + $("#patient_mes_link_5").attr("name"),'_self',false);
        event.preventDefault();
    });
function GetTimeLine(unread,scenario)
    ...
    $(document).on(".RightZone",'click',function() {
         ...
         var RecTipo=LanzaAjax(cadena);
         var WLink="../../patientdetail/html/PatientDetails.php?IdUsu="+myClass2; 
         window.location.href = WLink;
    });
    
    $('.btn-group.pull-left').on("#PatientMessagesButton",'click',function(e) {
        window.open('../../common/Messages.php','_self',false);
        e.preventDefault();
    });
    $('.btn-group.pull-left').on("#DoctorMessagesButton",'click',function(e) {
        window.open('../../common/Messages.php?isDoctors=1','_self',false);
        e.preventDefault();
    });
</script>
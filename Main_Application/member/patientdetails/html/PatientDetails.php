...
session_start();
set_time_limit(180);
require("../../../ajax/environment_detail.php");
require_once("../../../modules/push/push.php");
require("../../../ajax/push_server_for_PD.php");
require('../../../ajax/getFullUsersMEDCLASS.php');
require_once("../../../ajax/displayExitClass.php");
include('../../../ajax/checkoutClass.php');
...
<html lang="en"><head>
    ...
    <?php
    if($GrantAccess != 'CATA'){
		echo '<link href="../../../master_css/style.css" rel="stylesheet">';
	}else{
		echo '<link href="../../../master_css/styleCATA.css" rel="stylesheet">';
	}
    ?>
    <link href="../../../master_css/bootstrap.css" rel="stylesheet">
    <link href="../../../master_css/bootstrap-dropdowns.css" rel="stylesheet">
    ...
    <link rel="stylesheet" type="text/css" href="../../../master_css/jquery.timepicker.css" />
    ...
    <link rel='stylesheet' href='../../../master_css/tipped.css'>
    <link rel="stylesheet" href="../../../master_css/jquery-ui-autocomplete.css" />
    ...
    <link rel="stylesheet" href="../../../master_css/jvInmers.css">

    <link rel="stylesheet" type="text/css" href="../../../master_css/tooltipster.css" />
    
    <link rel="stylesheet" type="text/css" href="../../../../h2m_css/h2m_patientdetailMED-new.css" />
    <link rel='stylesheet' type='text/css' href='../../../master_css/sweet-alert.css'>
	...
	<link rel="stylesheet" type="text/css" href="../../../master_js/uploadify/uploadify.css">
    <script type="text/javascript" src="../../../master_js/uploadify/jquery.uploadify.min.js"></script> 
    <script type="text/javascript" src="../../../master_js/jquery.fittext.js"></script> 
...
<!--  <body onload="$('.note').trigger('click'); $('.TABES').children().trigger('click');"> -->
  <body onload=" $('.TABES:eq(<?php echo $tabToOpen;?>)').click();">
	...
	<div class="header" >
      ...
      <!--  Start of comment <div style="float:left;">
           ...
           <div class="pull-right">
            <?php if ($privilege==1) include '../../../provider/common/message_center.php'; ?>
		   <!--Notifications Start-->  
		   ...
		   <div class="btn-group pull-right" >
            ...
            <ul class="clear_ul" >
              <li><a href="../../userdashboard/html/UserDashboard.php" lang="en"><i class="icon-globe"></i> Home</a></li>
    ...
    <script src="../../../master_js/SimpleWebRTC/latest.js"></script> 
    <script src="../../../master_js/SimpleWebRTC/RecordRTC.js"></script> 
    ...
    <div title="Share With Patient" id="share_modal" style="width: 900px; height: 400px; display: none;">
        ...
        <link rel="stylesheet" href="../../../master_css/toggle.css">
    ...
    <div id="probe_editor" title="Probes" style="display: none; overflow: hidden;">
        <div id="manage_user_probe" style="display: block; margin: auto; margin-top: 10px; overflow: hidden;">
            <h1 style="color: #444; font-size: 14px; text-align: center; margin-top: -10px;">Manage Probe</h1>
            <div class="probe_info_section" style="height: 200px;">
                ...
                <select id="probe_protocols" style="width: 44%; height: 30px; float: left;">
                </select>
                ...
                <input id="probe_time5" type="text"  style="width: 61%; height: 18px;"/>
                <br/>
            ...
            <div class="probe_info_section" style="height: 200px; margin-top: 30px;">
                ...
                <div style="width: 100px; height: 30px; margin: auto; margin-top: 10px;">
                    ...
                    <div id="probeToggleLabel" style="color: #54BC00; float: right; width: 30px; height: 30px; font-size: 22px; text-align: right; margin-top: 7px;">On</div>
                </div>
        ...
        <div id="add_probe" style="display: none; overflow: scroll;">
            ...
            <br/>
            <div style="width: 19%; float: left; margin-right: 2%; height: 24px; padding-top: 6px;">Title:</div>
        ...
        <div id="edit_probe_alerts" style="display: none; overflow: scroll;">
            <h1 style="color: #444; font-size: 14px; text-align: center; margin-bottom: -10px;">Probe Alerts</h1>
            
            <h1 style="color: #777; font-size: 12px; margin-bottom: -5px; margin-top: -30px;">Select Question</h1>
            ...
            <h1 style="color: #777; font-size: 12px; margin-bottom: -10px;">Tolerance:</h1>
            <div style="width: 100%;">
            ...
            <div style="width: 95px; height: 100px; margin-top: 10px; margin-top: 30px; float: right;">
                ...
                <div style="width: 66px; height: 22px; margin-left: 5px; float: left; margin-top: 10px;" >Good</div>
                ...
                <div style="width: 66px; height: 22px; margin-left: 5px; float: left; margin-top: 10px;" >Tolerated</div>
                ...
                <div style="width: 66px; height: 22px; margin-left: 5px; float: left; margin-top: 10px;" >Alert</div>
            </div>
            <div style="width: 400px; height: 150px; margin: auto; margin-top: 34px;">
                <canvas id="probe_alert_graph" style="background-color: #FFF; box-shadow: 0px 0px 0px #FFF;" width="380" height="150">
    ...
    <!-- End of MOdal for PhoneNotes -->
     ...
     <ul class="menu-speedbar">
		<?php
            if($MedID > 0)
            {
                echo '<li><a href="../../../provider/maindashboard/html/MainDashboard.php" lang="en">Home</a></li>';
                
                require("../../../ajax/checkPageAccessControl.php");
                ...
                if((count($arr_d['items'])>0)&&($arr_d['items'][0]['accessid']==1)){ 
                    ...
                    echo '<li><a lang="en" href="../../userdashboard/html/UserDashboard.php"  lang="en">Dashboard</a></li>';
                }
                ...
                if ($privilege==1)
                {
                    echo '<li><a href="../../../medicalconnections/html/MedicalConnections.php"  lang="en">Doctor Connections</a></li>';
                }
                    echo '<li><a href="../../patientdetails/html/PatientDetails.php"  lang="en">Patient Network</a></li>';
                if ($privilege==1)
                {
                
                    echo '<li><a href="../../../provider/configuration/html/Configuration.php" lang="en">Configuration</a></li>';
                }
                    echo '<li><a href="../../../ajax/logout.php" style="color:yellow;" lang="en">Sign Out</a></li>';
            }
            else
            {
                echo '<li><a href="../../userdashboard/html/UserDashboard.php" lang="en">Dashboard</a></li>';
                echo '<li><a href="#" lang="en" class="act_link">Medical Records</a></li>';
                if($GrantAccess == 'CATA')
                    echo '<li><a href="../../../ajax/logout.php" style="color:DarkRed;" lang="en">Sign Out</a></li>';
                else
                    echo '<li><a href="../../../ajax/logout.php" style="color:yellow;" lang="en">Sign Out</a></li>';
            }
        ?>
     ...
     <div class="content" >
	  ...
	  <!--- VENTANA MODAL  ---> 
		 ...
		 <div id="upload_reports_form" lang="en" title="Upload New Report" style="display: none;">
			...
			<form id="upload" action="../../../ajax/upload_file.php?queId=<?php echo $IdUsu ;?>&from=<?php echo $IdMEDEmail;?>" method="POST" enctype="multipart/form-data">
	   ...
	   <!--End Pop up for records board -->
        ...
        <div class="clearfix" style="margin-bottom:20px;"></div>
		 ...
		 <!-- image upload changes start -->
		  <?php
		  	$hash = md5( strtolower( trim( $email ) ) );
		  	$avat = '../../../ajax/identicon.php?size=50&hash='.$hash;
      ...
      <!--   <div class="label label-info" style="margin:20px;float:right;-webkit-animation: glow 2s linear infinite;"><a href="clearAllergy_emr.php?idusu=<?php echo $IdUsu ?>" class="btn"> Clear Allergy </a> </div> -->
        ...
        <input type="hidden" id="IdUsuP" value="<?php echo $IdUsu ?>" />
            ...
            <?php
                ...
                if($GrantAccess == 'CATA') {
                    echo '    <div style=" margin-left: '.$margin_sides.'; margin-right: -'.$margin_sides.'; margin-top:'.$margin_top.'; width:'.$size.'; height:'.$size.'; font-size: '.$icon_size.'; color: DarkRed;"><i class="icon-upload"></i></div>';
                ...
                echo '</a>';
                    echo '<a id="Summary_Button" value="BotonUpload_New" class="btn ButtonDrAct" href="../../../ajax/medicalPassport.php?IdUsu='.$IdUsu.'" style="margin-top: -10px; margin-left: 15px; width: '.$width.'; height: '.$height.'">';
                echo '    <div style=" margin-left: '.$margin_sides.'; margin-right: -'.$margin_sides.'; margin-top:'.$margin_top.'; width:'.$size.'; height:'.$size.'; font-size: '.$icon_size.'; color: DarkRed;"><i class="icon-book"></i></div>';
                ...
                echo '</a>';
                    echo '<a id="Print_Button" value="BotonUpload_New" class="btn ButtonDrAct" href="../../../ajax/printReports.php?IdUsu='.$IdUsu.'" style="margin-top: -10px; margin-left: 15px; width: '.$width.'; height: '.$height.'">';
                echo '    <div style=" margin-left: '.$margin_sides.'; margin-right: -'.$margin_sides.'; margin-top:'.$margin_top.'; width:'.$size.'; height:'.$size.'; font-size: '.$icon_size.'; color: DarkRed;"><i class="icon-list"></i></div>';
				...
				//E-PRESCRIBE FOR HTI & H2M
			     ...
			     if(($MedID > 0)&&($privilege != 3))
                 {
                    ...
                    //if ($privilege != 3) { 
                        ...
                        echo '<a id="Drop_Button" class="btn ButtonDrAct" href="../../../ajax/dropzone_short.php?IdUsu='.$IdUsu.'" style="margin-top: -10px; margin-left: 15px; width: '.$width.'; height: '.$height.'">';
...
if (isset($_SESSION['CustomLook']) && $_SESSION['CustomLook']!='COL') {
  ...
  <div id="tabsWithStyle" style="margin-top:20px" class="style-tabs"> 
	...
	<script type="text/javascript" src="../../../master_js/storyjs-embed.js"></script>
      
    <script src="../../../master_js/kinetic-v4.5.5.min.js"></script>
    <script src="../../../master_js/konva.min.js"></script>
    <script src="../../../master_js/moment-with-locales.js"></script>
    <script src="../../../master_js/moment-timezone.js"></script>
    <script type="text/javascript" src="../../../master_js/H2MRange.js"></script>
    
    <script src="../../../master_js/jquery.easing.1.3.js"></script>
    <script src="../../../master_js/tipped.js"></script>
    <script src="../../../master_js/imagesloaded.pkgd.min.js"></script>
    <script src="../../../master_js/H2M_Timeline.js"></script>
    <script src="../../../master_js/h2m_probegraph-newdes.js"></script>
	...
	<!--<script src="../../../master_js/bootstrap-modal.js"></script>
	<script src="../../../master_js/bootstrap-dropdown.js"></script>-->
    ...
    <script src="../../../master_js/timezones.js"></script>
	<script src="../../../master_js/detectRTC.js"></script>
  ...
  <!--  <script type="text/javascript" src="http://code.jquery.com/jquery-1.8.0.min.js"></script>--->
    <script type="text/javascript" src="../../../master_js/jquery.tooltipster.min.js"></script>
	...
	<!-- CHECKOUT MODULES -->
    <script src="../../../master_js/CHECKOUT/connect_member_button.js"></script>
    <script src="../../../master_js/CHECKOUT/probe_checkout.js"></script>
    ...
    <script type="text/javascript" src="../../../master_js/timer.js"></script>
    ...
    -->
    <script type="text/javascript" src="../js/patientdetails.js"></script>
	<!--<script src="fileupload/filedrag.js"></script>-->

...
echo $NombreEnt;
echo "----PasswordENT : ";
echo $PasswordEnt;'<?php echo $domain;?>
*/
  ...
  <body style="background: #F9F9F9;">
	...
	<div id="content" style="padding-left:0px; background: #F9F9F9;">
     ...
     <ul class="menu-speedbar">
    	 ...
    	 <li><a href="patients.php?Acceso=23432&Nombre=<?php echo $NombreEnt;?>&Password=<?php echo $PasswordEnt;?>&MEDID=<?php echo $MedID;?>">Clinical Records</a></li>
	 ...
	 <span class="label label-success" style="left:0px; margin-left:10px; margin-top:40px; font-size:30px;">Connect to Doctors</span>

     <div class="content">

	     <div class="row-fluid" style="height:500px;">	            
		 <div class="grid span6" style="width:40%;  height:400px;">
		  ...
		  $avat = 'identicon.php?size=50&hash='.$hash;
			?>	
				<img style="position:fixed; left:37%; top:210px;" src="<?php echo $avat; ?>" />
        ...
        <div class="clear"></div>
		 ...
		 <!--Tabs Start-->
        <div class="span8 grid-transparent" style="width:55%; height:400px;">
        ...
        <div id="main-container"  class="tab-content shadow" style="height:400px;">
             ...
             <div class="grid">
          <div class="grid-title">
           <div class="pull-left"><div class="fam-database-lightning" style="margin-right:10px;"></div>Registered Doctors Database</div>
           <div class="pull-right"></div>
           <div class="clear"></div>   
          </div>

...
$sql_que = $con->prepare("Insert INTO message_infrastructureuser set Subject=?,content=?,sender_id=?,receiver_id=?,patient_id=?,connection_id=?,attachments=?,fecha=now(),status='new', tofrom=?, message_type = ?");
...
$sql_que->bindValue(9, $message_type, PDO::PARAM_STR);
$res = $sql_que->execute();;

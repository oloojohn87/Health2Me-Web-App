...
<html lang="en"><head>
    <meta charset="utf-8">
    <title>Health2me Patient Detail<?php echo 'status1='.$checker->status1; echo ' status2='.$checker->status2.' status3='.$checker->status3.' status4='.$checker->status4;?></title>
...
<!--  <body onload="$('.note').trigger('click'); $('.TABES').children().trigger('click');"> -->
 ...
 $('#PrintImage').live('click',function(){
   ...
   $(".TABES").live('click',function() {
		...
		var queUrl ='CreateReportStream.php?ElementDOM=na&EntryTypegroup='+EntryTypegroup+'&Usuario='+Usuario+'&MedID='+MedID+'&num_reports='+num_reports+'&isDoctor='+isDoctor;
		//console.log(queUrl);

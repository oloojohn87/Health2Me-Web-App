...
<!--  <body onload="$('.note').trigger('click'); $('.TABES').children().trigger('click');"> -->
	...
	<div class="header" >
          ...
          <?php
		   ...
		   <div class="btn-group pull-right" >
            ...
            <ul class="clear_ul" >
              <li><a href="signin.html" lang="en"><i class="icon-globe"></i> Home</a></li>
     ...
     <div class="content" >
        ...
        <div id="encryptbox">
        	<div class="grid-content overflow">
				...
				<div id="progressbar" style="margin-top:15px; height:5px; width:100%; margin:0 auto; text-align:center;"><div style="margin-left:0px; margin-top:-5px; padding:0px; text-shadow:none; color:white; font-size:10px;" class="progress-label"></div></div> 
                <div id="progressstatus" style="width:100%; margin:0 auto; text-shadow:none; color:black; text-align:center;" lang="en">Loading and decrypting clinical content please wait...</div>
      		</div>	
        </div>
        <!--PROGRESS BAR Box Start-->
     	  <!--- VENTANA MODAL  ---> 
  ...
  <div id="tabsWithStyle" style="margin-top:20px" class="style-tabs"> 
          ...
          <ul id="myTab" class="nav nav-tabs tabs-main" style="width: 1080px;">
            <li id="0" class="TABES" style="width:<?php if($multireferral>0) {echo 97;} else {echo 108;}?>px; background: none repeat scroll 0% 0% rgb(204, 204, 204); text-align:center;"><a href="#ALL" data-toggle="tab" style="height:40px; font-size:16px;" lang="en"><i class="icon-ok-sign icon-large" style="color:black; font-size: 1.0em; width:100%;"></i><div style="width:100%"></div>ALL</a></li> 
			<?php
				if($multireferral>0){
            ...
            <li id="10" class="TABES" style="text-align: center; width:<?php if($multireferral>0) {echo 97;} else {echo 108;}?>px; background-color:black;"><a href="#ALL" lang="en" data-toggle="tab" style="height:40px; color:balck;"><i class="icon-lock icon-large" style="color:RGB(111,111,111); font-size: 1.0em; width:100%;"></i><div style="width:100%"></div>Locked</a></li>
   ...
   $('#sliderright').live('click',function(){
    ...
    /*  $(".note2").hover(
      function() {
            ...
            console.log("hovering id"+id);
            $("#"+id).css("border","2px solid #224EFF");

            ...
            <div  id="notification_window" class="dropdown-menu">
              ...
              <div class="ichat">
               <div class="ichat-messages">
                ...
                <!--<div id="notif_1" class="imessage">
                  <div class="r_icon"><a href="#"><i class="icon-camera"></i></a></div>
                  <div class="r_info">
					<button class="close" type="button" data-dismiss="modal" id="notif_btn1">×</button>
                ...
                <div id="notif_2" class="imessage">
                  <div class="r_icon"><a href="#"><i class="icon-thumbs-up"></i></a></div>
                  <div class="r_info">
				    <button class="close" type="button" data-dismiss="modal" id="notif_btn2">×</button>
                ...
                <div id="notif_3" class="imessage">
                  <div class="r_icon"><a href="#"><i class="icon-user"></i></a></div>
                  <div class="r_info">
				    <button class="close" type="button" data-dismiss="modal" id="notif_btn3">×</button>
	   ...
	   <!--End Pop up for records board -->
        ...
        <div class="clearfix" style="margin-bottom:20px;"></div>
		  ...
		  ?>	
            ...
            <?php
            if ($UConnected == 1) {
            echo '<span id="Nmp" style="float:right; font: bold 16px Arial, Helvetica, sans-serif; color: #54bc00; cursor: auto; margin-right:40px; "><span><i class="icon-refresh  icon-spin" style="color:#22aeff; margin-right:10px;"></i></span>This patient is connected to Health2Me</span>';
            };
            ?>
        ...
        <input type="hidden" id="IdUsuP" value="<?php echo $IdUsu ?>" />
        	...
        	<div class="grid-content overflow">
			  ...
			  <div id="BotonRecords" style="margin-left:20px;" data-target="#header-modal4" data-toggle="modal" class="pull-left"><a href="#" class="btn" title="New Records Board"><i class="icon-folder-open"></i> Records Board</a> </div>
  ...
  <div id="tabsWithStyle" class="style-tabs">
          ...
          <div id="myTabContent" class="tab-content tabs-main-content padding-null" >
                <div  class="tab-pane tab-overflow-main fade in active" id="ALL">
					<div class="notes" style="height: 290px; width:100%; margin-top:-10px; background-color:white;" >
        ...
        if(clicks === 1) {
               ...
               timer = setTimeout(function() {
				...
				if (extensionR=='pdf')
				{
					...
					/*var cadena = '<?php echo $domain;?>/DecryptFile.php?rawimage='+queImg+'&queMed='+<?php echo $MedID;?>;
					var RecTipo = LanzaAjax (cadena);*/
					var audiopdf = ImagenRaiz.substr(0,ImagenRaiz.length-1);
					var contenTHURL = '<?php echo $domain; ?>/Packages/'+ImagenRaiz+'.pdf';  // PONER /PinImageSetTH/ en lugar de /PinImageSet/ PARA CARGAR THUMBNAILS EN LUGAR DE IMAGENES COMPLETAS
					var contenURL =   '<?php echo $domain; ?>/Packages/'+ImagenRaiz+'.pdf';  // PONER /PinImageSetTH/ en lugar de /PinImageSet/ PARA CARGAR THUMBNAILS EN LUGAR DE IMAGENES COMPLETAS
					//var conten = '<img id="ImagenN" src="'+contenURL+'" alt="">';
					var conten =  '<iframe id="ImagenN" style="border:1px solid #666CCC; margin:0 auto; display:block;" title="PDF" src="'+contenURL+'" alt="'+queId+'" frameborder="1" scrolling="auto" height="850" width="600" ></iframe>';
					var contenTH = '<img id="ImagenTH"  src="'+contenTHURL+'" alt="">';
  ...
  $("#ConfirmaLink,#ConfirmaLinkAll").live('click',function() {
		...
		$('#Thisreport,#Allreport').hide();
			...
			/*  function doneEncoding( blob ) {
				/*Recorder.forceDownload( blob, "MedicalRecording" + ((recIndex<10)?"0":"") + recIndex + ".wav" );
				recIndex++;*/
				//alert("reached");
	/*			var url = (window.URL || window.webkitURL).createObjectURL(blob);
				...
				/*"upload_file_audio.php?queId=<?php echo $IdUsu; ?>&from=<?php echo $IdMEDEmail;?>",*/
		/*		var RecTipo="test";
				$.ajax({
					url :  "upload_file_audio.php",
					type: 'POST',
					data: audiodata,

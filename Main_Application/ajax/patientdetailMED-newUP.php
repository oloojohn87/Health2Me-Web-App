    ...
    <!--</div>-->
     ...
     <div class="content" >
	  ...
	  <!--- VENTANA MODAL  ---> 
		 ...
		 <div id="upload_reports_form" lang="en" title="Upload New Reports" style="display: none;">			
          <div id="dialogcontainer" style="width:100px; height:700px;">
            <div id="innercontainer" style="width:1800px; height:700px; overflow:auto;">
   <!--             
   <pre class="pre--demo" style="float:left;"><code data-language="javascript">// The date picker (<a href="date.htm">read the docs</a>)
$('.datepicker').pickadate()</code></pre>
    ...
    -->           
                <div id="DialogPart1" style="width:900px; height:700px; float:left;">
            <form action="upload_file.php?queId=<?php echo $IdUsu ;?>&from=<?php echo $IdMEDEmail;?>" method="POST" enctype="multipart/form-data" class="dropzone"  id="mydropzone" style="position:absolute; top:0px; width:800px; height:550px; margin:30px; border:2px dashed #cacaca; border-radius:5px; overflow:auto;">
                <div class="dropzone-previews"></div> <!-- this is were the previews should be shown. -->    
                <button id="submitUpload" type="submit" style="visibility:hidden;">Submit data and files!</button>
             </form>
			...
			<form id="upload" action="upload_file.php?queId=<?php echo $IdUsu ;?>&from=<?php echo $IdMEDEmail;?>" method="POST" enctype="multipart/form-data">
                <fieldset>
                    ...
                    <div style="width: 300px; height: 100px; margin: auto; visibility: hidden;">
            ...
            <div id="DialogPart2" style="width:870px; height:700px; float:left;">
            </div>        
        ...
        <div class="clearfix" style="margin-bottom:20px;"></div>
		 ...
		 <!-- image upload changes start -->
		  ...
		  ?>	
				...
				<center><img src="<?php echo $file;?>" style="<?php echo $style;?>"></center>
      ...
      <!--   <div class="label label-info" style="margin:20px;float:right;-webkit-animation: glow 2s linear infinite;"><a href="clearAllergy_emr.php?idusu=<?php echo $IdUsu ?>" class="btn"> Clear Allergy </a> </div> -->
        ...
        <input type="hidden" id="IdUsuP" value="<?php echo $IdUsu ?>" />
            ...
            <?php
                ...
                echo '    <div style="line-height:25px; width: '.$label_width.'; height: 25px; font-size: '.$label_font_size.'; margin-left: '.$label_margin_left.';"><span lang="en">Upload Reports</span></div>';
                echo '</a>';
      ...
      <li id="10" class="TABES" style="text-align: center; width:<?php $medid = $_SESSION['MEDID'];
         ...
         <div id="myTabContent" class="tab-content tabs-main-content padding-null" style="width: 1077px;" >
                <div  class="tab-pane tab-overflow-main fade in active" id="ALL" style="overflow: auto;overflow-y: hidden;">
					<div class="horizontal-only notes" id="hscroll" style="height: 290px; width:100%; margin-top:10px; background-color:white;" ><div id="sliderleft" class="slider-image" style="float:left;margin-top:100px"><i class="icon-chevron-sign-left icon-5x"></i></div><div id="sliderright" class="slider-image" style="margin-left: 1022px;margin-top: 100px;"><i class="icon-chevron-sign-right icon-5x"></i> </div> 
  ...
  <!--  <script type="text/javascript" src="http://code.jquery.com/jquery-1.8.0.min.js"></script>--->
    ...
    console.log("Multireferral is :"+<?php echo $multireferral; ?>)
...
Dropzone.options.mydropzone = { // The camelized version of the ID of the form element
  ...
  init: function() {
    ...
    this.on("sending", function(file, xhr, formData) {
        ...
        types = 70;
        formData.append("reportdate", rep_date);
        formData.append("reporttype",types);
    });
     ...
     this.on("uploadprogress", function(file, progress) {
      ...
      this.on("error", function(file, message) { alert('Error in Dropzone: '+message); });
    ...
    this.on("sendingmultiple", function() {
        ...
        var r = 0;
        while (r < numberfiles){
            var quefile = this.files[0].name;
            console.log (r+': '+quefile);
          */
          //UploadFile (this.files[r]);
        /*
            r++;
        };
        */
    ...
    this.on("errormultiple", function(files, response) {
      ...
      alert ('Error.- Please contact Health2Me technical support.');
      setTimeout(function(){window.location.reload()},100);
    });
  }
    ...
    $('#dialogcontainer').live('click',function(){
        //alert ('click');
        $("#dialogcontainer").animate({ scrollLeft: 400}, 800);
    });
 ...
 $('#PrintImage').live('click',function(){
...

    {
       ...
       /* $.get("medicalPassport_PDF.php?IdUsu="+userId, function(data, status)
        ...
        //ajax call for cerating PDF of summary and storing it in backend database
        // Removed from here and put into addPatientNotes.php
       // $.post("SavePatientSummaryAsPDF_table.php",{IdUsu:userId},function(data,status)
         //          {
           //           console.log(data);
             //      });
    ...
    $("#GrabaDatos").live('click',function() {
 	  ...
 	  var r=confirm('Confirm updating information for this block ?');
 	  	if (r==true)
 	  	{
	 	    ...
	 	    var idusfixed='';
            <?php if(isset($IdUsFIXED)){echo 'idusfixed="'.$IdUsFIXED.'";';} ?>;
			var idusfixedname='';
            <?php if(isset($IdUsFIXEDNAME)){echo 'idusfixedname="'.$IdUsFIXEDNAME.'";';} ?>;
			var idmed = -1;
   ...
   $(".TABES").live('click',function() {
        ...
        var queUrl1='';
        if(EntryTypegroup==10){
              queUrl1 ='createReportStreamLocked.php?ElementDOM=na&EntryTypegroup='+EntryTypegroup+'&Usuario='+Usuario+'&MedID='+MedID+'&isDoctor='+isDoctor;
        }else{
  ...
  $("#ConfirmaLink,#ConfirmaLinkAll").live('click',function() {
   ...
   //Adding datepicker for the upload report
	...
	$("#BotonUpload_New").live('click',function(){
		...
		if(language == 'th'){
		translation = 'Cargar Informes';
		var translation2 = 'Salir';
		}else if(language == 'en'){
		translation = 'Upload Reports';
		var translation2 = 'Exit';
		}

...
if( isset($_GET['IdUsu']) ) {$UserID = $_GET['IdUsu'];} 
...
console.log('en');
    ...
    <!-- Le styles -->
    <link href="../master_css/style.css" rel="stylesheet">
    <link href="../master_css/bootstrap.css" rel="stylesheet">
    <link rel="stylesheet" href="../../font-awesome/css/font-awesome.min.css">
    <link rel="stylesheet" href="../master_css/jquery-ui-1.8.16.custom.css" media="screen"  />
    <link rel="stylesheet" href="../master_css/fullcalendar.css" media="screen"  />
    <link rel="stylesheet" href="../master_css/chosen.css" media="screen"  />
    <link rel="stylesheet" href="../master_css/datepicker.css" >
    <link rel="stylesheet" href="../master_css/colorpicker.css">
    <link rel="stylesheet" href="../master_css/glisse.css?1.css">
    <link rel="stylesheet" href="../master_css/jquery.jgrowl.css">
    <link rel="stylesheet" href="../master_js/elfinder/css/elfinder.css" media="screen" />
    <link rel="stylesheet" href="../master_css/jquery.tagsinput.css" />
    <link rel="stylesheet" href="../master_css/demo_table.css" >
    <link rel="stylesheet" href="../master_css/jquery.jscrollpane.css" >
    <link rel="stylesheet" href="../master_css/validationEngine.jquery.css">
    <link rel="stylesheet" href="../master_css/jquery.stepy.css" />
    <!--<link rel="stylesheet" type="text/css" href=href="../master_css/googleAPIFamilyCabin.css">-->
      <script type="text/javascript" src="../master_js/42b6r0yr5470"></script>
	<link rel="stylesheet" href="../master_css/icon/font-awesome.css">
 <!--   <link href="//netdna.bootstrapcdn.com/font-awesome/4.0.0/../master_css/font-awesome.css" rel="stylesheet"> -->
    <link rel="stylesheet" href="../master_css/bootstrap-responsive.css">
	<link rel="stylesheet" href="../master_css/toggle-switch.css">
	<link rel="stylesheet" href="../../build/css/intlTelInput.css">
	
    <?php 
        if ($_SESSION['CustomLook']=="COL") { ?>
        <link href="../master_css/styleCol.css" rel="stylesheet">
    <?php  }  ?>
<!--    <link href="css/FamilyTree.css" rel="stylesheet">-->
	
	<script src="../master_js/jquery.min.js"></script>
    
	<script type="text/javascript" src="../master_js/jquery.easing.1.3.js"></script>	
	<script type="text/javascript" src="../master_js/modernizr.2.5.3.min.js"></script>	
...
<input type="hidden" id="UserHidden">
	...
	<!--			<tr>
				...
				<tr>
					<td style="width:20%"><span style="float: left;text-align:center;margin-top: 5px;font-size:14px;margin-left:5px" lang="en">State: </span></td>
					<td style="width:80%"><input id="State" type="text" style="margin-top: 10px;width: 95%; float:left;font-size:14px;height:17px" lang="en" placeholder="Enter State"></td>
				</tr>
				<tr>
...
-->
    ...
    <div id="modalDiagnostics" style="display:none; text-align:center; padding:20px;">
        ...
        <div style="border:solid 1px #cacaca;  margin-top:20px; padding:10px;height:240px">
			...
			<?php 
			if($isPatient != 1){
			echo '<input id="ICDBox" type="text" style="margin-left:10px;width: 60px; float:right;font-size:14px;height:17px" placeholder="ICD 10">';
			if($grant_access == 'CATA'){
			echo '<div style="float:right;margin-top:-15px;"><input onchange="changeRadio(1);" id="icd-10" style="float:right;display:block !important;margin-left:5px;" type="radio" name="select_diagnosis_type" checked="checked" />ICD-10 </div>
			<div style="float:right;margin-top:5px;margin-right:-60px"><input onchange="changeRadio(2);" id="icd-9" style="float:right;display:block !important;margin-left:5px;" type="radio" name="select_diagnosis_type" />ICD-9 </div>
			<div style="float:right;margin-top:25px;margin-right:-60px;"><input onchange="changeRadio(3);" id="icd-wellness" style="float:right;display:block !important;margin-left:5px;" type="radio" name="select_diagnosis_type" />Wellness </div>
			<div style="float:right;margin-top:45px;margin-right:-70px;"><input onchange="changeRadio(4);" id="icd-cpt" style="float:right;display:block !important;margin-left:5px;" type="radio" name="select_diagnosis_type" />CPT </div>';
			}
			}else{
			...
			?>
			<script>
				function changeRadio(switcher){
					if(switcher == 1){
						$("#ICDBox").attr('placeholder', 'ICD-10');
					}else if(switcher == 2){
						$("#ICDBox").attr('placeholder', 'ICD-9');
					}else if(switcher == 3){
						$("#ICDBox").attr('placeholder', 'Wellness');
					}else if(switcher == 4){
						$("#ICDBox").attr('placeholder', 'CPT');
					}
				}
			</script>
			<div style="width:100%;"></div>
    ...
    <div id="modalHabitsInfo" style="overflow:visible;display:none;  padding:20px;">
        <div style="border:solid 1px #cacaca; margin-top:5px; padding:10px;">
			...
			<table style="width:100%;background-color:white">
				...
				<tr>
					...
					<td style="width:35%"><input id="alcohol" type="text" style=";text-align:center;margin-left: 5px;margin-top: 10px;width: 25%; float:left;font-size:12px;height:17px"><span style="float: left;text-align:center;font-size:10px;margin-top: 10px;margin-left:5px" lang="en">Glasses/Week</span></td>
				</tr>
				<tr>
        ...
        <a id="ButtonUpdateHabitsInfo" class="btn" style="width:50px; color:#22aeff; float:right; margin-top:10px;margin-bottom:10px"><span lang="en">Update</span></a>
    ...
    ?>
			...
			<div id="BasicInfo" class="grid" class="grid span4" style="cursor:pointer;float:left;height:15%; margin-top:-2%; margin-left:1%; margin-right:1%;width:44%;display:table">
			...
			<div  id="DiagnosticHistoryInfo" class="grid" class="grid span4" style="cursor:pointer; overflow:auto;float:right; width:50%; height:44%; margin-top:-2%;  margin-right:1%; padding:.5%; display:table; position:relative;">
				<div style="display:table-cell; vertical-align:middle;">
			...
			<div id="AdditionalInfo" class="grid" class="grid span4" style="cursor:pointer;float:left;height:28.3%; margin-top:1%; margin-left:1%; margin-right:1%;width:44%;display:table">
				<div style="display:table-cell; vertical-align:middle;">
                    <p style="color:white; font-size:35px; font-weight:bold; text-align:center;  padding-top:8px;">
                        <i class="icon-spinner icon-spin" id="H2M_Spin" style="margin:0 auto; color:black;"></i>
                    </p>
			...
			<div id="MedicationInfo" class="grid" class="grid span4" style="cursor:pointer; float:left; overflow:auto;position:relative; height:24%; margin-top:1%; margin-left:1%; margin-right:.4%; padding:.5%;width:29.5%;display:table;">
				<div style="display:table-cell; vertical-align:middle;">
                    <p style="color:white; font-size:35px; font-weight:bold; text-align:center;  padding-top:8px;">
                        <i class="icon-spinner icon-spin" id="H2M_Spin" style="margin:0 auto; color:black;"></i>
                    </p>
			...
			<center><div id="FamilyHistoryInfo" class="grid" class="grid span4" style="cursor:pointer; position:relative; float:left;height:24%; margin-top:1%; margin-left:.4%;margin-right:.4%; padding:.5%;width:37.8%;display:table">
				<div style="display:table-cell; vertical-align:middle;">
                    <p style="color:white; font-size:35px; font-weight:bold; text-align:center;  padding-top:8px;">
                        <i class="icon-spinner icon-spin" id="H2M_Spin" style="margin:0 auto; color:black;"></i>
                    </p>
			...
			<div  id="HabitsInfo" class="grid" class="grid span4" style="cursor:pointer; float:right;height:48%; margin-top:1%;  margin-right:1%; margin-left:.4%; padding:.5%;width:24%;display:table">
				<div style="display:table-cell; vertical-align:middle;">
                    <p style="color:white; font-size:35px; font-weight:bold; text-align:center;  padding-top:8px;">
                        <i class="icon-spinner icon-spin" id="H2M_Spin" style="margin:0 auto; color:black;"></i>
                    </p>
			...
			<div id="ImmunizationAllergyInfo" class="grid" class="grid span4" style="cursor:pointer; float:left;height:22%; margin-top:1%; margin-left:1%; margin-right:.5%; padding:0px; width:50%; display:table">
				<div style="display:table-cell; vertical-align:middle;">
                    <p style="color:white; font-size:35px; font-weight:bold; text-align:center;  padding-top:8px;">
			...
			<div id="AllergyInfo" class="grid" class="grid span4" style="cursor:pointer; float:left;height:22%; margin-top:1%; margin-left:.5%; margin-right:.5%; padding:0px; width:19%; display:table">
				<div style="display:table-cell; vertical-align:middle;">
                    <p style="color:white; font-size:35px; font-weight:bold; text-align:center;  padding-top:8px;">
                        <i class="icon-spinner icon-spin" id="H2M_SpinA" style="margin:0 auto; color:black;"></i>
                    </p>
    ...
    <script type="text/javascript" >
		...
		//alert(<?php echo $_SESSION['BOTHID'] ?>);
    ...
    function LanzaAjax (DirURL)
	    ...
	    $.ajax(
           ...
           success: function(data) {
               ...
               console.log("From create medication data"+data);
	...
	{
		var link = 'getBasicPatientInfo.php?user=patient&IdUsu=<?php echo $_GET['IdUsu'] ?>';
	...
	{
		var link = 'getAdditionalPatientInfo.php?IdUsu=<?php echo $_GET['IdUsu'] ?>';
	...
	{
		var link = 'getMedicationInfo.php?IdUsu=<?php echo $_GET['IdUsu'] ?>';
	...
	{
        var IdUsu = <?php if(isset($_GET['IdUsu'])){ echo $_GET['IdUsu']; } else { echo 0; } ?>;
		var link = 'getFamilyHistoryInfo.php?IdUsu='+IdUsu;
	...
	{
		var link = 'getImmunoAllergyInfo.php?IdUsu=<?php echo $_GET['IdUsu'] ?>';
	...
	{
		var link = 'getImmunoAllergyInfo.php?allergy=yes&IdUsu=<?php echo $_GET['IdUsu'] ?>';
	...
	{
		var link = 'getDiagnosticInfo.php?IdUsu=<?php echo $_GET['IdUsu'] ?>';
	...
	{
		var link = 'getHabitsInfo.php?IdUsu=<?php echo $_GET['IdUsu'] ?>';
	...
	{
		var queUrl ='getDOB4VaccCalc.php?IdUsu=<?php echo $_GET['IdUsu'] ?>';
		$.ajax(
		{
			url: queUrl,
			dataType: "json",
...
//		$.post("GetConnectedLight.php", {User: queMED, NReports: 3, Group: group}, function(data, status)
	...
	*/
	...
	var trans1 = '';
		...
		if(language == 'th'){
		trans1 = 'Informacion del Miembro';
		}else if(language == 'en'){
		trans1 = 'Member Information';
		}
	...
	$('#AdditionalInfo').live('click',function()	{
		...
		$("#modalAdditionalInfo").dialog({bgiframe: true, width: 400, height: 450, modal: true,title:trans1});
	});
	...
	$("#ButtonUpdateAdditionalInfo").click(function() {
        ...
        */ //End fo comment
        ...
        if(email.length == 0)
        {
            ...
            var url = 'updateAdditionalInfo.php?insurance='+insurance+'&address='+address+'&city='+city+'&state='+state+'&zip='+zip+'&phone='+phone+'&email='+email+'&gender='+gender+'&dob='+dob+'&blood_type='+blood_type+'&weight='+weight+'&weight_type='+weight_type+'&height1='+height1+'&height2='+height2+'&height_type='+height_type+'&IdUsu=<?php echo $_GET['IdUsu'] ?>';
                console.log(phone);
                //alert(url);
        ...
        {
                var IdUsu = <?php if(isset($_GET['IdUsu'])){ echo $_GET['IdUsu']; } else { echo 0; } ?>;
                 $.post("validate_email.php", {email: email, type: '0', IdUsu: IdUsu}, function(data, status)
                  {
        ...
        //Below piece of code commented by Pallab
       ...
       /* $.post("validate_email.php", {email: email, type: '0'}, function(data, status)
        {
            ...
            if(data == 1)
            {
                var url = 'updateAdditionalInfo.php?insurance='+insurance+'&address='+address+'&city='+city+'&zip='+zip+'&phone='+phone+'&email='+email+'&gender='+gender+'&dob='+dob+'&blood_type='+blood_type+'&weight='+weight+'&weight_type='+weight_type+'&height1='+height1+'&height2='+height2+'&height_type='+height_type+'&IdUsu=<?php echo $_GET['IdUsu'] ?>';
                //console.log(hold_dob);
                //alert(url);
                var Rectipo = LanzaAjax(url);
                //alert(Rectipo);
	...
	$("#ButtonAddMedication").click(function() {
		...
		var url = 'createMedicationData.php?drugname='+drugname+'&drugcode='+drugcode+'&dossage='+dossage+'&frequency='+frequency+'&numDays='+numDays+'&IdUsu=<?php echo $_GET['IdUsu'] ?>';
		//alert(url);
		//return;
		var Rectipo = LanzaAjax(url);
		console.log(url);
...
//		alert(idrow);
		...
		var url = 'createMedicationData.php?drugname='+drugname+'&drugcode='+drugcode+'&dossage='+dossage+'&frequency='+frequency+'&numDays='+numDays+'&rowediter='+idrow+'&IdUsu=<?php echo $_GET['IdUsu'] ?>';
		//alert(url);
		//return;
		var Rectipo = LanzaAjax(url);
		//console.log(url);
	...
	{   
        var MedicationData;
		var queUrl ='getMedications.php?IdUsu=<?php echo $_GET['IdUsu'] ?>';
		$.ajax(
		{
			url: queUrl,
			dataType: "json",
  ...
  var translation3 = '';
	...
	$("#ButtonAddRelative").click(function() {
		...
		var url = 'createFamilyData.php?relativename='+relativename+'&relativecode='+relativecodeI+'&diseasename='+disease+'&diseasegroup='+diseasegroup+'&ICD10='+ICD10+'&ICD9='+ICD9+'&ageevent='+ageevent+'&isdeadcheck='+isdeadcheck+'&IdUsu=<?php echo $_GET['IdUsu'] ?>';
		//alert(url);
		//return;
		console.log(url);
		var Rectipo = LanzaAjax(url);
...
//		alert(idrow);
		...
		var url = 'createFamilyData.php?relativename='+relativename+'&relativecode='+relativecodeI+'&diseasename='+disease+'&diseasegroup='+diseasegroup+'&ICD10='+ICD10+'&ICD9='+ICD9+'&ageevent='+ageevent+'&isdeadcheck='+isdeadcheck+'&rowediter='+idrow+'&IdUsu=<?php echo $_GET['IdUsu'] ?>';
		//alert(url);
		//return;
		console.log(url);
		var Rectipo = LanzaAjax(url);
	...
	{
		var queUrl ='getRelatives.php?IdUsu=<?php echo $_GET['IdUsu'] ?>';
		$.ajax(
		{
			url: queUrl,
			dataType: "json",
...
//		alert(VaccName);
		...
		var url = 'createImmunoData.php?VaccCode='+VaccCode+'&VaccName='+VaccName+'&AllerCode='+AllerCode+'&AllerName='+AllerName+'&intensity='+intensity+'&dateEvent='+dateEvent+'&ageEvent='+ageevent+'&dob='+dob+'&IdUsu=<?php echo $_GET['IdUsu'] ?>';
		var Rectipo = LanzaAjax(url);
		getVaccines();		
...
//		alert(idrow);
		...
		var url = 'createImmunoData.php?VaccCode='+VaccCode+'&VaccName='+VaccName+'&AllerCode='+AllerCode+'&AllerName='+AllerName+'&intensity='+intensity+'&dateEvent='+dateEvent+'&ageEvent='+ageevent+'&dob='+dob+'&rowediter='+idrow+'&IdUsu=<?php echo $_GET['IdUsu'] ?>';
		var Rectipo = LanzaAjax(url);
		getVaccines();		
	...
	$("#ButtonAddVaccineCalendar").click(function() {
		...
		dob = getDOB4VaccCalc();
//		alert(dob);
		var url = 'createImmunoDataCalendar.php?country='+value+'&dob='+dob+'&IdUsu=<?php echo $_GET['IdUsu'] ?>';
		var Rectipo = LanzaAjax(url);
		getVaccines();	
...
//		alert(idrow);
	...
	var r=confirm('This action will delete all previous allergies and will prevent future allergies from being displayed.  Is this really what you would like to do?');
	 	 if (r==true)
	 	 {
		var url = 'createImmunoData.php?noallergies=yes&IdUsu=<?php echo $_GET['IdUsu'] ?>';
		var Rectipo = LanzaAjax(url);
		getAllergy(0);	
	...
	var r=confirm('This action will delete all previous medications and will prevent future medications from being displayed.  Is this really what you would like to do?');
	 	 if (r==true)
	 	 {
		var url = 'createMedicationData.php?nomeds=yes&IdUsu=<?php echo $_GET['IdUsu'] ?>';
		var Rectipo = LanzaAjax(url);
		getMedications();	
	...
	var r=confirm('This action will delete all previous diagnostics and will prevent future diagnostics from being displayed.  Is this really what you would like to do?');
	 	 if (r==true)
	 	 {
		var url = 'createDiagnosticData.php?nodiag=yes&IdUsu=<?php echo $_GET['IdUsu'] ?>';
		var Rectipo = LanzaAjax(url);
		getDiagnostics(0);	
 	...
 	function getDOB()
	{
		var queUrl ='getDOB.php?IdUsu=<?php echo $_GET['IdUsu'] ?>';
		$.ajax(
		{
			url: queUrl,
			dataType: "json",
	...
	{
		var queUrl ='getVaccines.php?IdUsu=<?php echo $_GET['IdUsu'] ?>';
		$.ajax(
		{
			url: queUrl,
			dataType: "json",
		...
		while (n<numVaccines){
            ...
            translation32 = 'desde';
            translation33 = 'años';
            translation35 = 'mes(es) atrás';
            }else if(language == 'en'){
            translation32 = 'since';
            translation33 = 'years old';
            translation35 = 'month(s) ago';
            }
			...
			if (VaccName != '')
			{
				...
				var middlecolumn = translation32+' ';
                if(ageEvent.slice(-1) == 'y') middlecolumn += ageEvent.slice(0, ageEvent.length - 1)+' '+translation33;
                else middlecolumn += ageEvent.slice(0, ageEvent.length - 1)+' '+translation35;
...
$('#ButtonSearchICD').live('click',function(){
  ...
  $('#DiagnosticEditBox').live('click',function()	{
    ...
    function LoadDonuts(){
        console.log("In Loaddonuts");
        var UserID = <?php echo $_GET['IdUsu']; ?> ;
        ...
        while (k < 7)
		{
            ...
            console.log(ConnData[k]);
            thisVerified = ConnData[k].doctor_signed;
            
            
            //Start of new code added by Pallab for fixing blank doctor verified ribbon issue
            //IF A PATIENT EDITED FOR THE LAST TIME
            if (thisVerified < 0)
            { 
                if(Date.parse(ConnData[k].latest_update) > bestDate)
                {
                    formattedMemberDate = Date.parse(ConnData[k].latest_update); 
                    date_holder = ConnData[k].latest_update;
            ...
            //IF A DOCTOR EDITED FOR THE LAST TIME
            else
            {          
                
                if(Date.parse(ConnData[k].latest_update) > bestDate)
                {
                    doctorId = ConnData[k].doctor_signed;
                    formattedDoctorDate = Date.parse(ConnData[k].latest_update); 
                    date_holder = ConnData[k].latest_update;
       ...
       console.log('parsedate:'+formattedMemberDate+'bestdate:'+formattedDoctorDate);
        if(formattedMemberDate > formattedDoctorDate)
        {
			
            var offset = new Date().getTimezoneOffset();
            var formattedDate = moment(formattedMemberDate).add('minutes',(offset*-1)).fromNow();

            subTitle = '<span class ="ribbon-lgtext">Edited</span><span class ="ribbon-smtext"> by User<br>Last Entry: '+date_holder+'</span>';  
            
            //title =  '<span class ="ribbon-lgtext">Verified</span><br> <span class ="ribbon-smtext">by '+namedoctor+' '+formattedDate+'<span class ="ribbon-lgtext"><br><span class ="ribbon-smtext">'+subTitle; //Added the extra line edited by Pallab
            ...
            document.getElementById("ribbon-verified").innerHTML=subTitle;
            document.getElementById("ribbon-verified").style.display = 'block';
        }
        //End of new code added by Pallab
        
        else if (formattedDoctorDate > Date.parse('1975-01-01 00:00:00'))
		{
			namedoctor = LanzaAjax ('getDoctorName.php?IdDoctor='+doctorId);
			console.log('name:'+namedoctor);
			contentVerif = 'Verified';// by '+namedoctor;
            var offset = new Date().getTimezoneOffset();
            var formattedDate = moment(bestDate).add('minutes',(offset*-1)).fromNow();
            
            title =  '<span class ="ribbon-lgtext">Verified</span><br><span class ="ribbon-smtext">by '+namedoctor+' '+formattedDate+'</span>'; //Added the extra line edited by Pallab
            //title =  '<span class ="ribbon-lgtext">Verified</span><br> <span class ="ribbon-smtext">by '+namedoctor+' on '+ VerifiedDate.substr(0, 10)+'<span class ="ribbon-lgtext">';
            console.log(title);
	...
	{
		//alert(toShow);
		var queUrl ='getDiagnostics.php?IdUsu=<?php echo $_GET['IdUsu'] ?>';
		$.ajax(
		{
			url: queUrl,
			dataType: "json",
...
if(del==0)
			...
			if(rowid==toShow)
			{
				DiagnosticBox += '<div style="width:10px; float:left; text-align:left;"><i class="icon-chevron-down"></i></div>';
					...
					DiagnosticBox += '<div style="width:190px; float:left; text-align:center; color:#22aeff;"><span class="DrName" style="font-size: 13px;">'+middleColumn +' </span></div>';
...
if(rowid==toShow)
		...
		translatione1 = 'Editing';
					...
					DiagnosticBox += '<div style="width:140px; float:left; text-align:left;cursor:pointer"><span class="PatName" style="white-space:nowrap">'+dxname.substr(0, 15)+'...</span></div>';
					DiagnosticBox += '<div style="width:210px; float:left; text-align:center; color:#22aeff;"><span class="DrName" style="font-size: 13px;">'+middleColumn +' </span></div>';
...
//		var dxcode = $('#field_id1').val();
		...
		var url = 'createDiagnosticData.php?dxname='+dxname+'&dxcode='+dxcode+'&sdate='+sdate+'&edate='+edate+'&notes='+notes+'&IdUsu=<?php echo $_GET['IdUsu'] ?>';
		console.log(url);
		var Rectipo = LanzaAjax(url);
		//alert(Rectipo);
...
//		alert(idrow);
		...
		var url = 'createDiagnosticData.php?dxname='+dxname+'&dxcode='+dxcode+'&sdate='+sdate+'&edate='+edate+'&notes='+notes+'&rowediter='+idrow+'&IdUsu=<?php echo $_GET['IdUsu'] ?>';
		console.log(url);
		var Rectipo = LanzaAjax(url);
		//alert(Rectipo);
	...
	function showElement(element)
	{
	   ...
	   if(welcome != null) welcome.style.display = 'block';
...
//		var coffee = $('#coffee').val();
		...
		var url = 'saveHabitInfo.php?cigarette='+cigarettes+'&alcohol='+alcohol+'&exercise='+exercise+'&sleep='+sleep+'&IdUsu=<?php echo $_GET['IdUsu'] ?>';
		console.log(url);
		var RecTipo = LanzaAjax(url);
		//alert(RecTipo);
		getHabitsInfo();
    ...
    <script src="../master_js/google-code-prettify/prettify.js"></script>

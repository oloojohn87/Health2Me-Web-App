	 ...
	 <div class="content">
			...
			<button id="probeRequest" data-target="#header-modal333" data-toggle="modal" class="btn btn-warning" style="display: none;">Modal with Header</button> 
				...
				<div class="modal-body">
					...
					<div>	<input type="radio" name="feedbackValue" value="Email"/> Email</div>
...
var timeoutTime = 18000000;
	...
	$('#createProbe').live('click',function(){	 
		...
		var url='createProbe.php?idusu='+<?php echo $idusu?>+'&timezone='+timezone+'&time='+time+'&interval='+interval+'&email=1&phone=1';
		//alert(url);

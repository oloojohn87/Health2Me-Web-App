...
<!--    <link href="css/FamilyTree.css" rel="stylesheet">-->
  ...
  <body id = "body" <?php if($is_modal){echo 'style="background: #FFF; width: 1000px; height: 660px;"';}else{echo 'style="background: #F9F9F9;"';} ?>>
...
<input type="hidden" id="UserHidden">
    ...
    ?>
    <div class="ribbon-banner" id="ribbon-verified" href = test.html></div>
    <!--<div class=ribbon-banner id="ribbon-verified"><span class ='ribbon-lgtext'>VERIFIED</span><span class='ribbon-smtext'><br>by Dr. <?php echo $doctor_surname ?> on <?php echo $latest_update ?></$latest_update></style></div>
    ...
    <div id="modalMedication" style="display:none; text-align:center; padding:20px;">
        <div style="color:#22aeff; font-size:14px; text-align: right; width: 70%; height: 10px; float: left; padding-bottom: 10px;"> Medications for <?php echo $UserName.' '.$UserSurname; ?> </div>
        ...
        <div style="border:solid 1px #cacaca; height:140px; margin-top:20px; padding:10px;">
            ...
            <a id="buttonNoDrugs" style="float:left; text-align:center; margin-left: 3px; margin-top: -5px; width: 150px; font-size:12px; height:17px;" class="btn">Not Taking Any Drugs</a>

            <a id="ButtonAddMedication" class="btn" style="height: 80px; width:50px; color:#22aeff; float:right; margin-top:-130px;"><span>Add</span></a>
        </div>
    </div>
	...
	<div id="modalDeletedMedications" style="display:none; text-align:center; padding:20px;">
        ...
        <div style="color:#22aeff; font-size:14px; text-align: right; width: 80%; height: 10px; float: left; padding-bottom: 10px;"> Deleted medications for <?php echo $UserName.' '.$UserSurname; ?> </div>
    ...
    <div id="modalFamilyHistory" style="display:none; text-align:center; padding:20px;">
        ...
        <div style="color:#22aeff; font-size:14px; text-align: right; width: 70%; height: 10px; float: left; padding-bottom: 10px;"> Family History for <?php echo $UserName.' '.$UserSurname; ?> </div>
        ...
        <div style="border:solid 1px #cacaca; height:100px; margin-top:20px; padding:10px;">
				...
				<span style="float: left;text-align:center;margin-top: 5px;font-size:14px;margin-left: 5px">Type of Relative</span>
...
-->
	...
	<div id="modalDeletedFamilyHistory" style="display:none; text-align:center; padding:20px;">
        ...
        <div style="color:#22aeff; font-size:14px; text-align: right; width: 80%; height: 10px; float: left; padding-bottom: 10px;"> Deleted family history for <?php echo $UserName.' '.$UserSurname; ?> </div>
    ...
    <div id="modalImmunizationAllergy" style="display:none; text-align:center; padding:20px;">
        ...
        <div style="color:#22aeff; font-size:14px; text-align: right; width: 70%; height: 10px; float: left; padding-bottom: 10px;"> Immunization for <?php echo $UserName.' '.$UserSurname; ?> </div>
        ...
        <div style="border:solid 1px #cacaca; height:120px; margin-top:20px; padding:10px;">
				...
				<input id="VaccineName" type="text" style="margin-left:10px;width: 150px; float:left;font-size:14px;height:17px" placeholder="Vaccine Code">
				...
				<input id="ageEventVac" type="text" style="margin-left:10px;width: 150px; float:left;font-size:14px;height:17px" placeholder="Vaccination Age">
            ...
            <a id="ButtonAddVaccine" class="btn" style="height: 80px; width:50px; color:#22aeff; float:right; margin-top:-130px; margin-right:19px;"><span>Add</span></a>
			...
			<option value="">Import Vacc. Calendar</option>
			<option value="USA">United States</option>
			<option value="COL">Colombia</option>
			<option value="SPA">Spain</option>
			</select>
			<a id="ButtonAddVaccineCalendar" class="btn" style="height: 17px; width:135px; color:#22aeff; float:right; margin-top:-45px; margin-right:118px;"><span>Import Calendar</span></a>
	...
	<div id="modalDeletedImmunizations" style="display:none; text-align:center; padding:20px;">
        ...
        <div style="color:#22aeff; font-size:14px; text-align: right; width: 80%; height: 10px; float: left; padding-bottom: 10px;"> Deleted immunizations for <?php echo $UserName.' '.$UserSurname; ?> </div>
    ...
    <div id="modalAllergy" style="display:none; text-align:center; padding:20px;">
        ...
        <div style="color:#22aeff; font-size:14px; text-align: right; width: 70%; height: 10px; float: left; padding-bottom: 10px;"> Known allergies for <?php echo $UserName.' '.$UserSurname; ?> </div>
        ...
        <div style="border:solid 1px #cacaca; height:140px; margin-top:20px; padding:10px;">
				...
				<input id="ageEventAll" type="text" style="margin-left:10px;width: 140px; float:left;font-size:14px;height:17px" placeholder="Age of Outbreak">
				...
				<span  id="intensitylabel" style="float:left; text-align:center; font-size:12px; margin-top:0px; margin-left:10px"><font style="color:hsl(0, 100%, 20%);">Very Low</font></span>
				...
				<a id="buttonNoAllergies" style="float:left; text-align:center; margin-left: 5px; margin-top: -5px; width: 150px; font-size:12px; height:17px;" class="btn">No Known Allergies</a>


            </div>            
            <a id="ButtonAddAllergy" class="btn" style="height: 80px; width:50px; color:#22aeff; float:right; margin-top:-140px; margin-right:19px;"><span>Add</span></a>
	...
	<div id="modalDeletedAllergy" style="display:none; text-align:center; padding:20px;">
        ...
        <div style="color:#22aeff; font-size:14px; text-align: right; width: 80%; height: 10px; float: left; padding-bottom: 10px;"> Deleted allergies for <?php echo $UserName.' '.$UserSurname; ?> </div>
    ...
    <div id="modalDiagnostics" style="display:none; text-align:center; padding:20px;">
        <div style="color:#22aeff; font-size:14px; text-align: right; width: 70%; height: 10px; float: left; padding-bottom: 10px;"> Diagnostics for <?php echo $UserName.' '.$UserSurname; ?> </div>
        ...
        <div style="border:solid 1px #cacaca;  margin-top:20px; padding:10px;height:240px">
			...
			<a id="buttonNoDiagnostics" style="float:left; text-align:center; margin-left: 5px; width: 150px; font-size:12px; height:17px;" class="btn">No Incidents to Report</a>
        </div>
    </div>
	<!-- Model view for deleted diagnostics -->
	<div id="modalDeletedDiagnostics" style="display:none; text-align:center; padding:20px;">

        <div style="color:#22aeff; font-size:14px; text-align: right; width: 80%; height: 10px; float: left; padding-bottom: 10px;"> Deleted diagnostics for <?php echo $UserName.' '.$UserSurname; ?> </div>
        ...
        <div style="border:solid 1px #cacaca; margin-top:5px; padding:10px;">
			...
			<table style="width:100%;background-color:white">
				<tr>
					...
					<td style="width:30%"><input id="cigarettes" type="text" style=";text-align:center;margin-left: 5px;margin-top: 10px;width: 25%; float:left;font-size:12px;height:17px"><span style="float: left;text-align:center;font-size:10px;margin-top: 10px;margin-left:5px">Per Day</span></td>
				</tr>
				<tr>
					...
					<td style="width:30%"><input id="alcohol" type="text" style=";text-align:center;margin-left: 5px;margin-top: 10px;width: 25%; float:left;font-size:12px;height:17px"><span style="float: left;text-align:center;font-size:10px;margin-top: 10px;margin-left:5px">Glass/Week</span></td>
				</tr>
				<tr>
					...
					<td style="width:30%"><input id="exercise" type="text" style=";text-align:center;margin-left: 5px;margin-top: 10px;width: 25%; float:left;font-size:12px;height:17px"><span style="float: left;text-align:center;font-size:10px;margin-top: 10px;margin-left:5px">Hours/Week</span></td>
				</tr>
				<tr>
					<td style="width:20%"><span style="float: left;text-align:center;font-size:12px;margin-left:5px">Sleep: </span></td>
					<td style="width:50%"><div id="sleep-slider" style="margin-left:10px;"></div></td>
					<td style="width:30%"><input id="sleep" type="text" style=";text-align:center;margin-left: 5px;margin-top: 10px;width: 25%; float:left;font-size:12px;height:17px"><span style="float: left;text-align:center;font-size:10px;margin-top: 10px;margin-left:5px">Hours/Day</span></td>
				</tr>
				<!--<tr>
    ...
    <!-- END MODAL VIEW FOR HABITS INFO -->
     ...
     <?php
        ...
        else
        {
            ...
            echo '<div id="dataGrid" class="grid" class="grid span4" style="width:1000px; height:2000px;margin: 0 auto; margin-top:30px; padding-top:30px;">';
        }
    ?>
<!-- Commented out by Pallab -->     
<!--
			...
			<div id="AllergyInfo" class="grid" class="grid span4" style="cursor:pointer; float:left;height:140px; margin:0px auto; margin-top:10px; margin-left:5px; margin-right:5px; padding:0px; width:195px; display:table">
 		     ...
 		     --> <!-- Commented out by Pallab -->
 <p><div id="BasicInfo" class="grid" class="grid span4" style="float:left;height:55px; margin:0px auto; margin-top:-20px; margin-left:10px; margin-right:10px; padding:20px;width:700px;display:table">
				<div style="display:table-cell; vertical-align:middle;">
                    <p id="Connect2" style="color:white; font-size:35px; font-weight:bold; text-align:center;  padding-top:8px;">
                        <i class="icon-spinner icon-spin" id="H2M_Spin" style="margin:0 auto; color:black;"></i>
                    </p>
...
<p><div id="AdditionalInfo" class="grid" class="grid span4" style="cursor:pointer;float:left;height:140px; margin:0px auto; margin-top:10px; margin-left:10px; margin-right:10px; padding:20px;width:700px;display:table">
				<div style="display:table-cell; vertical-align:middle;">
                    <p style="color:white; font-size:35px; font-weight:bold; text-align:center;  padding-top:8px;">
                        <i class="icon-spinner icon-spin" id="H2M_Spin" style="margin:0 auto; color:black;"></i>
                    </p>
...
<p><div  id="DiagnosticHistoryInfo" class="grid" class="grid span4" style="cursor:pointer; float:left;width:700px;margin:0px auto; margin-top:10px;  margin-left:10px;margin-right:10px; padding:5px; display:table; position:relative;">
				<div style="display:table-cell; vertical-align:middle;">
                    <p style="color:white; font-size:35px; font-weight:bold; text-align:center;  padding-top:8px;">
                        <i class="icon-spinner icon-spin" id="H2M_Spin" style="margin:0 auto; color:black;"></i>
                    </p>
		...
		<p><div id="MedicationInfo" class="grid" class="grid span4" style="cursor:pointer; float:left; margin:0px auto; margin-top:10px; margin-left:10px; margin-right:10px; padding:5px;width:700px;display:table;">
				<div style="display:table-cell; vertical-align:middle;">
                    <p style="color:white; font-size:35px; font-weight:bold; text-align:center;  padding-top:8px;">
                        <i class="icon-spinner icon-spin" id="H2M_Spin" style="margin:0 auto; color:black;"></i>
                    </p>
		...
		<p><div id="FamilyHistoryInfo" class="grid" class="grid span4" style="cursor:pointer; position:relative; float:left;height:150px; margin:0px auto; margin-top:10px; margin-left:10px;margin-right:10px; padding:5px;width:700px;display:table">
				<div style="display:table-cell; vertical-align:middle;">
                    <p style="color:white; font-size:35px; font-weight:bold; text-align:center;  padding-top:8px;">
                        <i class="icon-spinner icon-spin" id="H2M_Spin" style="margin:0 auto; color:black;"></i>
                    </p>
		...
		<p>	<div  id="HabitsInfo" class="grid" class="grid span4" style="cursor:pointer; float:left;height:300px; margin:0px auto; margin-top:10px;  margin-left:10px;margin-right:10px; padding:5px;width:700px;display:table">
				<div style="display:table-cell; vertical-align:middle;">
                    <p style="color:white; font-size:35px; font-weight:bold; text-align:center;  padding-top:8px;">
                        <i class="icon-spinner icon-spin" id="H2M_Spin" style="margin:0 auto; color:black;"></i>
                    </p>
			...
			<p><div id="ImmunizationAllergyInfo" class="grid" class="grid span4" style="cursor:pointer; float:left;height:140px; margin:0px auto; margin-top:10px; margin-left:10px;margin-left:10px; margin-right:5px; padding:0px; width:700px; display:table">
				<div style="display:table-cell; vertical-align:middle;">
                    <p style="color:white; font-size:35px; font-weight:bold; text-align:center;  padding-top:8px;">
                        <i class="icon-spinner icon-spin" id="H2M_SpinA" style="margin:0 auto; color:black;"></i>
                    </p>
		...
		<p><div id="AllergyInfo" class="grid" class="grid span4" style="cursor:pointer; float:left;height:140px; margin:0px auto; margin-top:10px; margin-left:10px; margin-right:5px; padding:0px; width:700px; display:table">
				<div style="display:table-cell; vertical-align:middle;">
                    <p style="color:white; font-size:35px; font-weight:bold; text-align:center;  padding-top:8px;">
                        <i class="icon-spinner icon-spin" id="H2M_SpinA" style="margin:0 auto; color:black;"></i>
                    </p>
     ...
     <p><button id ="Finish" class="bottom_buttons" style="width:150px;height:40px;background-color: #22aeff;margin-left:427px;margin-top:70px">Finish</button></p>
  ...
  //-------------------------------------- CODE FOR IMMUNIZATION AND ALLERGY -------------------------------------------------------------
	...
	$( "#intensity-slider" ).slider({
	      ...
	      slide: function( event, ui ) {
	        ...
	        switch (ui.value)
	        {
		        case 0:	$("#intensitylabel" ).html('<font style="color:hsl(0, 100%, 20%);">Very Low</font>');
						break;
		        case 1:	$("#intensitylabel" ).html('<font style="color:hsl(0, 100%, 26%);">Low</font>');
						break;
		        case 2:	$("#intensitylabel" ).html('<font style="color:hsl(0, 100%, 32%);">Medium</font>');
						break;
		        case 3:	$("#intensitylabel" ).html('<font style="color:hsl(0, 100%, 38%);">High</font>');
						break;
		        case 4:	$("#intensitylabel" ).html('<font style="color:hsl(0, 100%, 44%);">Very High</font>');
						break;
		        case 5:	$("#intensitylabel" ).html('<font style="color:hsl(0, 100%, 50%);">Extreme</font>');
						break;
	        }
	        $( "#intensity" ).val( ui.value );
	...
	$('#ImmunizationAllergyInfo').live('click',function()	{
		...
		$("#modalImmunizationAllergy").dialog({bgiframe: true, width: 550, height: 500, modal: true,title:"Immunization History"});
	});
	...
	$('#AllergyInfo').live('click',function()	{
		...
		$("#modalAllergy").dialog({bgiframe: true, width: 550, height: 500, modal: true,title:"Allergy History"});
	});
...
if(del==1)
  ...
  getAllergyDeleted();
		$("#modalDeletedAllergy").dialog({bgiframe: true, width: 400, height: 400, modal: true,title:"Deleted Allergies"});
  });
  
   $('#deletedDiagnostics').live('click',function()	{
   getDiagnosticsDeleted();
		$("#modalDeletedDiagnostics").dialog({bgiframe: true, width: 400, height: 400, modal: true,title:"Deleted Diagnostics"});
  });
  
  $('#deletedImmunizations').live('click',function()	{
  getVaccinesDeleted();
		$("#modalDeletedImmunizations").dialog({bgiframe: true, width: 400, height: 400, modal: true,title:"Deleted Immunization"});
  });
  
  $('#deletedFamilyHistory').live('click',function()	{
  getRelativesDeleted();
		$("#modalDeletedFamilyHistory").dialog({bgiframe: true, width: 400, height: 400, modal: true,title:"Deleted Family History"});
  });
  
  $('#deletedMedications').live('click',function()	{
  getMedicationsDeleted();
		$("#modalDeletedMedications").dialog({bgiframe: true, width: 400, height: 400, modal: true,title:"Deleted Medications"});
  });
...
//		var coffee = $('#coffee').val();
        ...
        $("#Finish").on('click',function(data,success)
                    ...
                    $.post("save.php",{data: data},function(data,success)
                           {
                            console.log(data);
                           });
                });

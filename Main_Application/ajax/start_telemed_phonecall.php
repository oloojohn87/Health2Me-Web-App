...
Kyle Austin (patient): {ID=2056, Num=12147349964}</br>
Bruno Lima (doctor): {ID=2543, Num=19723756339}";

echo "<form method='post' action='start_telemed_phonecall.php?stage=init-call' >
...
if(isset($_POST['pat_phone'])  && isset($_GET['stage']) && $_GET['stage'] == 'init-call'){
	...
	if(isset($_POST['message_text'])){
		$description = $_POST['message_text'];
	}
	...
	//Initiate call...
	$phone_prompt->initiate_call($_POST["pat_phone"],$doc_phone, $pat_id, $doc_id, $pat_name, $doc_name, $description, $override, $override_doc_validation, $grant_access, $language_var);
}
//REQ-DOC////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
if(isset($_GET['conference_id']) && isset($_GET['pat_name']) && isset($_GET['stage']) && $_GET['stage'] == 'req-doc'){
	//Request appointment prompt to doctor...
	$phone_prompt->request_appointment_from_doc($_GET['conference_id'], $_GET['pat_name'], $_GET['grant_access'], $_GET['language']);
}
//REQ-PAT////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
if(isset($_GET['grant_access']) && isset($_GET['info']) && isset($_GET['stage']) && $_GET['stage'] == 'req-pat'){
	...
	$phone_prompt->request_appointment_from_pat($doctor_id, $patient_id, $recent_id, $grant_access, $_GET['info'], $_GET['language']);
}
//REQ-PAT-STAGE2////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

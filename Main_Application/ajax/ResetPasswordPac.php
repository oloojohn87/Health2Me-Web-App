	...
	<div id="container_demo" >
		 <div id="wrapper" style="top:50px;">
         	...
         	<div class="animate form position">
                ...
                <form  id="resetpwdForm" method="post"  action="ResetPac.php" class="form-login"> 
                    <div class="content-login" style="text-align: center;">
                    <a href="#" class="logo"></a>
                    <span id="estaLabel" class="label label-success" style="font-size:18px; margin:0 auto;">MEMBER ACCOUNT</span>
                    ...
                    <div class="inputs">
                       ...
                       <!-- <div class="MsgAlarma2" style="height:0px; -webkit-border-radius: 3px; border-radius: 3px; margin-bottom:20px; background-color: #F77E45">
                     	...
                     	<!--</div>-->
                        <span class="label label-success" style="font-size:14px; margin-bottom:20px;">Password Reset</span>
                     	<!--<img src="images/load/4.gif" alt="" style="margin-left:50px; visibility" id="Wait1">-->
                        <div class="clear"></div>
                     	</br>
                     ...
                     <div style="margin: auto;margin-top:10px;cursor: pointer" class="submit_button_patient">
                            <div id="BotonEnviaF" style="padding-top:7px;">Reset Password</div>
...
<!--    <script type="text/javascript" src="http://code.jquery.com/jquery-1.8.0.min.js"></script>-->
    ...
    <script>
        ...
        var email=getEmailID($('#tokenID').val());
        $('#Nombre').val(email);
        ...
        $('#BotonEnviaF').bind("click", function(){
         ...
         /*case 12: if ((function(token){
                       ...
                       // alert('validating email entered');
                         ...
                         var url='validateResetEmailID.php?token='+token+'&ID='+userid+'&whichone=0';
                        //alert(url);
    ...
    function getEmailID (token){
         ...
         var url='validateResetEmailID.php?token='+token+'&whichone=0';
         //alert(url);
         var check=LanzaAjax(url);
         //alert('emailvalidationreturn'+check);
         if(check=='0'){$("#close_error_bar").hide();alarma('Request invalid or expired! <a href="SignInUSER.html#" style="color:white">click here to make a new request for password reset</a>','');}else{return check;}
     
     }
    /* function validateID(token){

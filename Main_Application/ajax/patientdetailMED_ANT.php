  ...
  <body onload="$('.note').trigger('click');">
	...
	<div id="content" style="padding-left:0px; background: #F9F9F9; height:1600px;">
     ...
     <ul class="menu-speedbar">
    	 ...
    	 <li><a href="patients.php?Acceso=23432&Nombre=<?php echo $NombreEnt;?>&Password=<?php echo $PasswordEnt;?>&MEDID=<?php echo $MedID;?>" class="act_link">Patients</a></li>
     ...
     <div class="content" >
         ...
         <div style="width:100%; border: 1px solid #cccccc;" id="ParseWindow">
         </div>
	  ...
	  <!--- VENTANA MODAL NUMERO 2  ---> 
        ...
        <input type="hidden" id="IdMed" value="<?php echo $IdMed ?>" />
        	...
        	<div class="grid-content overflow">
        	  <!--<button id="BotonMod" data-target="#header-modal2" data-toggle="modal" class="btn" style="float:right; margin-right:10px;"><i class="icon-indent-left"></i>Classification</button>-->
        ...
        <span class="label label-success" style="left:0px; margin-left:0px; margin-top:20px; margin-bottom:5px; font-size:14px;">Health History Timeline</span>
        <div class="scroll-pane horizontal-only notes" style="height: 290px; width:680px; border:1px solid #cacaca; margin-top:10px; background-color:white;" >
...
{
	$subtipo = substr($row['RawImage'], 3 , 2);  // Para los casos en que eMapLife+ (PROF) ya sube las imagenes a AMAZON y no a GODADDY
...
?>
  ...
  <!--  <script type="text/javascript" src="http://code.jquery.com/jquery-1.8.0.min.js"></script>--->
    ...
    $("#ParseReport").live('click',function() {
 	 	  
 	 	    var queImg = $("#URLIma").val();
 	 	    var cadena =  '<?php echo $domain;?>/parsereport.php?URLIma='+queImg+'&idioma=spa';
	 	  	var RecTipo = LanzaAjax (cadena);
	 	  	
	 	  	
	 	  	var inicio =RecTipo.indexOf("*3INICIO3*");
	 	  	var finale = RecTipo.indexOf("*3FINAL3*");
	 	  	var extraido = RecTipo.substring(inicio+10, finale);
	 	  	
	 	  	//$("#ParseWindow").html(RecTipo+'EXTRAIDO EXACTO:'+extraido+'****HASTA AQUI');
	 	  	$("#ParseWindow").html(extraido);
    ...
    $("#BotonUpload").live('click',function() {
	    ...
	    var VIEWIP = 0;
	    var MEDIO = 0;
	    var cadena = 'http://www.health2.me/LogEvent.php?IDPIN='+IDPIN+'&Content='+Content+'&VIEWIdUser='+VIEWIdUser+'&VIEWIdMed='+VIEWIdMed+'&VIEWIP='+VIEWIP+'&MEDIO='+MEDIO;
	 	var RecTipo = LanzaAjax (cadena);
	 	//alert (RecTipo);
	 	*/
   	});
...
//     $('this option:selected').remove();
    ...
    $('.note').click( function () {
	    ...
	    var queMed = $("#IdMed").val();
	 	
	 	var IDPIN = queId;
	    var Content = 'Information (ORIGINAL) displayed to DOCTOR (Pat. Detail scr)';
	    var VIEWIdUser = 0;
	    ...
	    else
	    {
	    	if (subtipo=='XX') { 
	    		...
	    		var conten = '<img id="ImagenN" src="<?php echo $domain;?>/Packages/'+queImg+'" alt="">';
	    		}
	    	else{ 

...
<input type="hidden" id="UserHidden">
	...
	<!--			<tr>
				...
				<tr>
					...
					<td style="width:80%"><input id="Email" type="text" style="margin-top: 10px;width: 95%; float:left;font-size:14px;height:17px" lang="en" placeholder="Select Email" readonly></td>
				</tr>
			</table>
		</div>
		...
		while (n<numMedications){
			...
			switch(f)
			{
				...
				case 1:switch(d)
					...
					MedicationBox += '<div class="DeleteMedication" id="'+rowid+'" style="width:60px; float:right;"><a id="'+rowid+'"  class="btn" style="height: 15px; padding-top: 0px; margin-top: -5px; color:red;" lang="en">Del</a></div>';
		...
		while (n<numMedications){
			...
			switch(f)
			{
				...
				case 1:switch(d)
					...
					MedicationBox += '<div class="DeleteMedication" id="'+rowid+'" style="width:60px; float:left;">Editing</div>';
	...
	function getRelatives()
	{
		...
		while (n<numRelatives){
			...
			RelativesBox += '<div class="InfoRow">';
					...
					RelativesBox += '<div class="DeleteRelative" id="'+rowid+'" style="width:60px; float:right;height:30px;"><a id="'+rowid+'"  class="btn" style="height: 15px; padding-top: 0px; margin-top: -5px; color:red;" lang="en">Del</a></div>';
	...
	function getRelativesEdit(toShow)
	{
		...
		while (n<numRelatives){
			...
			RelativesBox += '<div class="InfoRow">';
					...
					RelativesBox += '<div class="DeleteRelative" id="'+rowid+'" style="width:60px; float:left;height:30px;">Editing</div>';
  ...
  //-------------------------------------- CODE FOR IMMUNIZATION AND ALLERGY -------------------------------------------------------------
	...
	$( "#intensity-slider2" ).slider({
	      ...
	      slide: function( event, ui ) {
	        ...
	        switch (ui.value)
	        {
		        case 0:	$("#intensitylabel2" ).html('<font style="color:hsl(0, 100%, 20%);">Very Low</font>');
						break;
		        case 1:	$("#intensitylabel2" ).html('<font style="color:hsl(0, 100%, 26%);">Low</font>');
						break;
		        case 2:	$("#intensitylabel2" ).html('<font style="color:hsl(0, 100%, 32%);">Medium</font>');
						break;
		        case 3:	$("#intensitylabel2" ).html('<font style="color:hsl(0, 100%, 38%);">High</font>');
						break;
		        case 4:	$("#intensitylabel2" ).html('<font style="color:hsl(0, 100%, 44%);">Very High</font>');
						break;
		        case 5:	$("#intensitylabel2" ).html('<font style="color:hsl(0, 100%, 50%);">Extreme</font>');
						break;
	        }
	        $( "#intensity2" ).val( ui.value );
	...
	function getVaccines()
	{
		...
		while (n<numVaccines){
			...
			VaccinesBox += '<div class="InfoRow">';
					...
					VaccinesBox += '<div class="DeleteVaccine" id="'+rowid+'" style="width:60px; float:right;"><a id="'+rowid+'"  class="btn" style="height: 15px; padding-top: 0px; margin-top: -5px; color:red;" lang="en">Del</a></div>';
	...
	function getVaccinesEdit(toShow)
	{
		...
		while (n<numVaccines){
			...
			VaccinesBox += '<div class="InfoRow">';
					...
					VaccinesBox += '<div class="DeleteVaccine" id="'+rowid+'" style="width:60px; float:left;">Editing</div>';
...
if(del==0)
			...
			VaccinesBox += '<div class="InfoRow">';
					...
					VaccinesBox += '<div class="DeleteAllergy" id="'+rowid+'" style="width:60px; float:right;"><a id="'+rowid+'"  class="btn" style="height: 15px; padding-top: 0px; margin-top: -5px; color:red;" lang="en">Del</a></div>';
...
if(del==0)
			...
			VaccinesBox += '<div class="InfoRow">';
					...
					VaccinesBox += '<div style="width:210px; float:left; text-align:left;"><span class="PatName">'+leftcolumn+'</span></div>';
					VaccinesBox += '<div style="width:140px; float:left; text-align:left; color:#22aeff;"><span class="DrName">'+middlecolumn +' </span></div>';
					VaccinesBox += '<div class="DeleteAllergy" id="'+rowid+'" style="width:60px; float:left;">Editing</div>';
...
if(del==0)
			...
			if(rowid==toShow)
			{
				DiagnosticBox += '<div style="width:10px; float:left; text-align:left;"><i class="icon-chevron-down"></i></div>';
					...
					DiagnosticBox += '<div class="DeleteDiagnostic" id="'+rowid+'" style="width:60px; float:right;"><a id="'+rowid+'"  class="btn" style="height: 15px; padding-top: 0px; margin-top: -5px; color:red;" lang="en">Del</a></div>';
...
if(rowid==toShow)
			...
			if(notes.length==0)
			{
				...
				DiagnosticBox += '<div style="width:10px; float:left; text-align:left;"><i class="icon-chevron-down"></i></div>';
					...
					DiagnosticBox += '<div class="EditDiagnostic" id="'+rowid+'" style="width:60px; float:left;margin-right:20px;">Editing</div>';
			}
	//				DiagnosticBox += '<div style="width:200px; float:left; text-align:left;cursor:pointer"><span class="PatName" style="white-space:nowrap"><strike>'+dxname.substr(0, 30)+'</strike></span></div>';
	//				DiagnosticBox += '<div style="width:200px; float:left; text-align:center; color:#22aeff;"><span class="DrName"><strike>'+middleColumn +' </strike></span></div>';
...
//		alert(idrow);
	...
	$(".EditDiagnostic").live('click',function(){
		var myClass = $(this).attr("id"); 
		//alert (myClass);
		$("#editDiagnostics").dialog({bgiframe: true, width: 550, height: 510, modal: true,title:"Edit Past Diagnostics"});
	...
	$(".EditMedication").live('click',function(){
		var myClass = $(this).attr("id"); 
		//alert (myClass);
		$("#editMedications").dialog({bgiframe: true, width: 550, height: 380, modal: true,title:"Edit Past Medications"});
	...
	$(".EditFamilyHistory").live('click',function(){
		var myClass = $(this).attr("id"); 
		//alert (myClass);
		$("#editFamilyHistoryModal").dialog({bgiframe: true, width: 550, height: 380, modal: true,title:"Edit Past Family History"});
	...
	$(".EditVaccine").live('click',function(){
		var myClass = $(this).attr("id"); 
		//alert (myClass);
		$("#editVaccineModal").dialog({bgiframe: true, width: 550, height: 380, modal: true,title:"Edit Past Vaccines"});
	...
	$(".EditAllergy").live('click',function(){
		var myClass = $(this).attr("id"); 
		//alert (myClass);
		$("#editAllergyModal").dialog({bgiframe: true, width: 550, height: 380, modal: true,title:"Edit Past Allergies"});

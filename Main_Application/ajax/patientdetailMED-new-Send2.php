  ...
  <body onload=" $('.TABES:eq(<?php echo $tabToOpen;?>)').click();">
	...
	<div class="header" >
          ...
          <?php
		   ...
		   <a href="#en" onclick="setCookie('lang', 'en', 30); pageRefresh(); return false;"><img src="icons/english.png"></a>
		   </br>
			<a href="#sp" onclick="setCookie('lang', 'th', 30); pageRefresh(); return false;"><img src="icons/spain.png"></a>
			</div>
    ...
    <!-- End of MOdal for PhoneNotes -->
     ...
     <!--<ul class="menu-speedbar"> Commented out by pallab as not required for NOn H2M doctor for Send
		<?php
            /*if($MedID > 0)
            {

...
$result_group->execute();
 ...
 while($cnt>0){
	...
	*/
	...
	<span style="font-size:16px; color:#54bc00; width:80px; padding-top:6px; height:6px; diplay:inline-block;" class="truncate">'.$SurnameP.'.</span>
	...
	<span style="font-size:16px; color:#22aeff; width:135px; padding-top:6px; height:6px; display:inline-block;" class="truncate">'.substr($nomDoc,0,18).$AddNom.'</span>
...
//////////////////////////////////////////////////////////////////HERE IS WHERE THE CODE REALLY STARTS/////////////////////////////////
	...
	*/
	...
	echo '<td class="ROWREF" id="'.$idP.'" style="height:10px; width:200px; line-height:0;">
	<div style="padding:10px;">
	<span style="font-size:16px; color:#54bc00; width:80px; padding-top:6px; height:6px; display:inline-block;" class="truncate">'.$SurnameP.'</span>
	<span style="font-size:16px; color:#54bc00;">'.strtoupper(substr($NameP,0,1)).'.</span>

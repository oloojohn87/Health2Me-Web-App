...
-->
  ...
  getHabitsInfo();
	...
	{
		var queUrl ='getDOB4VaccCalc.php';
		$.ajax(
		{
			url: queUrl,
			dataType: "json",
  ...
  $('#DiagnosticEditBox').live('click',function()	{
    ...
    function LoadDonuts(){
		...
		if (bestVerified > -1)
		{
			...
			title =  '<span class ="ribbon-lgtext">Verified</span><br> <span class ="ribbon-smtext">by '+namedoctor+' '+formattedDate+'<span class ="ribbon-lgtext">';

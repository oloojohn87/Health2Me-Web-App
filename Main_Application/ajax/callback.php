...
<Response>
    ...
    <Gather action="handle-user-input.php?IdRef=<?php echo $IdRef?>" numDigits="1">
        ...
        <Say language="en" voice="man" >This is a patient information shipping from  <?php echo 'Doctor'; echo $NameDoctorRequest; echo $SurnameDoctorRequest ?>.</Say>
        <Say language="en" voice="man">To share with you the Clinical Record of Patient <?php echo $NamePatient; echo $SurnamePatient; ?>.</Say>

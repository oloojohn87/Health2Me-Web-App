	...
	<div id="content" style="padding-left:0px; background: #F9F9F9; height:2100px;">
     ...
     <div class="content" >
	  ...
	  <!--- VENTANA MODAL NUMERO 2  ---> 
        ...
        <input type="hidden" id="IdUsuP" value="<? echo $IdUsu ?>" />
...
?>
          ...
          <div class="queIMG" id="<?php echo $row['RawImage']; ?>" style="background-color: white; height:150px; width:150px;  padding:0px; margin:0px; overflow: hidden;">
          ...
          <!--
           ...
           -->
            ...
            <!--<div style="height:250px; float:left; margin-left:-10px; padding-left:0px;"><p class="css-vertical-text" style="font-size:10px; color:grey;"><?php echo $FechaBien; ?></p></div>-->
  ...
  <!--  <script type="text/javascript" src="http://code.jquery.com/jquery-1.8.0.min.js"></script>--->
    ...
    $("#BotonUpload").live('click',function() {
	    ...
	    */
	    ...
	    var VIEWIP = 0;
	    var MEDIO = 0;
	    var cadena = '<?php echo $domain;?>/LogEvent.php?IDPIN='+IDPIN+'&Content='+Content+'&VIEWIdUser='+VIEWIdUser+'&VIEWIdMed='+VIEWIdMed+'&VIEWIP='+VIEWIP+'&MEDIO='+MEDIO;
	 	var RecTipo = LanzaAjax (cadena);
	 	//alert (RecTipo);
	 	*//*KYLE
   	});
    ...
    $('.note2').click( function () {
	    ...
	    else
	    {
	    	if (subtipo=='XX') { 
	    		...
	    		var conten = '<img id="ImagenN" src="<?php $domain ?>/Packages/'+queImg+'" alt="" style="border:1px solid #666CCC; margin:0 auto; display:block;">';
	    		}
	    	else{ 
	    		var contenTHURL = '<?php echo $domain;?>/eMapLife/PinImageSetTH/'+queImg; 
	    		var conten = '<img id="ImagenN" src="<?php $domain ?>/eMapLife/PinImageSet/'+queImg+'" alt="" style="border:1px solid #666CCC; margin:0 auto; display:block;">';
	    		}  // PONER /PinImageSetTH/ en lugar de /PinImageSet/ PARA CARGAR THUMBNAILS EN LUGAR DE IMAGENES COMPLETAS
	    	var contenTH = '<img id="ImagenTH"  src="'+contenTHURL+'" alt="">';
	    //if(urlExists(contenTHURL)) {}else { contenTHURL = '<?php echo $domain;?>/eMapLife/PinImageSet/'+queImg;}
	    }
...
$cadena='{
    "timeline":
    {
        ...
        "asset": {
            "media":"<?php $domain ?>/images/ReportsGeneric.png", 
            "credit":"(c) health2.me",

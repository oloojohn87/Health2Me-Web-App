...
<input type="hidden" id="UserHidden">
    ...
    <!-- Start of Template of Processed Reports(right column, RepRow) Subsection --> 
                 <!--<div id="processedReportMetaData" value ="" class="RepRow" style="display:none;">
					 ...
					 <div style="float:left; border:0px solid #cacaca; width:380px; height:89px;">
								 <div style="float:left; width:50px; height:80px; background-color:white;"><button id="ViewFilePreview" value = "" style="margin-top:15px;margin-left:5px;height:48px;width:48px;font-weight:bold; background-image: url(images/File-icons/48px/pdf.png); background-color: #FFF; border: 0px solid #FFF;"></button>
                         ...
                         <div style="float:left; width:330px; height:70px; background-color:white; padding-top:10px; border:0px solid #cacaca;">
									 ...
									 <div style="float:left; width:270px; height:70px; background-color:white; border:0px solid #cacaca;">
									 	...
									 	<div style="float:left; width:100px;"><input type="text" class="span2" value="<?php echo $dateFinal; ?>" id="dp1" readonly="" style="width:100px; min-height:20px; font-size:12px; "></div>						 
									     </div>
										...
										<div class="btn-group" style="font-size:10px;">
											  ...
											  <button id = "toggleButton" type="button" class="btn btn-xs dropdown-toggle" data-toggle="dropdown" style="overflow:visible;font-size:12px; width:100px; text-align:left;">
											    Types <span class="caret" style="float:right;"> </span>
											  </button>
											  <ul style ="overflow:visible;" class="dropdown-menu" role="menu">
									 ...
									 <div style="float:left; width:50px; height:70px; background-color:white; border:0px solid #cacaca;">
									 	 <button id = "Close" class="btn btn-danger" style="height: 50px; padding-top: 0px; margin-top: 0px; margin-left:8px;">Del</button>	
									 </div>	 
                         ...
                         <div class="progress progress-striped active" style="float:left; width:300px; height:10px; margin-left:10px;">
										  <div id="progressbar" class="progress-bar"  role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width: 45%">
										    <span id = "progressbarSpan" class="sr-only">45% Complete</span>
										  </div>
								 </div>
...
<!-- End of Processed Reports Subsection -->
...
<!-- start of code for modal window for create account button -->
  ...
  <div id="createAccount" style="overflow:visible;display:none;  padding:20px;">
        <div style="border:solid 1px #cacaca; margin-top:5px; padding:10px;">
           ...
           <p> <span id = "gender">Gender 
        <input type ="radio" name="sex" value="male" style="margin-left:30px">Male<br>
        <input type="radio" name="sex" value="female" style="margin-left:93px">Female</p>
		</div>
...
{
    var uploadURL ="http://dev.health2.me/upload_dropzoneRequestReportsExtDoc.php"; //Upload URL
                    ...
                    for(var i = 0;i < files.length;i++,j++) 
                        {
                          //  code for datepicker text area in dob of create account page
                           ...
                           // Changing the width of the progress bar   
                            ...
                            // Binding the function to the Report Type button adjacent to the Select Type of Report
                            $("#ReportType"+j).on('input',function(){
...
/*Dropzone.options.ReportsDropzone = {
    ...
    //Code for Finish button
        ...
        var updateUrl = "http://dev.health2.me/sendReturnMail2User.php";
        $.ajax({

	   ...
	   <div class="grid" class="grid span4" style="width:1000px; margin: 0 auto; margin-top:30px;">
		...
		<div class="row-fluid" style="height:400px; width:1000px; margin:0 auto;">	            
		  ...
		  <div style="margin:15px; padding-top:20px;">
			     <span class="label label-info" style="left:0px; margin-left:10px; margin-top:40px; font-size:30px;">Dashboard</span>
...
*/
 ...
 -->
    ...
    $(".CFILAMODAL").live('click',function() {
     	...
     	{
	     	x="You pressed OK!";
	     	queUrl ='UpdatePinUser.php?quePin='+pines[0].IdPin+'&queUsu='+myClass+'&queIdUsFIXED='+user[0].IdUsFIXED+'&queIdUsFIXEDNAME='+user[0].IdUsFIXEDNAME;

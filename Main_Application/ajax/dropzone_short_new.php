...
$pat = mysql_query("select idusfixedname from usuarios where identif=".$patient_id);
$pat_name=mysql_fetch_array($pat);
	...
	$(document).ready(function() {
      ...
      function onFinishCallback()
	  {
		...
		// var file = document.getElementById('file');
            ...
            // dataFile.append('file',$(file)[0].files[0]);
			//getImageDimension('getImageDimension.php');
		/*KYLEvar DirURL = 'dropzone_create_patient.php?idcreator=<?php echo $_SESSION['MEDID'];?>&idusfixed='+idusfixed+'&idusfixedname='+idusfixedname+'&name='+fname+'&surname='+sname+'&initial='+initial;
			//var DirURL = 'checkFileUploaded.php';
			// alert(DirURL);
		  $.ajax({
           url: DirURL,

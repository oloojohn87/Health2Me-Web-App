...
$result = $con->prepare("SELECT * FROM basicemrdata WHERE IdPatient = ? ORDER BY IdPatient ASC");
...
$result = $con->prepare("select * from p_diagnostics where idpatient = ? order by id ASC");
$result->bindValue(1, $UserID, PDO::PARAM_INT);
$result->execute();
$row = $result->fetch(PDO::FETCH_ASSOC);
...
//Start of new code by Pallab
$result = $con->prepare("select * from p_medication where idpatient = ? order by id ASC");
$result->bindValue(1, $UserID, PDO::PARAM_INT);
$result->execute();
$row = $result->fetch(PDO::FETCH_ASSOC);
...
//Start of new code by Pallab
$result = $con->prepare("select * from p_immuno where idpatient = ? AND AllerName is null order by id ASC");
$result->bindValue(1, $UserID, PDO::PARAM_INT);
$result->execute();
$row = $result->fetch(PDO::FETCH_ASSOC);
...
//Start of new code by Pallab
$result = $con->prepare("select * from p_family where idpatient = ? order by id ASC");
$result->bindValue(1, $UserID, PDO::PARAM_INT);
$result->execute();
$row = $result->fetch(PDO::FETCH_ASSOC);
...
//Start of new code by Pallab
$result = $con->prepare("select * from p_habits where idpatient = ? order by id ASC");
$result->bindValue(1, $UserID, PDO::PARAM_INT);
$result->execute();
$row = $result->fetch(PDO::FETCH_ASSOC);
...
//Start of new code by Pallab
$result = $con->prepare("select * from p_immuno where idpatient = ? and AllerName is not null order by id ASC");
$result->bindValue(1, $UserID, PDO::PARAM_INT);
$result->execute();
$row = $result->fetch(PDO::FETCH_ASSOC);

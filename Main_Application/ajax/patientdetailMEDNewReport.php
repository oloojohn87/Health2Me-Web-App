...
?>
  ...
  <!--  <script type="text/javascript" src="http://code.jquery.com/jquery-1.8.0.min.js"></script>--->
    ...
    $("#BotonUpload").live('click',function() {
	 	...
	 	var cadena = ''$domaindev'/UsuTimeline.php?Usuario='+queUsu+'&IdMed=0';
	 	var RecTipo = LanzaAjax (cadena);
	    alert (RecTipo);
	    */
	    ...
	    var VIEWIP = 0;
	    var MEDIO = 0;
	    var cadena = ''$domaindev'/LogEvent.php?IDPIN='+IDPIN+'&Content='+Content+'&VIEWIdUser='+VIEWIdUser+'&VIEWIdMed='+VIEWIdMed+'&VIEWIP='+VIEWIP+'&MEDIO='+MEDIO;
	 	var RecTipo = LanzaAjax (cadena);
	 	//alert (RecTipo);
	 	*/
   	});
...
//     $('this option:selected').remove();
    ...
    $('.note2').click( function () {
	    ...
	    else
	    {
	    	...
	    	var contenTH = '<img id="ImagenTH"  src="'+contenTHURL+'" alt="">';
	    //if(urlExists(contenTHURL)) {}else { contenTHURL = ''$domaindev'/eMapLife/PinImageSet/'+queImg;}
	    }

...
<div id="modalContents" style="display:none; text-align:center; padding-top:20px;">
		<a id='ButtonSkype' href="UserDashboard-new.php" value="Telemedicine" class="btn" title="Telemedicine" style="text-align:center; padding:15px; width:40px; height:40px; color:#22aeff; margin-left:50px; float:left;"> 
    ...
    <!--                 <a href="weemo_test.php?calleeID='<?php echo $DoctorEmail?>'" class="btn" title="Schedule" style="text-align:center; padding:15px; width:100px; height:50px; color:#22aeff; margin-left:20px; float:left;"> -->
					<a id='telemedicine'  href="UserDashboard-new.php" value="Telemedicine" class="btn" title="Telemedicine" style="text-align:left; padding:15px; width:90px; height:25px; color:#22aeff; margin-left:20px; float:left;"> 
                     	<i class="icon-camera icon-2x" style="float:left; margin:0 auto; padding:0px; color:#54bc00;"></i>
                     	<div style="float:left; line-height:25px; margin-left:6px;"><span>Telemed</span></div>

...
$next_spot = 1;
$phs_spot = 0;
$query = "SELECT * FROM doctors WHERE IdMEDEmail is not null AND Surname = 'kim' ";
if($telemed_only == 1)
{
    $query .= 'AND telemed = 1 ';
}
...
while (($row = $result->fetch(PDO::FETCH_ASSOC)) && $count < 6) 
{
    /*

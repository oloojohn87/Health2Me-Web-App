	  ...
	  <!--- VENTANA MODAL  ---> 
        ...
        <div class="grid" style="width:97%;">
        	<div class="grid-content overflow">
              <div class="pull-left"><a href="#" class="btn"><i class="icon-upload-alt"></i> Upload Report</a> </div>
...
$selecURL ='http://www.monimed.com/eMapLife/PinImageSetTH/'.$row['RawImage'];
$file = $selecURL;
...
//     $('this option:selected').remove();
    ...
    $('.note').click( function () {
	    ...
	    var contenTHURL = 'http://www.monimed.com/eMapLife/PinImageSet/'+queImg;  // PONER /PinImageSetTH/ en lugar de /PinImageSet/ PARA CARGAR THUMBNAILS EN LUGAR DE IMAGENES COMPLETAS

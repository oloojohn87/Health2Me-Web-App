...
//CONSTRUCTOR FUNCTION INITIALIZES ON OBJECT CREATION////////////////////////////////////////////////////////////////////////
	function __construct(){
        ...
        //MAYBE WE NEED TO INCLUDE THE WHOLE FILE OF environment_detail HERE DUE TO THE PATH ISSUE
		require_once("/var/www/html/Main_Application/ajax/environment_detail.php");
		...
		if($this->member_privilege == 'CATA' || strpos($this->doctor_service, 'CATA') !== false) {
	...
	//These allow for correct encoding of member name....
        ...
        $this->member_grant_access = $row['grant_access'];
	...
	require "../../../../Services/Twilio.php";
		...
		$this->telemed_type = $this->doctor_telemed_type;

...
$queUsu = cleanquery($_GET['Doctor']);
$NReports = cleanquery($_GET['NReports']);
...
if ($withGroup == 0) {
    ...
    $query_str = "SELECT idus.Identif, U.Name, U.Surname, 
                ...
                ( SELECT Identif, 0 AS gr FROM usuarios WHERE IdCreator = ? AND TIMESTAMPDIFF(DAY, signUpDate, NOW()) <= 30
                  ...
                  SELECT IdUs AS Identif, 0 AS gr FROM doctorslinkusers WHERE IdMED = ?

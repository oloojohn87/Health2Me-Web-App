<?php
    ...
    require 'telemedicinePatClass.php';

    $master = new telemedicinePatClass($_GET['doc_id']);
    /*
...
<html>
    ...
    <body style="background-color: #FAFAFA;">
        ...
        <div id="connection_toolbar">
            <div id="connection_description">You are in a consultation with <span style="color: #22AEFF">Dr. <?php echo $master->doctor_name; ?>.</span></div>
        ...
        <div id="doctor_presence_notification" style="width: 100%; text-align: center; font-size: 28px; font-family: Calibri, sans-serif; color: #BBB; margin-top: 240px;">
            The doctor has not yet entered the consultation<br/>Please Wait ...
        </div>
        ...
        <script src="js/telemed_pat.js"></script>

...
if (!$con)
  ...
  $privilege=$_SESSION['Previlege'];
	...
	$basefilename = $user->mem_id.'.png';
	$qrdata = $domain."/emergency.php?id=".$user->mem_id;
    ...
    <div id="search_modal" title="Search Doctors" style="display:none; text-align:center; width: 900px; height: 700px; overflow: hidden;">
        ...
        <div id="doctor_directory">
           <div id="search_doctor_toolbar" style="width: 100%; height: 30px; margin-left: 15px;"> 
                ...
                <div style="width:670px; margin:10px 0 -10px 15px; float:left;">      
            ...
            <div id="doctor_rows" style="float:left; width: 90%; margin: 30px 0 0 15px; height: 510px;">
            ...
            <div style="width: 85%; height: 200px; float: left;">
                ...
                <div id="setup_page_6" style="display: none;">
                    ...
                    <?php
                            ...
                            else if($plan == 'FAMILY' && $access == 'Delegate' && $user->member_age >= 18)
                            {
                      ...
                      <div style="margin:15px; padding-top:0px;">
                             ...
                             <?php
                                          ...
                                          $avat = 'identicon.php?size=75&hash='.$hash;
                                            ?>	
						  <a href="emergency.php?id=<?php echo $user->mem_id; ?>">   <img src="<?php echo $qrcodeResults; ?>" style="width:90px;height:90px;float:right; margin-right:40px; font-size:18px; padding:0px 0px 15px 0px; font-family: “Andale Mono”, AndaleMono, monospace;"/></a>
                          <style>
                            div.RowNotif{      
                                  width: 100%;
                                  height: 25px;
...
<div id="modalContents" style="display:none; text-align:center; padding-top:20px;">
    ...
    <script type="text/javascript" src="js/h2m_userdashboard.js"></script>
    <script type="text/javascript" src="js/h2m_probePurchaseClass.js"></script>
    ...
    <script src="js/doctor_search_mars.js"></script> <!-- used for doctor search modal window -->
...
<link rel="stylesheet" href="js/signature/assets/jquery.signaturepad.css">
  ...
  <script src="js/h2m_medicalrelease.js">
	  alert("loaded script");
</script>
...
<script type="text/javascript">	
    ...
    $('#SearchDirectory').trigger('click');
        var i = 0;
        var lic_size = 0;
        var lic_mul = "no";
        var lic_height = 0;
        
        $('#doctor_rows').bind('dbclick', function() {
            //alert($(this).find('.doctor_license')[0]);
            $(this).find('.doctor_license').each(function() { 
                var el = $(this);
                lic_mul = el.attr('data-lic-multiple');
                //alert(lic_size);
                //alert(lic_mul);
                if(lic_mul == 'yes') {
                    lic_size = el.attr('data-lic-size');            
                    setInterval(function(){
                        ...
                        //alert(lic_size);
                        el.animate({ scrollTop: lic_height }, { duration: 700 }); 

     ...
     <div class="grid" class="grid span4" style="width:1000px; margin: 0 auto; margin-top:30px; padding-top:30px;">
         ...
         <div class="grid" class="grid span4" style="height:80px; margin:0px auto; margin-top:-20px; margin-left:10px; margin-right:10px; padding:20px;">
            ...
            <div id="NombreComp" style="width:100%; color: rgba(34,174,255,1); font: bold 22px Arial, Helvetica, sans-serif; cursor: auto;"><?php echo $MedUserTitle.' '.$show_text;?> <?php echo $show_text2;?></div>
                <span id="NombreComp" lang="en" style="color: rgba(84,188,0,1); font: bold 16px Arial, Helvetica, sans-serif; cursor: auto; margin-top:-5px;"><span lang="en">CENTER</span>:  <span lang="en"><?php if ($MedGroupName<' ') echo 'single license'; else echo $MedGroupName ;?></span>
		...
		$.ajax(
			{
				...
				success: function(data)
				{
					...
					if(telemed_pat != '' && banner_holder == 0){
						$("#phone_consultation_text").html("Member " + d.name + " is calling you for a phone consultation for <font color='black'>"+d.Description+"</font>");
...
/*$.post('get_current_telemed_info.php', {id : $("#MEDID").val()}, function(data, status)
        {
            var d = JSON.parse(data);
            telemed_pat = d['ID'];
	    $("#phone_consultation_id").val(telemed_pat);
	    $("#phone_consultation_name").val(d['Name']+' '+d['Surname'])
        });*/
    ...
    {
	//var telemed_pat = $("#phone_consultation_id").val();

$( document ).ready(function() {  
		...
		$("#box-2").click(function() {
			//alert("hello");
			//get_reports(num_reports,2);
		});	
		$("#box-3").click(function() {
			//get_reports(num_reports,2);;	
		});	
		$("#box-4").click(function() {
			//get_reports(num_reports,4);
		});		
		$("#box-5").click(function() {
			//get_reports(num_reports,5);	
		});	
		$("#box-6").click(function() {
			//get_reports(num_reports,6);
		});	
		$("#box-7").click(function() {
			//get_reports(num_reports,7);	
		});	
		$("#box-8").click(function() {
			//get_reports(num_reports,8);	
		});	
		//$(".note").hide();
...
/*Out : EntryTypeGroup									*/
/*Desc: 												*/
function get_reports(user,num_reports, entry_type_group){

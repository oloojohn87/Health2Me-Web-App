...
function get_doctors()
{
    ...
    $.post(domain+"getTelemedDoctorsMobile.php", {starting_point: doctors_next_result, order: order_column, asc: order_direction, timezone: get_timezone_offset(), online_only: online_only, telemed_only: telemed_only, search_term: $("#search_bar").val(), speciality: sp, location: loc}, function(data,status)
    {
        //console.log(data);
        var info = JSON.parse(data);

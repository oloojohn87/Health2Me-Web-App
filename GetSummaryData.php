...
$hold_address = '';
	...
	if (strlen(trim(htmlspecialchars($row['DOB']))) > 0) $AdminData++;
	if (strlen(trim(htmlspecialchars($hold_address))) > 0) $AdminData++;
	if (strlen(trim(htmlspecialchars($row['City']))) > 0) $AdminData++;
	if (strlen(trim(htmlspecialchars($row['state']))) > 0) $AdminData++;
	if (strlen(trim(htmlspecialchars($row['zip']))) > 0) $AdminData++;
	if (strlen(trim(htmlspecialchars($row['phone']))) > 0) $AdminData++;
	if (strlen(trim(htmlspecialchars($row['insurance']))) > 0) $AdminData++;

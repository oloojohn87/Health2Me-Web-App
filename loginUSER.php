...
/* if($access==23432)
 ...
 //   echo '*** ';
    ...
    if($count==1)
	{
        ...
        // LOG LOGIN SUCCESS
        $success = $con->prepare("INSERT INTO login_attempts SET date = NOW(), username = ?, ip = ?, success = 1, type = 'PAT'");
        $success->bindValue(1, $row['Alias'], PDO::PARAM_STR);
        $success->bindValue(2, $_SERVER['REMOTE_ADDR'], PDO::PARAM_STR);
        $success->execute();
        ...
        if(strpos($GrantAccess, 'HTI') !== false) {
            ...
            // LOG LOGIN FAILED
            $failed = $con->prepare("INSERT INTO login_attempts SET date = NOW(), username = ?, ip = ?, success = 0, type = 'PAT'");
            $failed->bindValue(1, $row['Alias'], PDO::PARAM_STR);
    ...
    else
	{
		...
		//////////////////////////////////////////////////////////////////
            ...
            // LOG LOGIN SUCCESS
            $success = $con->prepare("INSERT INTO login_attempts SET date = NOW(), username = ?, ip = ?, success = 1, type = 'PAT'");
            $success->bindValue(1, $row2['Alias'], PDO::PARAM_STR);
            $success->bindValue(2, $_SERVER['REMOTE_ADDR'], PDO::PARAM_STR);
            $success->execute();

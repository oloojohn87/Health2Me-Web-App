...
<body style="background: #F9F9F9;">
    ...
    <!-- MAIN GRID -->
     <div class="grid" class="grid span4" style="width:1000px; margin: 0 auto; margin-top:30px; padding-top:30px;">
        ...
        <div style="display:none; margin-right:10px; min-width: 70px;">
           ...
           <div id="EngaBOX" style="display:inline-block; vertical-align:top; width:250px;float:right; margin-right:80px;">
    ...
    <div class="grid" class="grid span4" style="margin:0px auto; margin-top: 10px; margin-left:10px; margin-right:10px; padding:20px; height: 40px;  display:none; background-color: #54bc00;" id="part_f">
        <div><div style="width: 78%; height: 30px; margin-top: -20px; float: right;"><a id="phone_consultation_connect" href="javascript:void(0)" class="btn" title="Acknowledge" style="width:18%; color: green; margin-bottom: 2px; float: right; padding-left: -15px;">View Member Records</a></a><p id="phone_consultation_text" style="color: #FFF; height: 10px; font-size: 14px; margin-top: 4px;"><span lang="en">You are on a phone consultation with patient</span> <?php echo $telemed_name; ?>.</p></div><input type="hidden" id="phone_consultation_id" value="<?php echo $telemed; ?>" /><input type="hidden" id="phone_consultation_name" value="<?php echo $telemed_name; ?>" /><span class="label label-info" id="EtiTML" style="float:left;background-color:#FFF; margin-top: -15px; margin-left:0px; margin-bottom:0px; font-size:16px; text-shadow:none; text-decoration:none; color:#54bc00;">Phone Consultation</span></div>
    </div>
    <!-- END PART F -->
...
$(document).ready(function() 
{
    ...
    {
        $("#phone_consultation_text").text("You are on a phone consultation with patient " + $("#phone_consultation_name").val() + ".");
...
//	    alert (id-1+' stopping '+(id-2)+' and '+(id));
    ...
    */
    ...
    $("#BotonBusquedaPac").click(function(event) {
            ...
            var serviceURL =hp' + '?Usuario=' + UserInput; 

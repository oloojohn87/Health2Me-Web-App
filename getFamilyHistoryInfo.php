...
$queUsu = 0;
// get the user ID from that value passed in if it is set, or session if not
if(isset($_GET['IdUsu']) && $_GET['IdUsu'] != NULL && $_GET['IdUsu'] != 0)
{
    $queUsu = $_GET['IdUsu'];
}
else
...
echo '<style>';
echo 'div.FamRow{';
echo '  width:420px; height:35px; background-color:white; text-align:center; display:table-cell; vertical-align:middle;';
echo '  } ';
echo 'icon.si{';
...
echo '				<div  style="width:100%; height:20px; border:0px solid; text-align:center; background-color: #e74c3c; color: white;line-height: 20px;">';
	...
	echo '</div>';
echo '				<div id="TableContainer" style="width:365px; margin-top:15px; border:0px solid #cacaca;">';
echo '					<table style="margin-top:5px; background-color:white;">';
// Grandparents Line

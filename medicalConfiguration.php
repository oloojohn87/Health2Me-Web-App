...
$filename = $local."DoctorImage/".$user->med_id.".jpg";
    
if(!file_exists($filename))
{
    $filename = $hardcode."PatientImage/defaultDP.jpg";
}
else $filename = $hardcode."DoctorImage/".$user->med_id.".jpg";
...
<div id="Loading"></div>
	...
	<!-------------------------------------------------------------------------------------------HIDDEN INPUTS-------------------------------------------------------------------------------------->
    	...
    	<input type="hidden" id="IdMEDEmail" Value="<?php if(isset($user->doctor_email)) echo $user->doctor_email; ?>">	
      ...
      <!--  Start of comment <div style="float:left;">
		   ...
		   <div class="btn-group pull-right" >
            ...
            <a class="btn btn-profile dropdown-toggle" id="button-profile" data-toggle="dropdown" href="#">
              <span class="name-user"><strong lang="en">Welcome</strong>, <?php echo $user->doctor_first_name.' '.$user->doctor_last_name; ?></span> 
             <?php 
...
<!--CONTENT MAIN END-->
    ...
    <script>
        $(document).ready(function(){
            ...
            function get_main_data(scope, period)
            {
                ...
                $.post("getConsultationsDataConfig.php", {period: period, medid: medid}, function(data, status)
                {
                    console.log(data);
   ...
   <script src="realtime-notifications/lib/gritter/js/jquery.gritter.min.js"></script>
    ...
    <script type="text/javascript" src="js/h2m_medicalconfiguration.js"></script>

...
echo '  } ';
echo 'div.Section2{';
echo '  float:left; width: 50%; height: 90%; border:0px solid #cacaca; margin-top: 2px;display: table;';
echo '  } ';
echo 'p.DisText{';
...
echo '<div id="TimelineContainer" 		style="margin:0 auto; width:480px; height:'.$HeightContainer.'px; margin-top:18px; border:0px solid #cacaca;">';
echo '	<div id="ColDataLabels"     	style="float:left; width:0px; height:100%; border:0px solid #cacaca; position:relative;">';
...
$new_month = 'Dec '.substr($dateA, 4, 4);
 ...
 // echo '<style>div.SemiBall {width:0px; }; </style>';
	...
	echo '				<p class="DisText">'.substr($surgery[$n],0,50).'</p>';
	echo '			</div>';
	echo '		</div>';	

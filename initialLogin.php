...
<input type="hidden" id="UserHidden">
	...
	<div class="header" >
		...
		<input type="hidden" id="IDPIN_HOLDER" Value="<?php echo $_GET['idpins']; ?>"><!--	
    ...
    <!--Header END-->
   	 ...
   	 <button id="message_modal" data-target="#header-message" data-toggle="modal" class="btn btn-warning" style="display: none;">Modal with Header</button> 
         ...
         <div class="formRow" style=" margin-top:-10px; margin-bottom:10px;">
             <span id="ToDoctor" style="color:#2c93dd; font-weight:bold;">TO <? echo 'Dr. '.$NameDoctor.' '.$SurnameDoctor; ?></span><input type="hidden" id="IdDoctor" value='<? echo $IdDoctor; ?>'/>
         </div>
        ...
        <!-- <input type="hidden" id="docId" value="<? echo $IdMed; ?>"/> -->
         <input type="hidden" id="userId" value="<? echo $IdUsu; ?>" />
        ...
        <script src="TypeWatch/jquery.typewatch.js"></script>
          ...
          <script type="text/javascript" >
            ...
            $("#ViewRecords").on('click',function()
                 {
                   ...
                   location.replace("patientdetailMED-new-Send.php?IdUsu="+<?php echo $userId; ?>+"&Acceso="+'23432'+"&doctor_email="+doctorEmail+idpins);
                 });
            ...
            $("#CreateAccount").on('click',function(){
                ...
                $("#EmailCreateAccountPage").val('<?php echo $doctorEmail; ?>');
              ...
              var name,surname,email,password,repeatPassword,date,gender,mem_id,pin_holder;
             ...
             $("#createAccountNewDoc").on('click',function(){
                    ...
                    if(passwordStatus == 'correct')
                    {
                        ...
                        $.get("createAccountNewDoc.php?name="+name+"&surname="+surname+"&email="+email+"&password="+password+"&date="+date+"&gender="+gender+"&emailDoc="+emailDocToBeAdded+'&memid='+mem_id+'&pins='+pin_holder,function(data,status)
                        {

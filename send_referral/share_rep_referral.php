<html>
    ...
    $doctors->execute();*/
    echo '<div id="sharestation" style="width: 100%; height: 30px; text-align: center; font-family: Helvetica, sans-serif; color: #888; margin-top: 15px;">Highlighting';
    /*Sharing with ';
    ...
    echo '<span id="number_of_highlighted_files" style="margin-left: 8px;">0</span> out of '.$num_reports.' reports';
    echo '<button id="save" style="background-color: #54BC00; width: 30px; height: 30px; margin-left: 10px; color: #FFF; border: 0px solid #FFF; outline: none; font-family: Helvetica, sans-serif; font-size: 18px; border-radius: 30px; cursor: pointer;"><i class="fa fa-floppy-o" ></i></button>';
    echo '</div>';
    ...
    while($reports_row = $reports->fetch(PDO::FETCH_ASSOC))
    {
        ...
        $file = decrypt_files($reports_row['RawImage'], $MedID, $pass, $local);
    ...
    <script>
        window.total_file_num = <?php echo $num_reports; ?>;
        $('#num_of_files').text(total_file_num);
        ...
        $(document).ready(function()
        {
            ...
            window.highlighted_files = new Array();
            ...
            $("#number_of_highlighted_files").text(highlighted_files.length);
            ...
            $("button[id^='select_']").on('click', function()
            {
                ...
                else
                {
                    ...
                    index = highlighted_files.indexOf(id);
                    highlighted_files.splice(index, 1);
                ...
                /*if($("select#user_select option:selected").text().indexOf("Dr.") > -1)
                    ...
                    $("#number_of_highlighted_files").text(highlighted_files.length);
                    $("#num_of_highlighting_files").text(highlighted_files.length);
            ...
            { */
                ...
                {*/
                    for(var k = 0; k < highlighted_files.length; k++)
                    {
            ...
            function update_tags()
            {
                ...
                if(highlighted_files.indexOf(currently_selected_file) > -1)

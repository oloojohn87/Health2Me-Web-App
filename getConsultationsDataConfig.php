...
if($scope == "Global")
{
    ...
    elseif($period == 2)
    {
        ...
        while(strcmp($current_date, $tomorrowDate) != 0)
        {
        ...
        $query2->bindValue(1, $dateOfLastSunday.' 00:00:00', PDO::PARAM_STR);
        $query2->bindValue(2, $todayDate.' 23:59:59', PDO::PARAM_STR);
    ...
    elseif($period == 3)
    {
        ...
        $query2 = $con->prepare("SELECT DISTINCT Patient FROM consults WHERE DateTime BETWEEN ? AND ? AND Doctor = ?");
        $query2->bindValue(1, $firstDateOfMonth.' 00:00:00', PDO::PARAM_STR);
        $query2->bindValue(2, $todayDate.' 23:59:59', PDO::PARAM_STR);
        $query2->bindValue(3, $med_id, PDO::PARAM_INT);
        $query2->execute();
        $numUsers = $query2->rowCount();

...
$query = $con->prepare("select name,icdcode,DATE_FORMAT(datestart,'%m-%d-%Y') as datestart,DATE_FORMAT(datestop,'%m-%d-%Y') as datestop from pastdx where idpatient=? and del=0");
...
$query = $con->prepare("select name,drugcode,DATE_FORMAT(datestart,'%m-%d-%Y') as datestart,DATE_FORMAT(datestop,'%m-%d-%Y') as datestop,dossage,numberday from medications where idpatient=? and del=0");
$query->bindValue(1, $id, PDO::PARAM_INT);
$result = $query->execute();
$i=1;
...
$query = $con->prepare("select name,age,reaction,DATE_FORMAT(date,'%m-%d-%Y') as datestart from immunizations where idpatient=? and del=0");
$query->bindValue(1, $id, PDO::PARAM_INT);
...
$query = $con->prepare("select name,type,description,DATE_FORMAT(daterec,'%m-%d-%Y') as datestart from allergies where idpatient=? and del=0");
$query->bindValue(1, $id, PDO::PARAM_INT);
...
$query->bindValue(6, 0, PDO::PARAM_INT); //Replaced the $userid with 0 to make demographics pdf as publicly viewable
$query->bindValue(7, $userid, PDO::PARAM_INT);
$query->bindValue(8, $checksum, PDO::PARAM_STR);
$query->bindValue(9, $row1['name']."_".$row1['surname']."_Summary.pdf", PDO::PARAM_STR);
$query->execute();

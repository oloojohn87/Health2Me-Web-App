...
<input type="hidden" id="UserHidden">
    ...
    <div class="wrapper" id="modalFamilyHistory" style="display:none; text-align:center; padding:20px;">
...
<!--				<input id="AgeEvent" type="text" style="width: 40px; margin-top:5px;margin-left:10px; visibility:hidden;">-->
    ...
    ?>  
        <script type="text/javascript">
            document.getElementById("ribbon-verified").style.display = 'none';
            //can't get jquery to work
            //$( function() {
            //    $('#ribbon-verified').hide();});
        </script>
    <?php } ?>

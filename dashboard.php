	...
	<div class="header" >
    	...
    	<input type="hidden" id="IdMEDLogo" Value="<?php echo $MedUserLogo; ?>">	
		   ...
		   <div class="btn-group pull-right" >
			...
			$current_encoding = mb_detect_encoding($IdMedFIXEDNAME, 'auto');
			$show_text3 = iconv($current_encoding, 'ISO-8859-1', $IdMedFIXEDNAME); 
			?>
	  	    		...
	  	    		<div class="row-fluid" style="">	            
		  	    		...
		  	    		<div class="grid" style="padding:10px; height:280px;">
			  	    		...
			  	    		<div style="width:400px;  float:left;"><!-- WRAPPER DE ESTA AREA --->
				  	    		...
				  	    		<span id="NombreComp" style="font: bold 24px Arial, Helvetica, sans-serif; color: #3D93E0; cursor: auto; margin-left:20px; "> <?php echo $MedUserTitle.' '.$show_text;?> <?php echo $show_text2;?></span>
				  	    		...
				  	    		<span id="IdUsFIXEDNAME" style="font-size: 14px; color: GREY; font-weight: bold; font-family: Arial, Helvetica, sans-serif; margin-left:20px;"><?php echo $show_text3;?></span>

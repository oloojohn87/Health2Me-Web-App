...
<div class="loader_spinner"></div>
	...
	<div class="header" >
		   ...
		   <div class="btn-group pull-right" >
            ...
            <ul class="clear_ul" >
              <li><a href="dashboard.php"><i class="icon-globe"></i> <span lang="en">Home</span></a></li>
				...
				<div id="step-1" style="height:900px;width:1100px">	
					<h2 class="StepTitle" lang="en">Create Member</h2>
									...
									<ul id="myTab1" class="nav nav-tabs tabs-main">
										...
										<?php if($row['personal'])
											echo '<li><a href="#TabPersonal" data-toggle="tab" lang="en">Personal History</a></li>';
										?>
										<?php if($row['family'])
										echo '<li><a href="#TabFamily" data-toggle="tab" lang="en">Family History</a></li>';
										?>
										<?php if($row['pastdx'])
										echo '<li><a href="#TabPastDX" data-toggle="tab" lang="en">Past Diagnostics</a></li>';
										?>
										<?php if($row['medications'])
										echo '<li><a href="#TabMedication" data-toggle="tab" lang="en">Medication</a></li>';
										?>
										<?php if($row['immunizations'])
										echo '<li><a href="#TabImmunization" data-toggle="tab" lang="en">Immunization</a></li>';
										?>
										<?php if($row['allergies'])
										echo '<li><a href="#TabAllergies" data-toggle="tab" lang="en">Allergies</a></li>';
										?>
														...
														<div style="margin-left:20px; margin-top:20px; color: #3d93e0; font-size:20px; font-weight:bold; width:100%; " lang="en">Demographics</div>
															...
															<div style="float:left; width:450px; margin:10px; padding:10px; height:250px; margin-top:-10px">
																...
																<div class="formRow" <?php if(!$row['phone']) echo 'style="display:none"'?>>
																	<label style="margin-left:30px;" lang="en">Phone: </label>
																	<div class="formRight" >
																...
																<div>
																	<label for="file" style="margin-left:30px;" lang="en">Image:</label>
				...
				<div id="step-2">
					...
					<center>
						...
						<tr>
							...
							<div id="dropzone" style="background: #F9F9F9; height:30px; width:290px;">
								<center>Other</center>
								<form action="upload_dropzone.php" method="post" class="dropzone" id="myAwesomeDropzone9" style="background:<?php echo $TipoColorGroup[4] ?>; height:30px; width:auto;  margin-top:600px"><center style="color:white; font-size:22px;"><i class="<?php echo $TipoIconGroup[4] ?> icon-2x" style="color:white;"></i>&nbsp;&nbsp;<span lang="en">Other</span></center></form>
							</div>
							</td>
						</tr>
		...
		function leaveAStepCallback(obj)
		{
			...
			switch(parseInt(step_num))
			{
				...
				case 2: 
						...
						else if((filecount-failed_uploads) != upload_count)
						{

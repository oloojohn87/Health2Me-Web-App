...
$query1=$con->prepare("SELECT b.id as id,date(datetimestamp) as eventdate,time(datetimestamp) as eventtime,content,u.idmedfixedname as user,viewip FROM bpinview b,doctors u  USE INDEX(id) WHERE b.viewIdmed=u.id and  b.idpin=? order by datetimestamp");

...
$referralcolors=array("#0B701B", "#FC9856", "#4673D1", "#4673D1");
$i=0;
        ...
        <div class="clearfix" style="margin-bottom:20px;"></div>
		 ...
		 <!-- image upload changes start -->
		  <?php
			...
			$fileName = "C:/xampp/htdocs/PatientImage/".$USERID.".jpg";
		  ...
		  ?>	
				...
				<tr>
				<td>
				<img src="<?php echo $fileName;?>" style="<?php echo $style;?>"> 
				</td>
				...
				<span id="NombreComp" style="font: bold 24px Arial, Helvetica, sans-serif; color: #3D93E0; cursor: auto;  margin-left:10px;"><?php echo $MedUserName;?> <?php echo $MedUserSurname;?></span>
			  	...
			  	<span id="IdUsFIXEDNAME" style="font-size: 14px; color: GREY; font-weight: bold; font-family: Arial, Helvetica, sans-serif;margin-left:10px; "><?php echo $IdUsFIXEDNAME;?></span>
				<span id="email" style="font-size: 14px; color: #5EB529; font-weight: bold; font-family: Arial, Helvetica, sans-serif; margin-left:220px;"><?php echo $email;?></span>
				</td>
        ...
        //<!--Specific Referall Comm Box Start-->
					...
					//if($multireferral==1){
						...
						echo '<div style="width:90%; margin-top:12px;margin-left:20px;float:left;">';
									...
									echo '<div id="inpa'.$i.'" style="width:180px; float:left;"><div style="color: #ccc; font-size:20px; font-weight:bold; width:100%;">Stage D</div><span style="color: #ccc; font-size:12px; width:100%;">Interview Patient</span></div></div>';
  ...
  <!--  <script type="text/javascript" src="http://code.jquery.com/jquery-1.8.0.min.js"></script>--->
    ...
    $('#PrintImage').live('click',function(){
		...
		/*else{
	   	...
	   	window.open('printimage.php?path='+path,'','left=200,width=900,height=700,resizable=0,scrollbars=1');
	...
	$("#Telemedicine").on('click',function() {
		 ...
		 method: 'get',
			...
			// var content= dataString.replace(/<html[\S\s]*?html>/gi, '').match(/<script>([^<]+)<\/script>/)[1];
			// console.log(content);
			 // $(dataString.toString()).filter("script").each( function(e) { 
			 // console.log(e);
			// eval($(e).outerHTML());
			// } );
			//<p>(.*?)</p
			...
			// while ( ( m = rex.exec( dataString.toString() ) ) != null ) {
				// console.log( m[1] );
			// }
			//dataString.toString().match(rex)[1];
			// var title = dataString.toString().match(/<script>([^<]+)<\/script>/)[1];
			// console.log(title);
			 }
		 });

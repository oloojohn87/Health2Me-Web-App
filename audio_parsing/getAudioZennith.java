...
public class getAudioZennith {
	...
	public static void main(String[] args) throws InstantiationException, IllegalAccessException, ClassNotFoundException, IOException, InterruptedException 
	{
        ...
        try
        {
			...
			String query ="select p.idpin,l.rawimage,l.creatortype,l.idcreator from pending_audio p,lifepin l where l.idpin = p.idpin and l.vs=0 order by l.idpin";

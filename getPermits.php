...
if($Todoc==-1){
	...
	*/
	...
	<span style="font-size:16px; color:orange; max-width:70px; padding-top:10px; height:10px; margin-bottom:-3px; display:inline-block;" class="truncate">'.$SurnameP.'</span>
	<span style="font-size:16px; color:orange;">'.strtoupper(substr($NameP,0,1)).'.</span>
	<span style="font-size:12px; color:grey;">  from </span>
	<span style="font-size:16px; color:#22aeff; max-width:130px; padding-top:10px; height:10px; margin-bottom:-3px; display:inline-block;" class="truncate">'.substr($nomDoc,0,18).$AddNom.'</span>

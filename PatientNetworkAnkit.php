...
$resultG = mysql_query("SELECT IdGroup FROM doctorsgroups WHERE IdDoctor = '$MedID'");
	...
	<button id="probeRequest" data-target="#header-modal333" data-toggle="modal" class="btn btn-warning" style="display: none;">Modal with Header</button> 
				...
				<div class="modal-body" style="overflow-y:visible;">
					...
					<table style="background-color:white" id = "ProbeTab">
						...
						<tr id="EmailRow">
							<td> Email ID : </td>
							<td> <input id="Email" style="width:16em;margin-top:10px"> </td>
						</tr>
						<tr id="PhoneRow" style="display:none;">
							<td> Phone Number : </td>
							<td><input id="Phone" type="tel" placeholder="e.g. +1 702 123 4567" style="width:15em;margin-top:10px;height:30px"></td>
							
						</tr>
						<tr id="MessageRow" style="display:none;">
							<td> Phone Number : </td>
							<td> <input id="Message" type="tel" placeholder="e.g. +1 702 123 4567" style="width:15em;margin-top:10px;height:30px"> </td>
						</tr>
				...
				<div class="modal-footer">
					<a href="#" class="btn btn-success" data-dismiss="modal" id="createProbe">Create</a>
         ...
         <div class="modal-header" style="height:60px;">
             ...
             <div style="width:90%; margin-top:12px; float:left;">
                 ...
                 <div id="seldr" style="width:100px; margin-left:5%; float:left;">
                     ...
                     <span style="font-size:12px; width:100%;">Link to Patient</span>
                 </div>
             </div>
         </div>
                                ...
                                <div style="margin:0 auto; margin-top: 10px; width:360px; height:160px;">
                                    <div id="DivConnect" style="float:left; display: table-cell; vertical-align: middle; text-align:center; margin:0 auto; width:150px; height:150px; border:1px solid #cacaca; border-radius:5px; background-color:#f5f5f5">
                                        <div style="display: inline-block; width: 150px; height: 100px; margin-top:40px; text-align: center; ">
                                            ...
                                            <div style="margin-top:10px;"><span id="SpanConnect">Connect Connect Connect Connect</span></div>
                                        </div>
                                    </div>
                                     <div id="DivInvite" style="float:left; text-align:center; margin:0 auto; margin-left:50px; width:150px; height:150px; border:1px solid #cacaca; border-radius:5px; background-color:#f5f5f5">
                                        <div style="display: inline-block; width: 150px; height: 100px; margin-top:40px; text-align: center; ">
                                            ...
                                            <div style="margin-top:10px;"><span id="SpanInvite">Invite Invite Invite Invite</span></div>
                                        </div>
                                     </div>
                                </div>
 ...
 <button id="BotonMod2" data-target="#header-modal2" data-toggle="modal" class="btn" style="float:right; margin-right:10px; display:none;"><i class="icon-indent-left"></i>New</button>
     ...
     <ul class="menu-speedbar">
		 ...
		 <?php if ($privilege==1)
		 {
				 ...
				 echo '<li><a href="PatientNetwork.php" class="act_link">Patient Network</a></li>';
		 }
		 ?>
	 ...
	 <div class="content" style="">
            ...
            <div class="grid" class="grid span4" style="width:1000px; min-height:1300px; margin: 0 auto; margin-top:30px; padding-top:30px;">
                ...
                <span class="label label-info" style="left:0px; margin-left:30px; font-size:30px;">Patient Network</span>
        ...
        <?php
              ...
              $resultPAC = mysql_query("SELECT * FROM doctorslinkusers WHERE IdMED='$MedID' ");
              //$countPAC=mysql_num_rows($resultPAC);
              while ($rowP1 = mysql_fetch_array($resultPAC))
              {
              ...
              //$sumatotalPAC = 0;
              $resultCRU = mysql_query("SELECT * FROM doctorslinkdoctors WHERE IdMED='$MedID' ");
              //$countCRU=mysql_num_rows($resultCRU);
              while ($rowCRU = mysql_fetch_array($resultCRU))
              {
                  $Autorizado = $rowCRU['IdMED2'];
                  $resultPAC2 = mysql_query("SELECT * FROM doctorslinkusers WHERE IdMED='$Autorizado' ");
                  //$countPAC2=mysql_num_rows($resultPAC2);
                  while ($rowC2 = mysql_fetch_array($resultPAC2))
                  {
              ...
              $avat = 'identicon.php?size=75&hash='.$hash;
                            ...
                            <div id="MidIcons" style="margin-top:30px; margin-bottom:30px; text-align:center; float:left; width:270px; font-size:14px; color:#22aeff;">
                                ...
                                <span style="color:#54bc00; margin-left:5px;" title="Patients uploaded information in the past 30 days"><i class="icon-circle-arrow-up icon-3x "></i></span>
							...
							<div style="width:100px; border:1px solid rgba(194,194,194,1); float:right;  -webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; margin-left:10px;">
								...
								<p style="font-family: arial; font-size:18px; color:white; padding:5px; margin:0px; ">Probes</p>
								</div>	
							...
							<div style="width:100px; border:1px solid rgba(194,194,194,1); float:right;  -webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; margin-left:10px;">
								...
								<p style="font-family: arial; font-size:18px; color:white; padding:5px; margin:0px; ">Connected</p>
								</div>	
                ...
                <div id="PendingTasks" style="width:940px; margin-left:30px; margin-right:0px; margin-top:30px;" >
                        <div class="grid" style="width:100%; min-height:100px; max-height:300px;margin: 0 auto; overflow-y:scroll;">
                                    <div class="grid-title">
                                        <div class="pull-left"><div class="fam-user" style="margin-right:10px;"></div>Pending Confirmations and Invitations</div>
        ...
        <!--TAB Start-->
          <ul id="myTab" class="nav nav-tabs tabs-main">
            <li class="active" style="width:50%; " id="probeTab"><a href="#probe"  data-toggle="tab">Probes</a></li>
			<li style="width:50%; " id="connectedpatients"><a href="#cpatients" data-toggle="tab">Connected Patients</a></li>
          ...
          <div id="myTabContent" class="tab-content tabs-main-content padding-null">
					<div class="tab-pane tab-overflow-main fade in active" id="probe" style="width:940px; margin-left:30px; margin-right:0px; margin-top:30px;">
						<div class="grid" style="width:95%; " id="probeGrid">
                                    <div class="grid-title">
                                        <div class="pull-left"><div class="fam-user" style="margin-right:10px;"></div>Patients Database</div>
                                    ...
                                    <div class="search-bar" >
                                        <input type="text" class="span" name="" placeholder="Search Patient" style="width:150px;" id="searchProbe"> 
                                        <input type="button" class="btn btn-primary" value="Filter" style="margin-left:50px;" id="BotonBusquedaProbe">
                                    ...
                                    <div class="grid" style="margin-top:0px;">
                                       <div style="max-height:800px; overflow-y:scroll;width:890px ">
						...
						<div class="tab-pane" style="width:940px; margin-left:30px; margin-right:0px; margin-top:30px;"  id="cpatients" >
								...
								<div class="grid" style="width:95%; margin: -8px;" id="connectedPatientsGrid">
                                    <div class="grid-title">
                                        <div class="pull-left"><div class="fam-user" style="margin-right:10px;"></div>Connected Patients</div>
                                    ...
                                    <div class="grid" style="margin-top:0px;">
                                       <div style="max-height:800px; overflow-y:scroll; ">
											...
											<center>
												<div id = "prevPatients" style = "width: 75px; height: 50px; margin-right: 100px; display: inline-block; cursor: pointer">
												   <i class = "icon-chevron-left"></i> Previous
												</div>
												<div id = "pageDisplay" style = "display: inline-block;">
													
												</div>
												<div id = "nextPatients" style = "width: 75px; height: 50px; margin-left: 100px; display: inline-block; cursor: pointer">
            ...
            <div id="OLDpatientstable" class="grid" style="float:left; width:90%; height:300px; margin: 0 auto; margin-left:2%; margin-top:30px; margin-bottom:30px; overflow:scroll;">
                    ...
                    <div class="search-bar">
                        <input type="text" class="span" name="" placeholder="Patient Name" style="width:150px;" id="SearchUserT"> 
	...
	var userSurname = $('#SearchUserUSERFIXED').val();
		...
		$.ajax({
			...
			success: function(data){
				...
				var UProbe = res[2];
				//alert(UProbe);
				titulo = 'Percentage of the patients that are connected to you ('+UConn+'), out of the total of patients available ('+UTotal+') ';
   ...
   //Set options for timezone 
    ...
    function SendMsgOnClick (id1,id2){
        ...
        //alert (myClass2);
 	    switch (myClass2)
 	    {
	 	    case 'conn':	$('#ContenidoModal2').html('<p>Please enter patient email to send a connection request:</p><p><input id="ResPas" name="ResPas" type="text" class="last-input" placeholder="email" title="Please insert email" style="padding-left:10px; margin-top:5px; width:250px;" /></p><p><input id="TelefUser" name="TelefUser" type="text" class="last-input" placeholder="phone number (add country code)" title="Please insert phone number" style="padding-left:10px; margin-top:5px; width:300px;" /></p>');
	        				$('#BotonMod2').trigger('click');
							break;
	 	    case 'invi':  	contenido1 ='<p>Please provide a temporary password for your patient.</p><p><input id="TempoPas" name="TempoPas" type="text" class="last-input" placeholder="Temporary Password" title="Please insert temporary password" style="padding-left:10px; margin-top:5px; width:250px;" /></p>';
    ...
    $('#sendmessages_inbox').live('click',function(){
             ...
             if (subject < ' ')  subject='Message form your doctor.';
	    ...
	    phonepaciente = user[0].telefono; 
	  	...
	  	switch (UserSwitch)
 	    {
	 	    case 'conn':	EmailTarget = $('#ResPas').val();;
						 	...
						 	{
							    var r=confirm('Confirm sending connection request to patient '+paciente+' ?   '+subcadena);
							 	if (r==true)
							 	 {
							    	var IdDocOrigin = $('#MEDID').val();
							     	var NameDocOrigin = $('#IdMEDName').val() ;
	 	    ...
	 	    case 'invi':	PasswordTarget = $('#UTempoPass').val();
                            if (!emailpaciente) emailpaciente = TempoEmail;
	 						...
	 						var r=confirm('Confirm sending invitation to patient '+paciente+' ?   '+subcadena);
							if (r==true)
							 	 {
							    	var IdDocOrigin = $('#MEDID').val();
							     	var NameDocOrigin = $('#IdMEDName').val() ;
  ...
  */  
  ...
  $("#BotonBusquedaProbe").click(function(event) {
	...
	$(".CannotProbe").live('click',function() {
		displaynotification("Cannot Probe","Patient does not want to receive Probes.");
	});

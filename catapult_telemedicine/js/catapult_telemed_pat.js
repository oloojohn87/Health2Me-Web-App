...
$(document).ready(function()
{
    ...
    push.bind('doctor_in', function(data)
    {
        ...
        $("#doctor_presence_notification").html('NP has entered the consultation');
        var start = new Date();
    ...
    {
        swal({title: "Closing Consultation", text: "The NP has closed the consultation.\nYou will now be redirected to your records page where you can see the NP's notes", type: "warning", showCancelButton: false, confirmButtonText: "Ok", closeOnConfirm: true }, function()
        {   setTimeout(function()
            {
                window.location.href = window.location.protocol + '//' + window.location.host + '/Main_Application/member/patientdetails/html/PatientDetails.php?IdUsu=' + pat_id;
            }, 1000);
         });
    });

		...
		<!-- Pop up PastDX Start-->
         ...
         <div style="margin:10px; margin-top:20px;" >     
													...
													<div class="grid" style="padding:10px;height:620px;width:1028px">
														...
														<div style="margin-left:20px; margin-top:20px; color: #3d93e0; font-size:20px; font-weight:bold; width:100%; " lang="en">Demographics</div>
															...
															<div style="float:left; width:450px; margin:10px; padding:10px; height:250px; margin-top:-10px">
																...
																<div class="formRow">
								<label style="margin-left:10px; width:78px;" lang="en" >Middle Initial</label>:
																	<div class="formRight" style="width:78%">																	<input id="initial" name="initial" maxlength="1" type="text" class="first-input" style="width:9px; border-bottom-right-radius:3px; border-bottom-left-radius:3px;"/>
																	</div>
																...
																<div class="formRow">
																	<label style="margin-left:10px;width:55px" lang="en">Date of Birth</label>:
																	<div class="formRight" style="width:78%">
																		<input id="dp32" style="width:150px" readonly/>
																		<!--<divx class="validate[custom[date],past[2013/01/01]] input-append date" id="dp3" data-date="12-02-2012" data-date-format="dd-mm-yyyy" >
            ...
            $style = "max-height: 80px; max-width:80px;margin-left:110px;";
				...
				<img id="patientImage" style="width:0px; height:0px;overflow:hidden;"/>
						...
						<div id="progressNumber" style="margin-left: 130px; color: #22aeff; font-weight: bold;"></div>
								...
								<div class="formRow" <?php if(!$row['city']) echo 'style="display:none"'?>>
																...
																<div class="formRow"
																	<?php if($row['state']) echo 'style="display:none"'?>>
																	 <label style="margin-left:30px;" lang="en">State: </label>
																	?>
																	<div class="formRight" style="width:78%">
									...
									<div style="float:right; margin-right:20px;margin-top:10px;">
														...
														<div style="margin-left:20px; margin-top:20px; color: #3d93e0; font-size:20px; font-weight:bold; width:100%; " lang="en">Confirmation</div>
															<hr>
																...
																<div style="margin-left:20px;margin-top:10px; float:left;">
																	<span lang="en">Please confirm that you want to create this member</span>:
																</div>
																<!--<div style="float:right; margin-right:20px;margin-top:10px;">-->
										...
										<center>
											<input type="button" class="btn btn-primary" value="SAVE" onClick="checkNumber();createPatient();" style="margin-top:7px;" lang="en">	
										</center>
				...
				<div id="step-3">
					    <h2 class="StepTitle"><span lang="en">Report Verification</span><label align="right" id="verified_count_label" style="color:red;"></label></h2>	
					<center>
					<br>
							...
							<table>
								<tr>
									...
									<td><input type="button"  id="previous" value = "Previous" onClick="previous_click();"lang="en"></td>
									<td><div class="grid-content" id="AreaConten">
											<img id="ImagenAmp" src="">
										</div>
									</td>
									
				<td><input type="button" id="next" value="Next" onClick="next_click(); "lang="en"></td>
							    </tr>
							</table>
					</center>
				</div>
...
function ShowTimeOutWarning()
{
	...
	function fileSelected() {
      ...
      function uploadFile2() {
        ...
        console.log(document.getElementById('fileToUpload2').value);
        xhr.send(fd);
...
var phone = $('#new_user_phone').val();
      ...
      shell_exec("rm -f ".$local."PatientImage/temp_MEDID”);
